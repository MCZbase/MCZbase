						...
						<form name="searchForm" id="searchForm" class="search-box">
							...
							<div class="row mx-2 py-2">
								...
								<div class="col-12 col-xl-9 mt-2">
									<div class="col-12">
										<p class="smaller-text" tabindex="0">Add an = <span class="sr-only">equals sign</span> to the beginning of names entered for exact match. Add ! <span class="sr-only">exclamation mark</span> for not. Name fields accept comma separated lists. NULL finds blanks. Searching the fields 'any part of name or classification' and 'remarks' use fuzzy matching.</span></div>
									<div class="form-row bg-light border rounded p-2 mx-0">
										...
										<div class="col-md-4">
											...
											<input type="text" class="data-entry-input" aria-labelledby="common_name" id="common_name" name="common_name" value="#common_name#" placeholder="common name">
										</div>
									</div>
									<div class="form-row mt-2">
										<div class="form-group col-md-2">
											...
											<input type="text" class="data-entry-input" aria-labelledby="genus" id="genus" name="genus" value="#genus#" placeholder="generic name">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="subgenus" aria-labelledby="subgenus" name="subgenus" value="#subgenus#" placeholder="subgenus">
										</div>
										<div class="form-group col-md-2">
											...
											<input type="text" class="data-entry-input" id="species" aria-labelledby="species" name="species" value="#species#" placeholder="specific name">
										</div>
										<div class="form-group col-md-2">
											...
											<input type="text" class="data-entry-input" id="subspecies" name="subspecies" aria-labelledby="subspecies" value="#subspecies#" placeholder="subspecific name">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="author_text" name="author_text" aria-labelledby="author_text" value="#author_text#" placeholder="author text">
										</div>
									</div>
									<div class="form-row mb-1">
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="kingdom" aria-labelledby="kingdom" name="kingdom" value="#kingdom#" placeholder="kingdom">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="phylum" name="phylum" aria-labelledby="phylum" value="#phylum#" placeholder="phylum">
										</div>
										<div class="col-md-2">
											...
											<input type="small" class="data-entry-input" id="subphylum" name="subphylum" aria-labelledby="subphylum" value="#subphylum#" placeholder="subphylum">
										</div>
										<div class="col-md-2">
											...
											<input type="small" class="data-entry-input" id="superclass" aria-labelledby="superclass" name="superclass" value="#superclass#" placeholder="superclass">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="phylclass" name="phylclass" aria-labelledby="phylclass" value="#phylclass#" placeholder="class">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="subclass" id="subclass" aria-labelledby="subclass" name="subclass" value="#subclass#" placeholder="subclass">
										</div>
									</div>
									<div class="form-row mb-1">
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="superorder" name="superorder" aria-labelledby="superorder" value="#superorder#" placeholder="superorder">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="phylorder" name="phylorder" aria-labelledby="phylorder" value="#phylorder#" placeholder="order">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="suborder" name="suborder" aria-labelledby="suborder" value="#suborder#" placeholder="suborder">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="infraorder" name="infraorder" aria-labelledby="infraorder" value="#infraorder#" placeholder="infraorder">
										</div>
									</div>
									<div class="form-row mb-1">
										<div class="col-md-2">
										...
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="family" name="family" aria-labelledby="family" value="#family#" placeholder="family">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="subfamily" name="subfamily" aria-labelledby="subfamily" value="#subfamily#" placeholder="subfamily">
										</div>
										<div class="col-md-2">
											...
											<input type="text" class="data-entry-input" id="tribe" name="tribe" aria-labelledby="tribe" value="#tribe#" placeholder="tribe">
										</div>
										<div class="col-md-2">
									...
									<div class="form-row mb-3 mt-2">
										...
										<div class="col-md-3">
											...
											<input type="text" class="data-entry-input" id="infraspecific_author" name="infraspecific_author" value="#infraspecific_author#" placeholder="infraspecific author" aria-labelledby="infraspecific_author" aria-label="infraspecific author for botanical names only">
										</div>
									</div>
