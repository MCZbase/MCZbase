	...
	<div id="overlaycontainer" style="position: relative;">
			...
			<section class="container-fluid">
				<div class="row">
					<div class="col-12 mb-5">
						...
						<h1 class="h4">Results: <span class="px-1 font-weight-normal text-success" id="resultCount" tabindex="0"><a class="messageResults" tabindex="0" aria-label="search results"></a></span> </h1><span id="resultLink" class="d-inline-block px-1 mt-2 pt-1"></span>
		...
		<script>
			...
			function gridLoaded(gridId, searchType) { 
				...
				$('##resultDownloadButtonContainer').html('<button id="loancsvbutton" class="btn-xs btn-secondary px-3 mx-1 mb-1 my-md-2" aria-label="Export results to csv" onclick=" exportGridToCSV(\'searchResultsGrid\', \''+filename+'\'); " >Export to CSV</button>');
			}
