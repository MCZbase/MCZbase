												...
												<div class="form-group mb-0 pb-0">
													<ul class="list-group list-group-horizontal list-group-flush mt-0 p-1 border bg-light rounded ">
														...
														<li class="list-group-item px-1 px-md-2 pb-0 pt-1">
															<label for="validFGChecked" class="d-block" style="position:relative; padding-left: 1.2rem;font-size: 0.9em!important;">
														...
														<li class="list-group-item px-1 px-md-2 pb-0 pt-1">
															<label for="validFGUnchecked" class="d-block" style="position:relative; padding-left: 1.2rem;font-size: 0.93em!important;">
														...
														<li class="list-group-item px-1 px-md-2 py-1">
															<label for="validFGNot" class="d-block" style="position:relative; padding-left: 1.2rem;font-size: 0.93em!important;">
											...
											<fieldset class="bg-light border-default field-set rounded px-2 pt-1 pb-2 mt-1 mx-2">
												...
												<div class="form-group mb-0 pb-0">
													<ul class="list-group list-group-horizontal list-group-flush mt-0 p-1 border bg-light rounded">
														...
														<li class="list-group-item px-1 px-md-2 pb-0 pt-1">
															<label for="wehavesomeAll" class="small95 d-block" style="position:relative; padding-left: 1.2rem;">
														...
														<li class="list-group-item px-1 px-md-2 pb-0 pt-1">
															<label for="wehavesomeHave" class="small95 d-block" style="position:relative; padding-left: 1.2rem;">
														...
														<li class="list-group-item px-1 px-md-2 py-1">
															<label for="wehavesomeNot" class="small95 d-block" style="position:relative; padding-left: 1.2rem;">
