                                ...
                                <form name="searchForm" id="searchForm">
                                    ...
                                    <div class="col-12 px-2">     
                                        <fieldset class="bg-light border-right border-bottom border-left field-set rounded px-2 pt-1 pb-1 mt-0 mx-2">         
                                            <div class="form-row mt-0">             
                                                    <div class="form-group col-12 col-lg-3 col-md-3 col-xl-2 px-0 mb-0 pb-0">
                                                    ...
                                                    <div class="form-group col-12 col-lg-3 col-md-4 col-xl-2 px-0 mb-0 pb-0">
                                                     ...
                                                     <cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_taxonomy")>
                                                        ...
                                                        <div class="d-flex flex-wrap col-12 col-lg-3 col-md-3 col-xl-2 px-0 mb-0 pb-0">
                                                    ...
                                                    <div class="form-group col-12 col-md-5 col-xl-2 px-0 mb-0 pb-0">
