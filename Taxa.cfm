									...
									<form name="searchForm" id="searchForm">
										<div class="row mx-2">
											...
											<div class="col-12 col-xl-8 mt-2">
												...
												<button type="button" class="btn btn-xs btn-warning" aria-label="Start a new taxon search with a clear form" onclick="window.location.href='#Application.serverRootUrl#/Taxa.cfm';" ><a href="##content">New Search</a></button>
											</div>
										</div>
									</form>
								</div>
