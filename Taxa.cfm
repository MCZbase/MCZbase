										...
										<div class="row mx-2">
											...
											<div class="col-12 col-xl-8 mt-2">
												...
												<div class="form-row bg-light border rounded p-2 mx-0">
													<div class="col-md-4">
														<label for="scientific_name" aria-label="scientific name" class="data-entry-label align-left-center">Scientific Name <a href="##" aria-labelledby="equals" class="btn-link" onclick="var e=document.getElementById('scientific_name');e.value='='+e.value;" > (=) </a></label>
													...
													<div class="col-md-4">
														<label for="common_name" class="data-entry-label align-left-center">Common Name <a aria-labelledby="equals" href="##" class="btn-link" onclick="var e=document.getElementById('common_name');e.value='='+e.value;"> (=) </a></label>
