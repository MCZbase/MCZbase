					...
					<div class="col-12">
						<div class="tab-card-main mt-4 pb-2 tab-card"> 
							...
							<div class="card-header tab-card-header pb-0 w-100">
								<h1 id="content" class="h3 smallcaps text-white mt-1 mb-2 pl-1 w-50">Search Taxonomy <span class="count font-italic text-grayish mx-0"><small>(#getCount.cnt# records)</small></span></h1><i class="fa fa-info-circle small" tabindex="0" onClick="getMCZDocs('Taxonomy Search')" aria-label="Link to MCZbase Wiki for more information"></i> 
							</div>
							<!--- End tab header div ---> 
