									...
									<form name="searchForm" id="searchForm">
										<div class="row mx-2">
											...
											<div class="col-12 col-xl-8">
												<div class="col-12">
													<p class="small text-success" aria-label="input info">Add equals sign for exact match.  Fields marked with (,) support comma separated lists.</p>
												</div>
												<div class="form-row bg-light border rounded px-2 pb-2">
													<div class="col-md-4">
														<label for="taxonomic_scientific_name" class="data-entry-label align-left-center">Scientific Name <span class="small text-success" onclick="var e=document.getElementById('scientific_name');e.value='='+e.value;" aria-label="Add equals sign for exact match.">(=) </span><span aria-label="accepts comma separated list" class="small">(,)</span></label>
												...
												<div class="form-row mt-2">
													<div class="form-group col-md-2">
														<label for="genus" class="data-entry-label align-left-center">Genus <span class="small text-success" onclick="var e=document.getElementById('genus');e.value='='+e.value;" aria-label="add equals sign before entry for exact match"> (=) </span><span aria-label="accepts comma separated list" class="small">(,)</span></label>
													...
													<div class="form-group col-md-2">
														<label for="species" class="data-entry-label align-left-center">Species <span class="small text-success" onclick="var e=document.getElementById('species');e.value='='+e.value;" aria-label="add equals sign before entry for exact match"> (=)</span><span aria-label="accepts comma separated list" class="small">(,)</span> </label>
												...
												<div class="form-row mb-1">
													...
													<div class="col-md-2">
														<label for="subphylum" class="data-entry-label align-left-center">Family <span class="small text-success" onclick="var e=document.getElementById('family');e.value='='+e.value;" aria-label="add equals sign before entry for exact match"> (=) </span><span aria-label="accepts comma separated list" class="small">(,)</span></label>
				...
				$('##searchForm').bind('submit', function(evt){
					...
					$("##searchResultsGrid").jqxGrid({
						...
						columns: [
							...
							{ text: 'Subfamily', datafield: 'SUBFAMILY', width:120, hideable: true, hidden:false },
