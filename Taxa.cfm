					...
					<div class="col-12">
						<div class="tab-card-main mt-4 pb-2 tab-card"> 
							...
							<div class="card-header tab-card-header pb-0 w-100">
								<h1 id="content" class="h3 smallcaps text-white mt-1 mb-2 pl-1 w-50" tabindex="0">Search Taxonomy <a class="" style="color: white !important;" onClick="getMCZDocs('Taxonomy Search')"  href="##" aria-label="Link to MCZbase Wiki for more information"><i class="fa fa-info-circle small"></i></a><span class="count font-italic text-grayish mx-0"> <small>(#getCount.cnt# records)</small></span></h1>
							</div>
							<!--- End tab header div ---> 
