			...
			$(document).ready(function() {
				...
				$('##searchForm').bind('submit', function(evt){
					...
					$("##searchResultsGrid").on("bindingcomplete", function(event) {
						...
						$('##showhide').html('<button class="my-0 border rounded" title="hide search form" onclick=" toggleAnySearchForm(\'searchFormDiv\',\'searchFormToggleIcon\'); "><i id="searchFormToggleIcon" class="fas fa-eye-slash mx-2"></i></button>');
