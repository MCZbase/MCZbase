								...
								<div class="row mx-2 py-2">
									<div class="col-12 col-xl-3">
										...
										<div id=blurb class="smaller-text mt-2" tabindex="0">
											Search taxonomies used in MCZbase. <a class="" href="##" onClick="getMCZDocs('Taxonomy Search')"><i class="fa fa-info-circle" aria-label="hidden"></i></a> <a class="sr-only" style="color: transparent !important" tabindex="0"> link to more info </a> 
