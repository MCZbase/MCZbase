...
<cfoutput>
	...
	<cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_taxonomy")>
				...
				var linkIdCellRenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
					var rowData = jQuery("##searchResultsGrid").jqxGrid('getrowdata',row);
					var displayName = rowData['display_name_author']
					return '<span class="#cellRenderClasses#" style="margin-top: 8px; float: ' + columnproperties.cellsalign + '; "><a target="_blank" href="/taxonomy/showTaxonomy.cfm?taxon_name_id=' + rowData['TAXON_NAME_ID'] + '">'+display_name_author+'</a></span>';
				};
		</script>
