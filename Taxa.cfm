					...
					<div class="col-12">
						<div class="tab-card-main mt-1 pb-2 tab-card"> 
							...
							<div class="card-header tab-card-header pb-0 w-100">
								<h1 class="h3 smallcaps text-white mt-1 mb-2 pl-1">Search Taxonomy <span class="count font-italic text-grayish mx-0"><small>(#getCount.cnt# records)</small></span><i class="fas fas-info fa-info-circle" onClick="getMCZDocs('Taxonomy Search')" aria-label="help link"></i></h1>
							</div>
							<!--- End tab header div ---> 
