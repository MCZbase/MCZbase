									...
									<div class="col-12 px-2">
										...
										<fieldset class="bg-light border-right border-left border-top border-bottom field-set rounded px-2 pt-1 pb-1 mt-2 mx-2">
											...
											<div class="form-row mt-0">
												...
												<div class="form-group col-12 col-sm-6 col-md-2 mb-0 pb-0">
                                                    <span class="data-entry-label small">
                                                        <label for="subgenus" class="data-entry-label align-left font-weight-bold">Subgenus</label>
												...
												<div class="form-group col-12 col-sm-6 col-md-2 mb-0 pb-0">
                                                    <span class="data-entry-label small">
													    <label for="species" class="data-entry-label align-left font-weight-bold">Species</label> 
												...
												<div class="form-group col-12 col-sm-6 col-md-2 mb-0 pb-0">
													<span class="data-entry-label small">
                                                        <label for="subspecies" class="font-weight-lessbold">Subspecies </label>
												...
												<div class="form-group col-12 col-sm-6 col-md-2 mb-0 pb-0">
												    <span class="data-entry-label small">
                                                        <label for="author_text" class="font-weight-lessbold">Authorship</label>
												...
												<div class="form-group col-12 col-sm-6 col-md-2 mb-0 pb-0">
                                                    <span class="data-entry-label small">
                                                        <label for="infraspecific_author" class="font-weight-lessbold">Infrasp.&thinsp;Author</label>
									...
									<div class="col-12 px-2">
										<fieldset class="bg-light border-right border-left border-bottom border-top field-set rounded px-2 py-1 mt-2 mx-2">
											...
											<div class="form-row mt-0">
												...
												<div class="form-group col-12 col-lg-2 col-md-3 col-sm-6 mb-0 pb-0">
                                                    <span class="data-entry-label small">
                                                        <label for="phylum" class="font-weight-lessbold">Phylum</label> 
												...
												<div class="form-group col-12 col-lg-2 col-md-3 col-sm-6 mb-0 pb-0">
													<span class="data-entry-label small">
                                                        <label for="subphylum" class="font-weight-lessbold">Subphylum</label>
												...
												<div class="form-group col-12 col-lg-2 col-md-3 col-sm-6 mb-1 pb-0">
													<span class="data-entry-label small">
                                                        <label for="superclass" class="font-weight-lessbold">Superclass</label>
												...
												<div class="form-group col-12 col-lg-2 col-md-3 col-sm-6 mb-0 pb-0">
													<span class="h6">
                                                        <label for="infraclass" class="data-entry-label align-left font-weight-bold">Infraclass</label>
												...
												<div class="form-group col-12 col-lg-2 col-md-3 col-sm-6 mb-1 pb-0">
													<span class="data-entry-label small font-weight-lessbold">
                                                        <label for="suborder" class="data-entry-label align-left font-weight-bold">Suborder</label>
