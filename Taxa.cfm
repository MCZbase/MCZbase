          ...
          <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
			...
			<section class="container-fluid" role="search">
				<div class="row mx-0 mb-3">
                     <div class="d-flex flex-wrap mx-0 mb-0 mr-md-4 ml-md-4">
			...
			$(document).ready(function() {
				...
				$('##searchForm').bind('submit', function(evt){
					...
					$("##searchResultsGrid").on("bindingcomplete", function(event) {
						...
						$('##showhide').html('<button class="my-2 border rounded" style="margin-top: .2rem;" title="hide search form" onclick=" toggleAnySearchForm(\'searchFormDiv\',\'searchFormToggleIcon\'); "><i id="searchFormToggleIcon" class="fas fa-eye-slash"></i></button>');
