	...
	<div id="overlaycontainer" style="position: relative;">
		...
		<script>
			...
			function gridLoaded(gridId, searchType) { 
				...
				$('##resultDownloadButtonContainer').html('<button id="loancsvbutton" class="btn-xs btn-secondary px-3 mx-1 mb-1" aria-label="Export results to csv" onclick=" exportGridToCSV(\'searchResultsGrid\', \''+filename+'\'); " >Export to CSV</button>');
			}
