                                            ...
                                            <div class="form-row mt-0">             
                                                    ...
                                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 px-0 mb-0 pb-0">
                                                     ...
                                                     <cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_taxonomy")>
                                                        ...
                                                        <div class="d-flex flex-wrap col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4 px-0 mb-0 pb-0">
                                                    ...
                                                    <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 col-xl-4 px-0 mb-0 pb-0">
