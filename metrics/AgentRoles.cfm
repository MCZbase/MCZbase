...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-12">
				<p>Data <a href="#filePath##targetFile#">download table</a>. 
<!---This data comes from a temporary table in the database generated by a procedure and scheduled job which is then queried by CF to create the csv.--->
			</div>
		</div>
		<div class="row">
			<div class="col-12">
				<p>Stacked Barchart with outlier y-axis showing greater than 100,000 total counts (instances of agent activity).</p>
			</div>
			<div class="col-12">
