				...
				<br clear="all">	
					...
					<div class="sidebar-sticky pt-4 px-2" style="background-color: ##efeded;">
						<form id="loadReportForm">
							...
							<input type="hidden" id="annualReport" name="annualReport" value="no">
				...
				<!---			<form id="loadAnnualReport">
					...
					<main role="main" class="col-md-9 px-3 ml-sm-auto col-lg-10 mb-3">
						<div class="col-12 mt-4">
							...
							<cfset summaryAnnualBlock=getLoanNumbers(endDate="#endDate#",beginDate="#beginDate#",annualReport="#no#",returnFormat="#plain#")>
