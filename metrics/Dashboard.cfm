						...
						<div class="card-body">
							<div class="col-12 mt-4">
								...
								<div id="divOne" style="border: 2px solid ##ddd;padding:0 15px 0 15px;">
									<cfset summaryAnnualBlock1=getNumbers(endDate="#endDate#",beginDate="#beginDate#",annualReport="#annualReport#")>
									<div id="annualNumbersDiv1" class="py-2"> 
										#summaryAnnualBlock1#
									</div>
								</div>
								<div id="divTwo" style="border: 2px solid lightsalmon;padding:0 15px 0 15px;">
									<cfset summaryAnnualBlock2=getAquisitions(endDate="#endDate#",beginDate="#beginDate#",annualReport="#annualReport#")>
