		...
		<cfoutput>
			<cftry>
				...
				<section class="col-12 mt-3 px-0">
					<h2 class="h3 px-2">Holdings <span class="font-italics">(#encodeForHtml(beginDate)#/#encodeForHtml(endDate)#)</span></h2>
				...
				<section class="col-12 mt-3 px-0">
					<h2 class="h3 px-2">Holdings (continued) (#encodeForHtml(beginDate)#/#encodeForHtml(endDate)#)</h2>
					<table class="table table-responsive table-striped d-lg-table" id="t">
						<thead>
							<tr>
								<th><strong>Collection</strong></th>
