...
main_plot <- ggplot(main_data, aes(x = AgentInfo, y = AdjustedCount, fill=Role)) +
    ...
    theme(plot.title = element_text(size=rel(0.4), family="Roboto Black"),
        plot.margin = margin(t=0,r=1,b=0,l=8),
        ...
        legend.box.margin = margin(t=1,r=1,b=1,l=0), # Tighten the box margin if needed
        ...
        legend.margin = margin(t=3, r=3, b=3, l=3)#inside of box
    )
