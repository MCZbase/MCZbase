...
<cftry>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12">
				<p>Data that is imported into the R script is /metrics/datafiles/chart_data.csv and available here: <a href="/metrics/datafiles/chart_data.csv">download table</a></p>. This data comes from a temporary table in the database generated by a procedure and scheduled job which is then queried by CF to create the csv.
			</div>
		</div>
		<div class="row">
			<div class="col-12">
