...
<cfexecute name = "/usr/bin/Rscript https://mczbase-dev.rc.fas.harvard.edu/metrics/R/bubble_graph.R" arguments = "https://mczbase-dev.rc.fas.harvard.edu/metrics/R/bubble_graph.R" variable = "ChartData" timeout = "100"> </cfexecute>
