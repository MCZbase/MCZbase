...
SELECT rm.holdings as "HOLDINGS",h.collection as "COLLECTION",h.catalogeditems as "CATALOGED_ITEMS",h.specimens as "SPECIMENS",p.primaryCatItems as "PRIMARY_CATALOGED_ITEMS",p.primaryspecimens as "PRIMARY_SPECIMENS",s.secondaryCatItems as "SECONDARY_CATALOGED_ITEMS",s.secondarySpecimens as "SECONDARY_SPECIMENS"
FROM (select collection_cde,institution_acronym,descr,collection,collection_id from collection where collection_cde <> 'MCZ' and collection <> 'Special Collections' and collection <> 'Herpetology Observations' and collection <> 'Cryogenic') c
