	...
	<main class="container py-3" id="content">
		<section class="row">
			<div class="col-12">
				...
				<p>Each label has its own idiosyncratic history and intended purposes, read the descriptions carefully.  <strong>Department(s)</strong> lists the department or departments for which the reports were designed, this does not limit use to particular department, but data from other departments may or may not fit the assumptions of the report.  <strong>Shown</strong> indicates whether a particular report will be shown to you on the Print any report page by default, or if you need to click through the Show All Reports link at the bottom of that page to access that report.  The list of collections for which reports can be seen is configured for each user, if you or another user do not have Shown="By Default" for the desired set of labels, please file a bug report for the user and the desired list of collections.  <strong>Use</strong> is a guideline, though many Fluid reports will not produce labels for Dry specimens.  Every report has a different set of conditions and assumptions, these are spelled out in the <strong>Description</strong>.  Pay carefull attention to highlighted information, particularly cases where labels will not work as might be expected for types.  <strong>Types</strong> indicates reports that have been designed to work with type specimens.  <strong>Part Limit</strong> and <strong>Preserve Limit</strong> denote reports that include picklists allowing the generated PDF pages to be filtered to produced labels for only particular part types or preservation methods, if you would like these limits added to a report that does not have them, please file a bug report.  If a label does not meet current needs, file a bug report for tuning or requesting a new label.</p>
