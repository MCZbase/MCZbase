...
<cffunction name="format_uam_box" access="public" returntype="Query">
	...
	<cfloop query="d">
		...
		<cfloop list="#parts#" delimiters=";" index="p">
		    <!--- PJM: Substantive difference between 2.5.1 and 3.9, 3.9 has:  <cfif #p# contains "frozen">  ---> 
			<cfif #p# contains "(">
...
<cffunction name="get_loan_mcz" access="public" returntype="Query">
    <cf_getLoanFormInfo>
    <cfquery name="d" dbtype="query">
...
<cffunction name="get_loan_items" access="public" returntype="Query">
    <cf_getLoanFormInfo>
    <cfquery name="d" dbtype="query">
        select * from getLoanItems
    </cfquery>
    <cfreturn d>
</cffunction>

<cffunction name="get_loan_items_mcz" access="public" returntype="Query">
    <cf_getLoanFormInfo>
    <cfquery name="d" dbtype="query">
...
<!-------------------------------------------------------------->
<cffunction name="get_deacc_mcz" access="public" returntype="Query">
    <cf_getLoanFormInfo>
    <cfquery name="d" dbtype="query">
        select * from getDeaccMCZ
    </cfquery>
    <cfreturn d>
</cffunction>

<cffunction name="get_deacc_items_mcz" access="public" returntype="Query">
    <cf_getLoanFormInfo>
    <cfquery name="d" dbtype="query">
        select * from getDeaccItemsMCZ
    </cfquery>
    <cfreturn d>
</cffunction>
