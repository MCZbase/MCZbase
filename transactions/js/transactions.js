...
function addTransAgentToForm (id,name,role,formid) {
	...
	jQuery.getJSON("/transactions/component/functions.cfc",
		...
		function (data) {
			...
			var d='<article class="list-even pt-1 my-1 border-top border-bottom"><div class="input-group"><div class="col-12 col-md-5 mb-0"><div class="input-group">';
			...
			d+='</select></div><div class="col-2 col-md-1 mb-0"><label class="form-check-label data-entry-label pl-0 smaller">Delete?</label>';
