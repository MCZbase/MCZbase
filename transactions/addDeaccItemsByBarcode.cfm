...
<cfif action is "nothing">
	<cfoutput>
		<main class="container" id="content">
			...
			<section class="row">
				<h2 class="h3">Adding parts to deaccession: #encodeForHtml(l.collection)# #encodeForHtml(l.deacc_number)#</h2>
				...
				<cfelse>
					...
					<table border>
						<tr>
							...
							<th>Specimen</th>
							<th>ID</th>
							<th>#encodeForHtml(session.CustomOtherIdentifier)#</th>
							<th>Part</th>
							<th>PartCondition</th>
							<th>SS?</th>
						</tr>
				...
				<h3 class="h4 mt-1">Add Parts by Barcode</h3>
