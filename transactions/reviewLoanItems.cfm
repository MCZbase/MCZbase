								...
								$("##searchResultsGrid").jqxGrid({
									...
									columns: [
										<cfif isClosed>
											...
											{text: 'Remove', datafield: 'RemoveRow', width: 80, hideable: true, hidden: true, cellsrenderer: deleteCellRenderer, editable: false },
										<cfelseif isInProcess>
											...
											{text: 'Remove', datafield: 'RemoveRow', width: 80, hideable: false, hidden: false, cellsrenderer: deleteCellRenderer, editable: false },
										<cfelse>
											{text: 'Edit', datafield: 'EditRow', cellsrenderer:editCellRenderer, width: 40, hidable:true, hidden: false, editable: false },
											{text: 'Remove', datafield: 'RemoveRow', width: 80, hideable: true, hidden: true, cellsrenderer: deleteCellRenderer, editable: false },
											<cfif aboutLoan.loan_type EQ 'returnable'>
												{text: 'Return', datafield: 'ReturnRow', width: 80, hideable: true, hidden: false, cellsrenderer: returnCellRenderer, editable: false },
