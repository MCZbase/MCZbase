						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="add-form mt-2">
										<div class="add-form-header pt-1 px-2">
											<h2 class="h2">Deaccession Item <a href="/guid/#guid#" target="_blank">#guid#</a> #part_name# (#preserve_method#) in #deacc_number# #deacc_type# #deacc_status# <span class="smaller">[part collection_object_id: #lookupItem.part_id#]</span></h2>
											<cfif is_subsample EQ "yes">
