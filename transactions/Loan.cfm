...
#cfcatch.detail#
		...
		<cftry>
			...
			<form name="editloan" id="editLoan" action="/transactions/Loan.cfm" method="post">
				<div class="row mt-3">
					<div class="col-12 col-md-9 offset-xl-1">
				...
				$( document ).ready(loadShipments(#transaction_id#));
					...
					$("##dialog-shipment").dialog({
						...
						close: function() {
							...
							<div class="addstyle">
								<input type="button" class="btn btn-xs btn-primary float-left mr-4" value="Add Shipment" onClick="$('##dialog-shipment').dialog('open'); setupNewShipment(#transaction_id#);">
