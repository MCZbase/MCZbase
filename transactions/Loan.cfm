		...
		<main class="container py-3" id="content" aria-labelledby="newLoanFormSectionLabel">
			...
			<div class="row border rounded bg-light mt-2 mb-4 px-2 pt-2 pb-4 pb-sm-2">
				...
				<section class="col-12" aria-labeledby="nextNumberSectionLabel"> 
					<div id="nextNumDiv">
						<h2 class="h4 mx-2 mb-1" id="nextNumberSectionLabel" title="Select a collection button and the next loan number for that collection that's available in the database will be entered">Next Available Loan Number:</h2>
