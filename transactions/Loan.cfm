						...
						$(document).ready(function() {
							...
							<div class="col-12 col-md-4">
									...
									<div id="project" class="p-3 mb-2 bg-light mt-4 border text-dark">
										<h3>Projects associated with this loan: <i class="fas fas-info fa-info-circle pr-4 wikiInfo" onClick="getMCZDocs('Loan_Transactions##Projects_and_Permits')" aria-label="help link"></i></h3>
