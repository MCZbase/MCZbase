              ...
              <tr>
				...
				<td>
					...
					<fieldset style="margin-left: 0; width: 415px;">
						<input type="radio" id="searchPubs" name="search_type" value="publications" checked="checked"  class="float-left mt-1" style="width:15px;">
						<label for="searchPubs">Search Publications Only</label>
						<input type="radio" id="searchProj" name="search_type" value="projects"  class="float-left mt-1" style="width:15px;">
						<label for="searchProj">Search Projects Only</label>
						<input type="radio" id="searchBoth" name="search_type" value="both" class="float-left mt-1" style="width:15px;">
