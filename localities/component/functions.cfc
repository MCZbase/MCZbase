		...
		<cftry>
			...
			<cfoutput>
				<form id="addGeoAttForm">
					...
					<input type="hidden" name="locality_id" value="#locality_id#">
					<h2 class="h3 mb-2">Add a geological attribute for locality: <span class="font-weight-bold">#encodeForHtml(getLabel.locality_label)#</span></h2>
					<div class="form-row">
						...
						<div class="tab-content flex-wrap d-flex">
									...
									<div class="form-row">
										...
										<div class="col-12 mb-2">
											...
											<textarea name="lat_long_remarks" id="lat_long_remarks" 
												...
												class="form-control form-control-sm w-100 autogrow mb-1" rows="2" style="min-height: 50px;"></textarea>
											<script>
												// Bind input to autogrow function on key up, and trigger autogrow to fit text
												$(document).ready(function() { 
							...
							<div id="geolocatePanel" role="tabpanel" aria-labelledby="geolocateTabButton" tabindex="-1" class="col-12 px-0 mx-0 unfocus" hidden>
								<form id="geolocateForm">
									...
									<input type="hidden" name="locality_id" value="#locality_id#">
									<h2 class="px-1 h3">Use GeoLocate: <input type="button" value="GeoLocate" class="btn btn-xs btn-warning text-dark" style="opacity: .5;" onClick=" geolocate('#Application.protocol#'); "></h2>
										...
										<div class="postGeolocate col-12 float-left px-1 mb-2">
											...
											<textarea name="lat_long_remarks" id="gl_lat_long_remarks" 
												...
												class="form-control form-control-sm w-100 autogrow mb-1" style="min-height: 50px;" rows="2"></textarea>
											<script>
												// Bind input to autogrow function on key up, and trigger autogrow to fit text
												$(document).ready(function() { 
													$("##lat_long_remarks").keyup(autogrow);  
						...
						<form id="editGeorefForm">
							...
							<div class="form-row">
								...
								<div class="col-12 mb-2">
									...
									<textarea name="lat_long_remarks" id="lat_long_remarks" 
										onkeyup="countCharsLeft('lat_long_remarks', 4000, 'length_lat_long_remarks');"
										class="form-control form-control-sm w-100 autogrow mb-1" style="min-height: 50px;" rows="2">#encodeForHtml(lat_long_remarks)#</textarea>
									<script>
										// Bind input to autogrow function on key up, and trigger autogrow to fit text
										$(document).ready(function() { 
											$("##lat_long_remarks").keyup(autogrow);  
