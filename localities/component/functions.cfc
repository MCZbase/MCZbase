...
<cffunction name="georeferenceDialogHtml" access="remote" returntype="string">
	...
	<cfthread name="getGeorefThread#tn#">
		<cftry>
			...
			<cfoutput>
				<h2 class="h4 mt-0">Add a georeference for locality: <span class="font-weight-lessbold">#encodeForHtml(locality_label)#</span>
				<span class="small col-12 d-block px-0 pb-1">See: Chapman A.D. &amp; Wieczorek J.R. 2020, Georeferencing Best Practices. Copenhagen: GBIF Secretariat. <a href="https://doi.org/10.15468/doc-gg7h-s853" target="_blank">DOI:10.15468/doc-gg7h-s853</a>.</span></h2>
				<div>
