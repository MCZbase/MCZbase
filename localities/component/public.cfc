		...
		<cfoutput>
			<cftry>
				...
				<cfif isDefined("context") and context EQ "edit" AND getVerbatim.recordcount LT 21 >
					...
					<div class="h4">Collecting Events <a href="/localities/CollectingEvents.cfm?action=search&execute=true&method=getCollectingEvents&locality_id=863509&accentInsensitive=1&include_counts=1" target="_blank">(#getEventList.recordcount#)</a></div>
					<ul class="px-2 pl-xl-4 ml-xl-1">
