...
<cffunction name="getLocalitySummary" returntype="string" access="remote" returnformat="plain">
	...
	<cfloop query="lookupLocality">
		...
		<cfif len(dec_lat) GT 0>
			<cfset coordinates = " <span class='sr-only'>Coordinates </span> #dec_lat#, #dec_long# <span class='sr-only'>Datum </span>#datum# <span class='sr-only'>Point uncertainty </span>±#max_error_distance# #max_error_units# #verificationstatus# ">
		<cfelse> 
