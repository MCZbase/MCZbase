...
<cffunction name="getCollectingEvents_queryExecute" access="remote" returntype="any" returnformat="json">
   ...
   <cfargument name="collecting_event_id" type="string" required="no">
	...
	<cftry>
		...
		<cfif structKeyExists(arguments,"collecting_event_id") AND len(arguments.collecting_event_id) gt 0><cfset whereClauses = appendSetupNumericClauseCondition(whereClauses,sqlParams,"locality.collecting_event_id",arguments.collecting_event_id,"collecting_event_id")></cfif>
