...
<section class="container-fluid" role="search" title="Geography, Locality, Collecting Event Search Form">
	<cfif pageTitle = "Search Higher Geographies"><h1 class="h2 mt-2 px-1">Find Higher Geography</h1></cfif>
	<cfif pageTitle = "Search Localities"><h1 class="h2 mt-2 px-1">Find Locality</h1></cfif>
	<cfif pageTitle = "Search Localities"><h1 class="h2 mt-2 px-1">Search Collecting Events</h1></cfif>
