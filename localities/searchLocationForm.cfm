				...
				<div class="col-12 mt-0">
					...
					<div class="form-row mx-0 my-1">
						<div class="col-5 col-md-2 col-xl-2 px-3 pl-md-3 pr-md-2 py-1">
							...
							<select name="orig_elev_units" id="orig_elev_units" size="1" class="data-entry-select w-auto" style="min-width: 38%;">
								<option value=""></option>
					...
					<div class="form-row mx-0 my-1">
						<div class="col-5 col-md-2 col-xl-2 px-3 pl-md-3 pr-md-2 py-1">
							...
							<select name="depth_units" id="depth_units" size="1" class="data-entry-select w-auto"  style="min-width: 38%;">
								<option value=""></option>
					...
					<div class="form-row mx-0 my-1">
						<div class="col-12 col-md-5 col-xl-3 px-3 pr-md-0 py-2">
