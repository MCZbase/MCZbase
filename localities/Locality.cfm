...
<cfswitch expression="#action#">
	...
	<cfdefaultcase>
		<cfthrow message="<h2 class='h4 text-danger'>Error: Unknown Action</h2">
	</cfdefaultcase>
</cfswitch>
		...
		<cfoutput>
			<main class="container-fluid my-2" id="content">
				...
				<section class="col-12 col-md-9 px-md-0 col-xl-8 px-xl-0">
					<div class="col-12 px-0 pl-md-0 pr-md-3">
						...
						<div class="border rounded px-3 my-2 py-3" arial-labeledby="formheading">
							...
							<cfif countUses.total_uses GT "0">
								<button type="button" class="btn btn-xs btn-secondary" style="left: 22rem;margin-top: -1.7rem;position: relative;" onClick=" location.assign('/localities/Locality.cfm?action=new&clone_from_locality_id=#encodeForUrl(locality_id)#');" >Clone Locality</button>
							</cfif>
					...
					<div class="col-12">
						<div class="border bg-light rounded py-3 pr-md-3 pl-md-0 my-2">
