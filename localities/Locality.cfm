					...
					<div class="col-12 px-0 pl-md-0 pr-md-3">
						...
						<div class="border rounded px-3 my-2 pt-2 pb-3" arial-labeledby="formheading">
							...
							<cfif countUses.total_uses GT "0">
								<div class="row mx-0">
									<button type="button" class="btn btn-xs btn-secondary float-right mx-2" onClick=" location.assign('/localities/Locality.cfm?action=new&geog_auth_rec_id=#encodeForUrl(localityExists.geog_auth_rec_id)#');" >New Locality in same higher geography</button>
									<button type="button" class="btn btn-xs btn-secondary float-right mx-2" onClick=" location.assign('/localities/Locality.cfm?action=new&clone_from_locality_id=#encodeForUrl(locality_id)#');" >Clone Locality</button>
								</div>
							</cfif>
							<div class="row mx-0">
