			...
			<main class="container-fluid mt-3 pb-5 mb-5" id="content">
				...
				<section class="col-12 col-md-9 px-md-0 col-xl-8 px-xl-0">
					<div class="col-12 px-0 pl-md-0 pr-md-3">
						<h1 class="h2 mt-3 mb-0 px-3">Edit Locality [<a href="/localities/viewLocality.cfm?locality_id=#localityExists.locality_id#" target="_blank">#encodeForHtml(locality_id)#</a>]</h1>
