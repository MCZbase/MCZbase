					...
					<div class="col-12 px-0 pl-md-0 pr-md-3">
						...
						<div class="border rounded px-3 my-2 py-3" arial-labeledby="formheading">
							...
							<cfif countUses.total_uses GT "0">
								<button type="button" class="btn btn-xs btn-secondary ml-auto" style="margin-top: -1.75rem" onClick=" location.assign('/localities/Locality.cfm?action=new&clone_from_locality_id=#encodeForUrl(locality_id)#');" >Clone Locality</button>
							</cfif>
