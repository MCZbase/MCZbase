						...
						$('##searchForm').bind('submit', function(evt){
							...
							var search =
							{
								...
								[
									...
									{ name: 'COORDINATEUNCERTANTYINMETERS', type: 'string' },
							...
							$("##searchResultsGrid").jqxGrid({
								...
								columns: [
									...
									{ text: 'coordinateUncertantyInMeters', datafield: 'COORDINATEUNCERTANTYINMEERS', width: 100, hideable: true, hidden: getColHidProp('COORDINATEUNCERTANTYINMETERS',true) },
