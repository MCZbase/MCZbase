				...
				<script>
					...
					function makeSummary(rowData) { 
						...
						if (minDepth) { 
							...
							depthval = " Depth: " + maxDepth + " " + depthUnits + ". ";
						} else {
							depthval = "";
						}
						...
						$('##searchForm').bind('submit', function(evt){
							...
							$("##searchResultsGrid").jqxGrid({
								...
								columns: [
									...
									{ text: 'Cat.Items', datafield: 'SPECIMEN_COUNT',width: 100, hideable: true, hidden: getColHidProp('SPECIMEN_COUNT',false), cellsrenderer: specimensCellRenderer  },
									{ text: 'Coll Events', datafield: 'COLLECTING_EVENT_COUNT',width: 100, hideable: true, hidden: getColHidProp('COLLECTING_EVENT_COUNT',false), cellsrenderer: collectingEventCellRenderer  },
									{ text: 'Locality_id', datafield: 'LOCALITY_ID',width: 100, hideable: true, hidden: getColHidProp('LOCALITY_ID',true) },
									{ text: 'Locality Summary', datafield: 'summary',width: 500, hideable: true, hidden: getColHidProp('summary',false) },
									{ text: 'Specific Locality', datafield: 'SPEC_LOCALITY',width: 200, hideable: true, hidden: getColHidProp('SPEC_LOCALITY',true)  },
									{ text: 'Vetted', datafield: 'CURATED_FG',width: 50, hideable: true, hidden: getColHidProp('CURATED_FG',false)  },
									{ text: 'Locality Remarks', datafield: 'LOCALITY_REMARKS',width: 100, hideable: true, hidden: getColHidProp('LOCALITY_REMARKS',true)  },
									{ text: 'Min Depth', datafield: 'MIN_DEPTH',width: 100, hideable: true, hidden: getColHidProp('MIN_DEPTH',true)  },
									{ text: 'Max Depth', datafield: 'MAX_DEPTH',width: 100, hideable: true, hidden: getColHidProp('MAX_DEPTH',true)  },
									{ text: 'Depth Units', datafield: 'DEPTH_UNITS',width: 100, hideable: true, hidden: getColHidProp('DEPTH_UNITS',true)  },
									{ text: 'Min Depth m', datafield: 'MIN_DEPTH_METERS',width: 100, hideable: true, hidden: getColHidProp('MIN_DEPTH_METERS',true)  },
									{ text: 'Max Depth m', datafield: 'MAX_DEPTH_METERS',width: 100, hideable: true, hidden: getColHidProp('MAX_DEPTH_METERS',true)  },
									{ text: 'Min Elevation', datafield: 'MINIMUM_ELEVATION',width: 100, hideable: true, hidden: getColHidProp('MINIMUM_ELEVATION',true)  },
									{ text: 'Max Elevation', datafield: 'MAXIMUM_ELEVATION',width: 100, hideable: true, hidden: getColHidProp('MAXIMUM_ELEVATION',true)  },
									{ text: 'Elev Units', datafield: 'ORIG_ELEV_UNITS',width: 100, hideable: true, hidden: getColHidProp('ORIG_ELEV_UNITS',true)  },
									{ text: 'Min Elevation m', datafield: 'MIN_ELEVATION_METERS',width: 100, hideable: true, hidden: getColHidProp('MIN_ELEVATION_METERS',true)  },
									{ text: 'Max Elevation m', datafield: 'MAX_ELEVATION_METERS',width: 100, hideable: true, hidden: getColHidProp('MAX_ELEVATION_METERS',true)  },
									...
									{ text: 'Continent/Ocean', datafield: 'CONTINENT_OCEAN',width: 100, hideable: true, hidden: getColHidProp('CONTINENT_OCEAN',true)  },
									{ text: 'Ocean Region', datafield: 'OCEAN_REGION',width: 100, hideable: true, hidden: getColHidProp('OCEAN_REGION',true)  },
									{ text: 'Ocean Subregion', datafield: 'OCEAN_SUBREGION',width: 100, hideable: true, hidden: getColHidProp('OCEAN_SUBREGION',true)  },
									{ text: 'Sea', datafield: 'SEA',width: 100, hideable: true, hidden: getColHidProp('SEA',true)  },
									{ text: 'Water Feature', datafield: 'WATER_FEATURE',width: 100, hideable: true, hidden: getColHidProp('WATER_FEATURE',true)  },
									{ text: 'Island Group', datafield: 'ISLAND_GROUP',width: 100, hideable: true, hidden: getColHidProp('ISLAND_GROUP',true)  },
									{ text: 'Island', datafield: 'ISLAND',width: 100, hideable: true, hidden: getColHidProp('ISLAND',true)  },
									{ text: 'Country', datafield: 'COUNTRY',width: 100, hideable: true, hidden: getColHidProp('COUNTRY',true)  },
									{ text: 'Sovereign Nation', datafield: 'SOVEREIGN_NATION',width: 100, hideable: true, hidden: getColHidProp('SOVEREIGN_NATION',true)  },
									{ text: 'State/Province', datafield: 'STATE_PROV',width: 100, hideable: true, hidden: getColHidProp('STATE_PROF',true)  },
									{ text: 'County', datafield: 'COUNTY',width: 100, hideable: true, hidden: getColHidProp('COUNTY',true)  },
									{ text: 'Feature', datafield: 'FEATURE',width: 100, hideable: true, hidden: getColHidProp('FEATURE',true)  },
									{ text: 'Quad', datafield: 'QUAD',width: 100, hideable: true, hidden: getColHidProp('QUAD',true)  },
									{ text: 'PLSS', datafield: 'PLSS',width: 100, hideable: true, hidden: getColHidProp('PLSS',true)  },
									{ text: 'Geological Attributes', datafield: 'GEOLATTS',width: 250, hideable: true, hidden: getColHidProp('GEOLATTS',true)  },
									{ text: 'Departments', datafield: 'COLLCOUNTLOCALITY',width: 100, hideable: true, hidden: getColHidProp('COLLCOUNTLOCALITY',true)  },
									{ text: 'Valid', datafield: 'VALID_CATALOG_TERM_FG',width: 50, hideable: true, hidden: getColHidProp('VALID_CATALOG_TERM_FG',true)  },
									{ text: 'Source Authority', datafield: 'SOURCE_AUTHORITY',width: 100, hideable: true, hidden: getColHidProp('SOURCE_AUTHORITY',true)  },
									{ text: 'WKT', datafield: 'WKT_POLYGON',width: 80, hideable: true, hidden: getColHidProp('WKT_POLYGON',true)  },
									{ text: 'GUID Type', datafield: 'HIGHERGEOGRAPHYID_GUID_TYPE',width: 100, hideable: true, hidden: getColHidProp('HIGHERGEOGRPAHYID_GUID_TYPE',true)  },
									{ text: 'GUID', datafield: 'HIGHERGEOGRAPHYID',width: 100, hideable: true, hidden: getColHidProp('HIGHERGEOGRAPHYID',true)  }, 
									{ text: 'Higher Geography', datafield: 'HIGHER_GEOG', hideable: true, hidden: getColHidProp('HIGHER_GEOG',false) }
								],
								rowdetails: true,
								rowdetailstemplate: {
