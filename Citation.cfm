	...
	<table class="pubtable" border="0" style="border: none;font-size: 15px;margin-top:1.5rem;">
		<thead style="background-color: ##beecea;padding: 11px;line-height: 1.5rem;">
			<tr>
				<th>&nbsp;</th>
				<th>Cat Num</th>
				<cfif len(#session.CustomOtherIdentifier#) GT 0><th>#session.CustomOtherIdentifier#</th><cfelse><th></th></cfif>
				<th>Cited As</th>
				<th>Current ID</th>
				<th>Citation Type</th>
		...
		<tbody>
			...
			<cfloop query="getCited">
				<tr>
					...
					<cfif len(#getCited.CustomID#) GT 0><td nowrap="nowrap">#getCited.CustomID#</td><cfelse><td>&nbsp;</td></cfif>
