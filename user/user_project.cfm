...
<cfquery name="isGood" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfquery name="getUser" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	select 
		username,
		cf_users.user_id,
		first_name,
...
<p>
			...
			You must provide a project description before you may request a loan. A project may request multiple loans. You may view other project descriptions at <a href="/Projects.cfm">ProjectSearch</a>.
...
<cfquery name="items" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	select
...
<cfquery name="ctUse" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfoutput>
<cfquery name="edProj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	UPDATE CF_LOAN
		SET
		loan_name = '#loan_name#',
