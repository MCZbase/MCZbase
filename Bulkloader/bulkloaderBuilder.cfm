...
<cfoutput>
	...
	<cfset partA="">
	<cfloop from="1" to="#n#" index="i">
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_1")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_2")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_3")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_4")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_5")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_6")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_7")>
		...
		<cfset partA=listappend(partA,"PART_" & i & "1_ATT_NAME_8")>
