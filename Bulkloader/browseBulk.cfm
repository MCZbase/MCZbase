	...
	<cfoutput>
		...
		<cfform method="post" action="browseBulk.cfm">
			...
			<cfgrid attributeCollection="#args#">
				...
				<cfgridcolumn name="collection_object_id" select="no" display="yes" href="/DataEntry.cfm?action=editEnterData&pMode=edit&ImAGod=yes&enteredby2=#enteredby#&accn2=#accn#&colln2=#colln#&width=100" 
					hrefkey="collection_object_id" target="_blank" header="Key (temp value)" headeritalic="true">
