...
<cfif action is "ajaxGrid">
	...
	<h1 class="h2">Grid of New Cataloged Items to be Loaded</h1>
		...
		<ul class="pb-3">
			...
			<li>Double click fields to edit. Use "control" + "F" to bring field to focus on your screen&mdash;This is less helpful for inserting values into empty columns because it doesn't find column headers. </li>
		</ul>
		<cfoutput>
		<cfquery name="cNames" datasource="uam_god">
