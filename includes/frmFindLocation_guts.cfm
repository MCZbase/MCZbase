	...
	<table class="table table-responsive">
		...
		<tr>
			<td><div class="locGroup"> <span id="geogDetailCtl" class="infoLink" onclick="toggleGeogDetail(1)";>Show More Options</span>
									...
									<tr>
										...
										<td><label for="findHasGeoRef">Has Georeferences
											...
											<label for="findNoAccGeoRef">No Accepted Georeferences
												<input type="checkbox" name="findNoAccGeoRef" id="findNoAccGeoRef" class="checkbox">
											</label></td>
									</tr>
									<tr>
										...
										<td><label for="isIncomplete">isIncomplete
											...
											<label for="nullNoGeorefBecause">NULL NoGeorefBecause
												<input type="checkbox" name="nullNoGeorefBecause" id="nullNoGeorefBecause" class="checkbox">
											</label></td>
									</tr>
										<tr>
				...
				<cfif #showEvent# is 1>
					<div class="locGroup"> <span id="eventDetailCtl" class="infoLink" onclick="toggleEventDetail(1)";>Show More Options</span>
						<table class="table">
							<tr>
				...
				onmouseout="this.className='clrBtn'"></td>
						<td><cfif showLocality is 1 AND showSpecimenCounts>
