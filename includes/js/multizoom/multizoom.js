...
var featuredimagezoomer = { // the two options for Featured Image Zoomer:
	loadinggif: 'includes/js/multizoom/spinningred.gif', // full path or URL to "loading" gif
...
(function($){
	...
	$.extend(featuredimagezoomer, {
		...
		showimage: function($tracker, $mag, showstatus){
			...
			specs.$statusdiv.html('<span class="small">Zoom Level:</span> '+specs.curpower+'<div class="smaller">Use Mouse Wheel to Zoom In/Out</div>');
