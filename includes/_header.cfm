...
<cfoutput>
	...
	<div id="headerContent" style="background-color: #Application.old_header_color#;">
		<div id="image_headerWrap">
			<div class="headerText">
				...
				<!---  WARNING: Styles set on these elements must not set the color, this is set in a server specific variable from Application.cfc --->
				<h1 style="color:#Application.old_collectionlinkcolor#;">#Application.old_collection_link_text#</h1>
