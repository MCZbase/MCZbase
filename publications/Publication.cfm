						...
						<form name="newPubForm" id="newPubForm" method="post" action="/publications/Publication.cfm">
							...
							<div class="form-row">
								...
								<div class="col-12 col-md-1 ml-0 row mb-0">
									<div class="col-2 col-md-6 ml-0 mr-0 px-0 my-0 mt-md-4 mb-md-2">
										<ul class="list-group pt-0 px-2 mt-md-3">
									...
									<div class="col-2 col-md-6 ml-0 px-0 my-0 mt-md-4 mb-md-2">
										<ul class="list-group pt-0 px-2 pt-md-3">
											<li class="list-group-item m-1">
												<button type="button" class="btn btn-xs btn-secondary m-0 w-100" onclick="markup('publication_title','sub')" aria-label="make text subscript">A<sub>2</sub></button>
											</li>
											<li class="list-group-item m-1">
