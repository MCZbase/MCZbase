...
<cfif NOT isdefined("media_id") OR len(media_id) EQ 0>
	...
	<cfabort>
<cfelse>
	<cfquery name="media" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="media_result" timeout="#Application.short_timeout#">
		SELECT
