									...
									<tr>
										...
										<td style="width:60%;">
											<cfloop query="relm">
												...
												<cfif len(media.media_id) gt 0>
													<cfif isDefined(relm.media_id) and relm.media_id eq #media.media_id#><cfset activeimg = "border-warning border-top border-bottom border-right border"><cfelse><cfset activeimg = ""></cfif>
