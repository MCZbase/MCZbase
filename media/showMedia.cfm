								...
								<div class="row mx-0 border-bottom border-gray">
									...
									<div class="col-6">
										<cfif relm.recordcount lte #maxMedia#>
											<cfloop query="relm">
												<div class="border-light col-3 float-left mr-2 px-0 py-1 mb-0"> <!---style="width:112px;height: 175px">--->
													<cfif len(media.media_id) gt 0>
														<cfif relm.media_id eq '#media.media_id#'> 
															<cfset activeimg = "border-warning bg-white float-left border-left p-1 border-right border-bottom border-top">
														<cfelse>	
															<cfset activeimg = "border-lt-gray bg-white float-left p-1">
														</cfif>
														...
														<div class="#activeimg#" id="mediaBlock#relm.media_id#">
															<div class="col-5 bg-white px-1 pb-0 pt-2 float-left" style="max-height: 130px;"> #mediablock# </div>
