				...
				<div class="row mx-0">
					...
					<table class="search-box table mt-1 w-100">
						...
						<tbody>
							<cfloop query="ff">
								<tr>
									<td><a href="#auto_protocol#/#auto_host#/guid/#ff.guid#">#ff.guid#</a></td>
									...
									<td>
										<cfloop query="relm">
											<cfif len(media.media_id) gt 0>
												<cfset mediablock= getMediaBlockHtml(media_id="#relm.media_id#",displayAs="fixedSmallThumb",size='100',captionAs="textLinks")>
