											...
											<ul class="list-group list-group-horizontal text-white">
												...
												<li class="col-7 col-xl-7 px-1 list-group-item d-none d-lg-block">
													<span class="font-weight-lessbold">
														<cfset IDtitle = "#media_rel.media_relationship# Media">
														#IDtitle#
													</span>
												</li>
											</ul>
											...
											<div class="row mx-0 py-0 border-top-teal">
												...
												<div class="col-12 col-md-8 col-lg-8 px-0 px-1 py-1">
														<div class="col-6 bg-white px-0 float-left">
															<cfset mediablock= getMediaBlockHtml(media_id="#relm.source_media_id#",displayAs="fixedSmallThumb",size="75",captionAs="textLinks",background_color="white")>#mediablock#
														</div>
												<!---	<cfloop query="relm">
...
<!---											<cfquery name="accn_agent" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
											...
											<div class="row mx-0 border-top-teal py-0">
												...
												<div class="col-12 col-md-2 col-xl-2 py-2 pb-0 border-bottom rounded border-right small">
													...
													<div class="row mx-0">
														...
														<div class="col-12 px-0 px-md-1 py-0">#accn.accn_status#</div>
													</div>
											<!---		<cfloop query="">
							...
							<section class="my-2 row mx-0 w-100">
								...
								<div class="search-box pb-0 mt-1 w-100">
									...
									<div class="search-box-header px-2 mt-0">
										<ul class="list-group list-group-horizontal text-white">
											<li class="col-12 col-md-1 px-1 list-group-item">
												<span class="font-weight-lessbold">Collecting</span>&nbsp;Event<span class="d-inline d-lg-none">s</span><span class="d-none d-lg-inline-block">&nbsp;ID</span></span>
											</li>
									...
									<cfloop query="collecting_event">
										...
										<div class="row mx-0 border-top-teal py-0">
											<div class="col-12 col-md-2 col-lg-1 py-2 border-bottom rounded border-right small90">
											...
											<div class="col-12 col-md-2 border-bottom rounded col-lg-1 py-2 border-right small90">
											...
											<div class="col-12 col-md-2 col-md-2 py-2 border-right small">
												<div class="row mx-0">
											...
											<div class="col-12 col-md-6 col-xl-8 py-1 px-1">
												<cfloop query="relmCE">
						...
						<cfif len(permit.permit_id) gt 0>
							<a name="shows%20permit"></a><a name="document%20for%20permit"></a>
							<section class="my-2 row w-100 mx-0">
								...
								<div class="col-12 px-0">
									...
									<div class="search-box mt-1 pb-0 w-100">
										...
										<cfloop query="permit">
											...
											<div class="row mx-0 border-top-teal py-0">
												<div class="col-12 col-md-2 col-xl-1 py-2 pb-1 border-right border-bottom rounded small90">
													<span class="d-inline d-md-block d-lg-none font-weight-lessbold">Permit ID: </span>
												...
												<div class="col-12 col-md-2 col-xl-3 py-2 pb-0 border-right small">
													<div class="row mx-0">
						...
						<cfquery name="loan" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
							select  loan.transaction_id,loan.loan_type,loan.loan_status,loan.loan_instructions,loan.return_due_date,loan.loan_description,loan.loan_number 
							from loan
									...
									<div class="search-box mt-1 pb-0 w-100">
										...
										<cfloop query="loan">
											<div class="row mx-0 border-top-teal py-0">
												...
												<div class="col-12 col-md-2 col-xl-1 pt-2 pb-1 border-bottom rounded border-right small90">
													<span class="d-inline d-md-block font-weight-lessbold d-lg-none">Transaction ID: </span><a class="font-weight-lessbold" href="#relm11.auto_protocol#/#relm11.auto_host#/guid/#loan.transaction_id#">
									...
									<div class="search-box mt-1 pb-0 w-100">
										...
										<cfloop query="borrow">
											<div class="row mx-0 border-top py-0 border-gray">
												...
												<div class="col-12 col-md-6 col-xl-8 px-1 py-1">
													<cfloop query="relm5">
														<div class="border-light col-12 col-sm-6 col-md-6 col-lg-4 pb-1 col-xl-3 px-1 pl-md-0 pr-md-1 float-left">
															<cfif len(borrow.transaction_id) gt 0>
							...
							<section class="mt-2 mb-5 row w-100 mx-0">
								...
								<div class="search-box mt-1 pb-0 w-100">
									<div class="search-box-header px-2 mt-0">
										<ul class="list-group list-group-horizontal text-white">
											<li class="col-2 col-xl-1  px-1 list-group-item">
												<span class="font-weight-lessbold">Agent<span class="d-inline d-lg-none">s </span><span class="d-lg-inline d-none"> ID</span></span>
											</li>
											<li class="col-3 col-xl-3 px-1 list-group-item d-none d-lg-block">
												<span class="font-weight-lessbold">Details</span>
											</li>
									...
									<cfloop query="agents">
										<div class="row mx-0 py-0 border-top-teal">
											<div class="col-12 col-lg-2 col-xl-1 py-2 border-bottom rounded border-right small90"><a name="agents"></a>
