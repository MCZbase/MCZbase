	...
	<main class="container-fluid" id="content">
		<div class="row mx-0">
			...
			<cfloop query="media">
				...
				<cfif agents.media_relationship eq 'shows handwriting of agent' OR agents.media_relationship eq 'created by agent' OR agents.media_relationship eq 'shows agent'>
