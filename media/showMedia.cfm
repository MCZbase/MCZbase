												...
												<td>	
													<cfloop query="media_rel">#media_rel.media_relationship#<cfif media_rel.media_relationship eq 'shows cataloged_item'>:
														<cfloop query="spec">
															...
															</cfquery><cfif relm.recordcount GT 2><span>, </span></cfif><a class="small90 font-weight-lessbold" href="#relm.auto_protocol#/#relm.auto_host#/guid/#spec.guid#">#spec.guid#</a>
														</cfloop> 
													</cfif>
