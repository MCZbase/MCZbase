								...
								<div class="row mx-0 border-bottom border-gray">
									...
									<div class="col-6 px-0">
										<cfif relm.recordcount lte #maxMedia#>
											<cfloop query="relm">
												<div class="border-light col-4 pl-0 pr-1 float-left py-1 mb-1"> <!---style="width:112px;height: 175px">--->
													<cfif len(media.media_id) gt 0>
														...
														<div class="#activeimg#" id="mediaBlock#relm.media_id#">
															<div class="col-5 bg-white px-1 pb-0 pt-2 float-left" style="min-height: 130px;"> #mediablock# </div>
