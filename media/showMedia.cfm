											...
											<cfloop query="relm">
												<div class="border-light col-4 float-left mx-1 px-0 py-1 mb-1"> <!---style="width:112px;height: 175px">--->
													<cfif len(media.media_id) gt 0>
														...
														<div class="#activeimg#" id="mediaBlock#relm.media_id#"><div class="col-6 px-0 float-left"> #mediablock# </div><div class="float-left col-6 px-0 small" style="line-height: 1rem;">#title#</div></div>
													</cfif>
