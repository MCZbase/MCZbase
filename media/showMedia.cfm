			...
			<cfloop query="media">
				<div class="row">
					...
					<div class="col-12 mt-2 mb-2">
						...
						<div class="float-left col-12 px-0 col-md-9 pl-md-4 col-xl-8 px-xl-4">
							...
							<cfloop query="ff">
								<tr>
									...
									<td style="width:57%; padding-left: 0.75rem;">
										<cfloop query="relm">
											<div class="border-light float-left px-0 pt-1 py-1 h-auto" style="width:112px;">
											<cfif len(media.media_id) gt 0>
							...
							<table class="search-box table table-responsive mt-1 w-100">
								...
								<tbody>
									<tr>
										...
										<td style="width:57%; padding-left:0.75rem;">
											<cfloop query="relm2">
												<div class="border-light float-left mx-1 px-0 py-1" style="width:112px;height: 209px">
												<cfif len(tt.transaction_id) gt 0>
