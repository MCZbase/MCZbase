		...
		<div class="row mx-0">
			...
			<cfloop query="media">
											...
											<cfif len(media.media_id) gt 0>
												...
												<div class="#activeimg#" id="mediaBlock#relm.media_id#">
													...
													<cfset showTitleText1 = trim(title1)>
														<cfif len(title1) gt 130><cfset showTitleText1 = "#left(showTitleText1,130)#..." ></cfif>
				...
				<div class="row mx-0">
					...
					<cfelse>
						<h3 class="h4 mt-3 w-100 px-2 font-italic">Not associated with Borrow</h3>
					</cfif>
				</div>
				<!---Deaccession records--->			
				<div class="row mx-0">
					...
					<cfelse>
						<h3 class="h4 mt-3 w-100 px-2 font-italic">Not associated with Deaccession</h3>
					</cfif>
				</div>
				<!---Loan records--->			
				<div class="row mx-0">
