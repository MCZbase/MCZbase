				...
				<div class="row mx-0">
					...
					<cfquery name="thisguid" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#" >
						...
						<div class="rounded border bg-light col-12 col-sm-6 col-md-3 col-xl-3 float-left mb-3 pt-3 pb-2">
							<cfset mediablock= getMediaBlockHtml(media_id="#media.media_id#",displayAs="fixedSmallThumb",size="500",captionAs="textFull",background_color="white")>
							<div class="mx-auto text-center pt-1" id="mediaBlock#media.media_id#"> #mediablock# </div>
						</div>
						</cfif>

						<div class="float-left col-12 px-0 col-md-9 pl-md-4 col-xl-9 pl-xl-4">
