									...
									<div class="form-row">
                                        ...
                                        <div class="form-group pt-2 pb-1 mb-0">
											<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mb-md-0 pt-1 mx-md-1 mx-0 rounded justify-content-center">
												...
												<input name="made_date" id="made_date" type="text" class="datetimeinput col-3 px-1 py-0" placeholder="start yyyy-mm-dd or yyyy" value="#encodeForHtml(made_date)#" aria-label="start of range for transaction date">
