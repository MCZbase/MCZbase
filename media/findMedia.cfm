...
<div id="overlaycontainer" style="position: relative;"> 
	...
	<cfoutput>
		...
		<style>
			...
			.jqx-grid-card-cell table {height: 233px;overflow-y:hidden!important;}
			.jqx-grid-card-cell-label {width: 25%;}
...
//						autorowheight: 'false',
						...
						<cfif Application.serverrole NEQ "production" >
							...
							cardviewcolumns: [
								...
								{ width: 'auto', datafield: 'mask_media_fg',hidable: true},
								{ width: 'auto', datafield: 'media_type',hidable: true},
								{ width: 'auto', datafield: 'mime_type',hidable: true},
								{ width: 'auto', datafield: 'protocol',hidable: true},
								{ width: 'auto', datafield: 'host',hidable: true},
								{ width: 'auto', datafield: 'path',hidable: true},
								{ width: 'auto', datafield: 'filename',hidable: true},
								{ width: 'auto', datafield: 'extension',hidable: true},
								{ width: 'auto', datafield: 'aspect',hidable: true},
								{ width: 'auto', datafield: 'description',hidable: true},
								{ width: 'auto', datafield: 'made_date',hidable: true},
								{ width: 'auto', datafield: 'subject',hidable: true},
								{ width: 'auto', datafield: 'original_filename',hidable: true},
								{ width: 'auto', datafield: 'internal_remarks',hidable: true},
								{ width: 'auto', datafield: 'remarks',hidable: true},
								{ width: 'auto', datafield: 'spectrometer',hidable: true},
								{ width: 'auto', datafield: 'light_source',hidable: true},
								{ width: 'auto', datafield: 'spectrometer_reading_location',hidable: true},
								{ width: 'auto', datafield: 'height',hidable: true},
								{ width: 'auto', datafield: 'width',hidable: true},
								{ width: 'auto', datafield: 'creator',hidable: true},
								{ width: 'auto', datafield: 'owner',hidable: true},
								{ width: 'auto', datafield: 'credit',hidable: true},
								{ width: 'auto', datafield: 'dc_rights',hidable: true},
								{ width: 'auto', datafield: 'license_display',hidable: true},
								{ width: 'auto', datafield: 'relations',hidable: true},
								{ width: 'auto', datafield: 'ac_description',hidable: true},
								{ width: 'auto', datafield: 'media_uri',hidable: true},
							],
						</cfif>
						columns: [
