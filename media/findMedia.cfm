						...
						<div class="col-12 p-3" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
								...
								<fieldset class="bg-light border-top border-bottom border-right border-left field-set rounded px-2 pt-1 pb-2 mt-1 mx-2">
									<legend class="h6 mb-0 px-3 border-top border-bottom border-left border-right field-set-legend w-auto bg-teal sr-only">Search for Media</legend> 
									<div class="form-row">
									...
									<div class="form-row">
										...
										<div class="col-12 col-md-3 col-xl-3 mb-1">
											...
											<button type="button" class="rules small" onclick="var e=document.getElementById('original_filename');e.value='NULL';" aria-describedby="origFileNull_help">NULL</button><span id="origFileNull_help" class="sr-only">use NULL to find media records without the selected relationship</span>, 
											<button type="button" class="rules small" onclick="var e=document.getElementById('original_filename');e.value='NOT NULL';" aria-describedby="origFileAny_help">Any</button><span id="origFileAny_help" class="sr-only">Click Any for NOT NULL to find media records with a relationship to any record</span>)
									...
									<div class="form-row">
										<div class="col-12 col-md-6 col-lg-5 col-xl-4 mb-1">
										...
										<div class="col-12 col-md-6 col-xl-4">
											<div class="form-row mx-0 mb-2">
												<span class="w-100">
													...
													<button type="button" class="rules" onclick="var e=document.getElementById('media_relationship_value_1');e.value='NOT NULL';">NOT NULL</button><span class="sr-only">use NOT NULL to find media records with the selected relationship to any record</span>)
												</span>
