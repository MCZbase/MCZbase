							...
							<form name="searchForm" id="searchForm">
								...
								<!--- Set columns for keywords control depending on whether mask search is enabled or not --->
									...
									<label for="spectrometer" class="data-entry-label mb-0" id="spectrometer_label">Spectrometer 
										<span class="small">
											(<button type="button" tabindex="-1" aria-hidden="true"  class="border-0 bg-light m-0 p-0 btn-link" onclick="var e=document.getElementById('spectrometer');e.value='='+e.value;">https://mczbase-test.rc.fas.harvard.edu/media/findMedia.cfm</button><span class="sr-only">prefix with equals sign for exact match search</span>, 
											NULL, NOT NULL)
										</span>
									</label>
