										...
										<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 px-0 pl-lg-2 float-left">	
											...
											<div id="labels">
												...
												<cfloop query="labels">
													...
													<input type="text" name="label_value__#i#" id="toggle_value__#i#" value="#encodeForHTML(label_value)#" disabled class="data-entry-input col-7 float-left">
												...
												<span class="infoLink h5 box-shadow-0 d-block col-12 text-right my-1 pr-3" id="addLabel" onclick="addLabelTo(#i#,'labels','addLabel');">Add Label (+)</span> 
											</div><!---end id labels--->
											<div class="col-12 px-0 float-left">
