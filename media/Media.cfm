...
<cfswitch expression="#action#">
    ...
    <form name="editMedia" method="post" action="media.cfm">
      ...
      <input type="hidden" id="media_id" name="media_id" value="#media_id#">
		...
		<div class="form-row mt-1 dotted-border">
			<div class="col-12">
      			<label for="relationships" class="data-entry-label w-100">Media Relationships | <span class="infoLink" onclick="manyCatItemToMedia('#media_id#')">Add multiple "shows cataloged_item" records</span></label>
      ...
      <div id="labels" class="graydot">
        ...
        <cfloop query="labels">
          ...
          <div id="labelsDiv__#i#">
            ...
            :&nbsp;
            <input type="text" name="label_value__#i#" id="label_value__#i#" size="80" value="#encodeForHTML(label_value)#">
          </div>
          <cfset i=i+1>
        </cfloop>
