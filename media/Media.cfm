							...
							<div class="col-12 col-md-12 px-0 float-left">
									<div class="form-row my-1">
										<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 px-0 pr-lg-2 float-left">
											...
											<div class="row">
												<div class="col-12">
													<button class="btn btn-primary btn-xs" onClick="loadHello('relationsBlock','#media.media_id#');">Reload counterBlock</button> 
											...
											<script>
												function doReload() { 
													...
													loadHello('relationsBlock','#media.media_id#','#media.media_relations_id#');
												}
											</script> 
										</div><!---end col-12--->
