									...
									<div class="form-row mx-xl-1 mt-3">
										<div class="col-12 col-md-6 px-xl-2 float-left">
											...
											<div id="relationships">
												...
												<span class="infoLink h5 box-shadow-0 d-block col-md-5 offset-md-7 col-xl-3 col-xl-9 text-right my-1" id="addRelationship" onclick="addRelation(#i#)">Add Relationship (+)</span>
										...
										<div class="col-12 col-md-6 px-xl-2 float-left">	
											...
											<div id="labels">
												...
												<cfloop query="labels">
													...
													<span class="infoLink h5 box-shadow-0 d-block col-12 col-md-5 offset-md-7 col-xl-3 col-xl-9 text-right my-1" id="addLabel" onclick="addLabelTo(#i#,'labels','addLabel');">Add Label (+)</span> 
												</div><!---end id labels--->
										</div><!---end col-6--->	
