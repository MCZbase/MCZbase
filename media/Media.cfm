					...
					<div class="col-12 px-md-0 my-3">
						...
						<form name="editMedia" method="post" action="media.cfm" class="my-2">
							...
							<div class="col-12 px-0 float-left">
								<div class="rounded border col float-left mb-3" style="width:118px;">
								...
								<div class="col-10 pb-md-4 pb-xl-2 float-left">
									<div class="col-12 px-0 float-left">
									...
									<div class="form-row mx-xl-1 mt-3">
										<div class="col-12 col-md-6 px-xl-2 float-left">
											...
											<div id="relationships">
												...
												<span class="infoLink h5 box-shadow-0 d-block col-6 offset-2 col-md-5 offset-md-7 col-xl-3 col-xl-9 text-right my-1" id="addRelationship" onclick="addRelation(#i#)">Add Relationship (+)</span>
										...
										<div class="col-12 col-md-6 px-xl-2 float-left">	
											...
											<div id="labels">
												...
												<cfloop query="labels">
													...
													<span class="infoLink h5 box-shadow-0 d-block  col-6 offset-2 col-md-5 offset-md-7 col-xl-3 col-xl-9 text-right my-1" id="addLabel" onclick="addLabelTo(#i#,'labels','addLabel');">Add Label (+)</span> 
												</div><!---end id labels--->
										</div><!---end col-6--->	
