...
.grid-item-3 {
  ...
  border-radius: 5px;
					...
					<div class="col-md-4 px-xl-5 pb-5">
						...
						<div class="card mb-4 box-shadow bg-lt-gray border-lt-gray">
							<img class="card-img-top" data-src="https://iiif.mcz.harvard.edu/iiif/3/3823370/full/max/0/default.jpg" alt="DSpace logo" style="width: 100%; display: block;background-color: gray;padding-bottom: 2px;" src="https://iiif.mcz.harvard.edu/iiif/3/3823370/full/max/0/default.jpg" data-holder-rendered="true">
							<div class="card-body bg-white p-4">
