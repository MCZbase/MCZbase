										...
										<div class="row">
											<div class="col-12">
												...
												<div class="col-9 px-0 pt-2 float-left">
													...
													<button class="btn btn-xs btn-primary float-left" type="button" onClick="saveMediaRelationship('relationsBlock','#media_relationship#',#media_id#');">Save Relationships 
													</button>
												</div>
											</div>
										</div>
