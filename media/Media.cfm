									...
									<div class="row mt-3">
										<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 px-0 pr-lg-2 float-left">
											...
											<div class="col-9 px-0 float-left">
												<button class="btn btn-xs btn-primary float-left" type="button" onClick="newRelationship(#getRelations.media_id#,#media_relations_id#,media_relationship)">Save Relationships Changes</button>
											</div>
											<script>
												(function () {
													var previous;
