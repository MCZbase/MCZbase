							...
							<div class="col-12 col-xl-9 px-0">
								<div class="form-row mx-0 my-2">
									<div class="col-12 col-xl-11 px-md-5 float-left">
										...
										<button type="button" class="btn btn-secondary btn-xs mt-2 float-right" id="button_add_media" onclick="seeImage('','','','createMediaForm','media'); handleChange();"> Preview</button>
									</div>
								</div>
								<div class="form-row mx-0">
									<div class="col-12 col-md-11 px-md-5 mt-0 mb-2 float-left">
										...
										<input name="preview_uri" class="reqdClr data-entry-input" required>
											<button type="button" class="btn btn-secondary btn-xs float-right mt-2" id="button_add_media" onclick="seeImage('','','','createMediaForm','media'); handleChange();"> Preview in Popup </button>
									</div>
								</div>
								<div class="form-row mx-0">
