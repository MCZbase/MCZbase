								...
								<div class="col-12 col-md-12 float-left">
									...
									<div class="form-row mt-2">
										<div class="col-6 col-md-9 col-xl-5 px-3">
											<label for="media_license_id" class="h5 mb-0 mt-2 data-entry-label">License (<a href="#media.auto_host#/info/ctDocumentation.cfm?table=ctmedia_label&field=undefined" onclick="getCtDoc('ctmedia_label');" class="infoLink" target="_blank">Define</a>)</label>
