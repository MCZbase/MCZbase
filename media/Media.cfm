				...
				<div class="row">
					...
					<div class="col-md-4 px-5 pb-5">
						<div class="card mb-4 box-shadow bg-lt-gray border-lt-gray">
							...
							<div class="card-body bg-white p-4">
								<p class="card-text">External files could be stored anywhere outside of Harvard's facilities. This one is served from the Biodiversity Heritage Library. Permission or copyright clearance must be on file before uploading.</p>
								<div class="d-flex justify-content-between align-items-center">
									<div class="btn-group">
										<button type="button" class="btn btn-xs btn-primary px-5">Start</button>
									</div>
