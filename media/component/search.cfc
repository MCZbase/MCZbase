								...
								<div class="mt-0 col-12 pb-1 px-0 mt-1">
									...
									<div class="pb-1">
										...
										<cfif #l_captionAs# EQ "textFull"><!---This is for use with a size and the caption is 250 characters with links and copyright information--The images will fill the container (gray square present) and have a full caption (e.g., edit media page)--->
											...
											<p class="text-center col-12 my-0 p-0 smaller" <cfif len(#showTitleText#) lt 81 and #alt# contains 'type text' or #showTitleText# contains 'ledger'><cfelseif len(#showTitleText#) gte 81 and #alt# contains 'MCZ:'>style="height: 50px;"<cfelse>style="height: 101px;"</cfif>> #showTitleText# </p> 
