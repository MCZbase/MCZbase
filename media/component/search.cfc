						...
						<div class="media_widget">	
							...
							<cfelseif #l_captionAs# EQ "textLinks">
								...
								<div class="mt-0 col-12 pb-1 px-0 mt-1">
									<p class="text-center px-0 pb-1 mb-0 smaller col-12">
...
<!--- Obtain a list of the specimens in a media record in a form suitable for display in a jqxgrid. 
...
--->
<cffunction name="getSpecimensInMedia" access="remote" returntype="any" returnformat="json">
	<cfargument name="media_id" type="string" required="yes">
