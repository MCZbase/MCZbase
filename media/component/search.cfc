						...
						<tr>
							...
							<cfloop query="media_rel"><span class="text-capitalize">#media_rel.label##plural#</span>
								<div class="comma2 d-inline">
									...
									<cfif media_rel.media_relationship eq 'documents accn'>:<cfloop query="accns"><cfquery name="relm5" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#"> select m.media_id,ac.accn_number from accn ac left join media_relations m on ac.accn_num=m.related_primary_key left join trans on trans.transaction_id = ac.accn_number where m.media_relationship = 'documents accn' and ac.accn_number=<cfqueryparam cfsqltype="cf_sql_decimal" value="#accns.accn_number#" /> </cfquery> #relm5.accn_number#<span>, </span></cfloop>
									</cfif>
