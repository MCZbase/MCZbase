						...
						<tr>
							...
							<cfloop query="media_rel"><span class="text-capitalize">#media_rel.label#</span>
								<div class="comma2 d-inline">
									...
									<cfif media_rel.media_relationship contains 'loan'>:<cfloop query="agents1"><a class="font-weight-lessbold" href="/transactions/Loan.cfm?action=editLoan&transaction_id=#loan.transaction_id#"> #loan.loan_number#</a><span>, </span></cfloop>
									</cfif>
