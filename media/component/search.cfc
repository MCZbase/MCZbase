...
<cfset output='#output#<script type="text/javascript">jQuery(document).ready(function($){$("##MID#media.media_id#").addimagezoom({zoomrange: [2,12],magnifiersize:["100%","100%"],magnifierpos:"right",cursorshadecolor:"##fdffd5",cursorshade:true,largeimage:"#iiifFull#"})})</script>'>
					<cfif #captionAs# EQ "textNone">
