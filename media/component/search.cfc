		...
		<cftry>
			...
			<cfif media.recordcount EQ 1>
				...
				<cfloop query="media">
					...
					<cfset output='#output#<script type="text/javascript">jQuery(document).ready(function($){$("##MID#media.media_id#").addimagezoom({zoomrange: [2, 9],
						magnifiersize: [500,500],magnifierpos:"right",cursorshade:true,largeimage:"#iiifFull#"})})</script>'>
					<cfif #captionAs# EQ "textNone">
