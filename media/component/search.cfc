	...
	<cftry>
		...
		<cfloop query="media">
			...
			<cfquery name="media_rel" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
				...
				and (agent_name = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value=#agent1.agent_name#> OR agent_name = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value=#agent2.agent_name#> OR agent_name = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value=#agent3.agent_name#> OR agent_name = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value=#agent4.agent_name#>)
				and agent_name_type = 'preferred'
			</cfquery>
