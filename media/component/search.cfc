							...
							<cfelse>
								<div class="mt-0 col-12 pb-1 px-0 mt-1">
									...
									<div class="pb-1">
										...
										<p class="text-center col-12 my-0 p-0 smaller"<cfif #alt# CONTAINS 'type text'><cfelseif len(#alt#) gt 81>style="height: 101px;"<cfelse>style="height: 48px;"</cfif>>#showTitleText# </p> 
