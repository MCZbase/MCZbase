...
<cfif isDisplayable><cfset output='#output#<script type="text/javascript">jQuery(document).ready(function($){$("##MID#media.media_id#").addimagezoom({zoomrange: [2,12],magnifiersize:["100%","100%"],magnifierpos:"right",cursorshadecolor:"##fdffd5",cursorshade:true,largeimage:"#iiifFull#"})})</script>'></cfif>
					...
					<cfelse>
						...
						<cfelse>
							<cfif CGI.script_name CONTAINS "/MediaViewer.cfm">
								<cfset output='#output#(<a role="button" href="javascript:void(0)" id="btn_pane" class="" onClick="switchImages(#media_id#,300,'textLinks')">zoom/related</a>)'>
							<cfelse>
								<!---<cfset output='#output#(<a class="" href="/MediaSet.cfm?media_id=#media_id#">zoom/related</a>)'>--->
								<cfset output='#output#(<a class="" href="/media/MediaViewer.cfm?media_id=#media_id#">zoom/related</a>)'>
							</cfif>
...
<!---BELOW:::FUNCTIONS FOR RELATIONSHIPS and LABELS on EDIT MEDIA AND FUNCTION FOR SHOWING THUMBNAILS FOR showMedia.cfc -- Michelle--->	<cffunction name="switchMedia" access="remote" returntype="string" returnformat="plain">
	<cfargument name="media_id" type="string" required="yes">
	<cfargument name="size" type="string" required="no" default="600">
	<cfargument name="box" type="string" required="no" default="">
	<cfargument name="displayAs" type="string" required="no" default="full">
