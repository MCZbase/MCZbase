						...
						<tr>
							...
							<cfloop query="media_rel"><span class="text-capitalize">#media_rel.label#</span>
								<div class="comma2 d-inline">
									...
									<cfif media_rel.media_relationship contains 'media'>:<cfloop query="media1"><cfquery name="relm8" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">select media.media_id from media, media_relations mr where mr.media_id = media.media_id and mr.media_relationship = 'related to media'</cfquery>
									<a class="font-weight-lessbold" href="/media/#relm8.media_id#">with ID: #relm8.media_id#</a><span>, </span></cfloop>
									</cfif>
