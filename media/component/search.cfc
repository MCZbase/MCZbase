							...
							<cfif len(preview_uri) GT 0>
								...
								<!---	<cfset l_size = (#l_size#)/2>--->
									<cfif #l_displayAs# eq "thumb">
										...
										<cfset l_styles = "max-width:150px;max-height:100px;">
									<cfelse>
										<cfset hw = 'width="100" height="100"'><!---for shared drive images when the displayAs=thumb attribute is not used and a size is used instead. Since most of our intrinsic thumbnails in "preview_uri" field are around 150px or smaller, I will use that as the width. Height is "auto" for landscape and portrait.  --->
									</cfif>
							<cfelse>
