				...
				<cfloop query="media">
					...
					<cfif host EQ "mczbase.mcz.harvard.edu" AND enableIIIF>
						<cfif media_type EQ 'image' AND left(media.mime_type,6) EQ 'image/'>
							...
							<cfif media.height LT 1000 or media.width LT 1000><!---Zoom will not work if the image is near or equal to original size. Show original if there is not a larger size available.--->
								<cfset iiifFull = "#iiifSchemeServerPrefix##iiifIdentifier#/full/^#size#,/0/default.jpg">
							<cfelse>
					...
					<cfelse>
						...
						<cfset output='#output#<p class="text-center px-0 pb-0 mb-0 small col-12">'>
						<cfif listcontainsnocase(session.roles,"manage_specimens")>
							<cfset output='#output#<span class="d-inline">(<a href="/media.cfm?action=edit&media_id=#media_id#">Edit</a>)</span>'>
						</cfif>
						<cfset output='#output#(<a class="" href="/media/#media_id#">Media Record</a>)'>
						<cfif NOT isDisplayable>
							...
							<cfif media_uri contains "www.morphosource.org">
								<cfset output='#output#(<a class="" href="#media_uri#">File&##8201;<img src="/images/linkOut.gif"></a>)'>
							<cfelse>
