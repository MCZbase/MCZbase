						...
						<tr>
							...
							<cfloop query="media_rel"><span class="text-capitalize">#media_rel.label#</span>
								<div class="comma2 d-inline">
									...
									<cfif media_rel.media_relationship contains 'locality'>:<cfloop query="local">
									<a class="font-weight-lessbold" href="/showLocality.cfm?action=srch&locality_id=#local.locality_id#">#local.spec_locality#  #local.dec_lat# #local.dec_long# #local.error# #units#</cfif>  </a><span>, </span></cfloop>
									</cfif>
