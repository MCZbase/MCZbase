...
<cffunction name="relationsTableHtml" returntype="string" access="remote" returnformat="plain">
	...
	<cfthread name="getRelationsHtmlThread">
		<cftry>
			<cfquery name="mediaRelationsType" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
				select media_relationship, related_primary_key
				from media_relations
				where
					media_id=<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#media_id#">
			</cfquery>
			<cfset relationship = mediaRelationsType.media_relationship>
			<cfoutput>
				<div class="row">
					<div class="col-12">
