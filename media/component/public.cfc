...
<cfoutput>
	<cftry>
		...
		<cfquery name="media1" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
			select distinct m.media_id, m.media_uri
			from media m
						...
						<tr>
							...
							<cfloop query="media_rel">
								...
								<div id = "relatedLinks" class="comma2 d-inline onlyfirst">
									...
									<cfif spec.rel eq 'related to media'>: 
										<cfloop query="media1">
											<a class="font-weight-lessbold" href="/media.#media1.media_id#"> /media/#media1.media_id#</a>
									...
									<cfif media_rel.media_relationship eq 'transcript for audio media'>:
										<cfloop query="media2">
											<a class="font-weight-lessbold" href="/media/#media2.media_id#"> /media/#media2.media_id#</a>
