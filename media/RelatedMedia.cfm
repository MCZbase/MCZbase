					...
					<div class="row">
						<div class="col-12 my-3">
							<cfif len(media.media_id) gt 0>
								<div class="rounded highlight_media">
									<div id="zoom" class="rounded highlight_media col-12 col-md-5 col-xl-2 float-left pt-2 mt-4 mb-3 pb-0">
									...
									<div id="zoom" class="col-12 col-md-5 col-xl-2 float-left pt-2 mt-4 mb-3 pb-0">
										<h2 class="mb-1 mt-0 col-12 float-left text-center">Media Zoom</h2>
