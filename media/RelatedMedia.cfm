									...
									<div class="col-11 float-right mr-4"> 
										...
										<aside class="collapse collapseStyle mt-0 border-warning border-top border-right border-bottom border-left" id="collapseFixed">
											<div class="card card-body p-3">
												...
												<p class="d-none d-md-block mb-0" style="font-size: .83rem;line-height:.86rem;">Hover over the image to show a larger version at zoom level 2. Place cursor in top left corner of media and zoom in with mousewheel or touchpad to see a larger version of the image (up to zoom level 10).  Pan to see different parts of image if it goes beyond your screen size. Use the related button on images below to switch images.</p><p class="d-block d-md-none mb-0" style="font-size: .83rem;line-height:.86rem;"> Tap the image and swipe left to see larger version. Tap area off the image to close.  </p>
											</div>
										</aside>
									</div>
								</div>
