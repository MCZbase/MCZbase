																...
																<ul class="list-group px-0">
																	<li class="list-group-item px-0 mx-1">
																		...
																		<div class="#activeimg# image#i#" id="mediaBlock#relm.media_id#" style="height:230px;">
																			<div class="px-0">
																				<span class="px-2 d-block mt-1 small90 font-weight-lessbold text-center">#spec.label# <cfif spec.label = 'Shows Cataloged Item'>#spec.pk#</cfif> <br>(media/#relm.media_id#)
																				</span> 
																				#mediablock#
																			</div>
																		</div>
