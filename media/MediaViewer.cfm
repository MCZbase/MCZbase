						...
						<div class="col-12 my-3">
							<cfif len(media.media_id) gt 0>
								<div id="viewer targetarea" class="rounded highlight_media col-12 col-md-5 col-xl-2 float-left pt-2 mt-4 mb-3 pb-0">
									...
									<p class="" style="font-size: .83rem;">Place cursor in top left corner of media and zoom in with mousewheel or touchpad to see a larger version of the image. Pan to see different parts of image. On small mobile devices swipe left.  </p>
								</div>
							</cfif>
