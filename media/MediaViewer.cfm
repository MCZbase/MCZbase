...
<style>
	...
	<cfquery name="spec" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
		select distinct c.publication_id as pk, mr.media_relations_id, 'Publication' as wlabel
		from publication p
		...
		UNION
		select ci.collection_object_id as pk, mr.media_relations_id, 'cataloged_item' as wlabel
		...
		and mr.media_relationship <> 'created by agent'
		UNION
		select ce.collecting_event_id as pk, mr.media_relations_id, 'collecting_event' as wlabel
		...
		and mr.media_relationship <> 'created by agent'
		UNION
		select loan.transaction_id as pk, mr.media_relations_id, 'Loan' as wlabel
		from loan
		...
		and mr.media_relationship <> 'created by agent'
		UNION
		select accn.transaction_id as pk, mr.media_relations_id, 'accn' as wlabel
		from accn
		...
		and mr.media_relationship <> 'created by agent'
		UNION
		select locality.locality_id as pk, mr.media_relations_id, 'locality' as wlabel
		from locality
		...
		UNION
		select agent.agent_id as pk, mr.media_relations_id, 'agent' as wlabel
		from agent_name an
