				...
				<div class="row">
					...
					<div class="col-12 px-0 px-xl-2 mt-2 mb-2">
						<cfif len(media.media_id) gt 0>
							<div class="rounded border bg-light col-12 col-sm-8 col-md-6 col-xl-6 float-left mb-2 pt-3 pb-0">
															...
															<div class="border-light col-md-3 col-lg-3 col-xl-2 p-1 float-left"> <!---style="width:112px;height: 175px">--->
																<cfif len(media.media_id) gt 0>
																	...
																	<div class="#activeimg#" id="mediaBlock#relm.media_id#">
																		<div class="col-2 bg-white px-1 float-left" style="min-height: 125px;"> #mediablock# </div>
