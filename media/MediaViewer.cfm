								...
								<div class="search-box mt-2 w-100 mb-5">
									<div class="search-box-header px-2 mt-0 mediaTableHeader">
										<ul class="list-group list-group-horizontal text-white">
											<li class="col-12 px-1 list-group-item mb-0 h4 font-weight-lessbold">Related Media Records </li>
										</ul>
									</div>
									<div class="row mx-0">
										<div class="col-12 p-1">
											...
											<cfquery name="relm" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
												...
												where media_relations.related_primary_key = <cfqueryparam value=#rels.related_primary_key# CFSQLType="CF_SQL_varchar">
												and media.media_id = <cfqueryparam value=#media.media_id# CFSQLType="CF_SQL_varchar">
