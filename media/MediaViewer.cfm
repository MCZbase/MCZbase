					...
					<div class="col-12 my-3">
						...
						<cfif len(media_rel.media_relationship) gt 0>
							...
							WHERE media_id = <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#media.media_id#"> 
								and ctmedia_relationship.auto_table = '#media_rel.media_relationship#'
							</cfquery>
						</cfif>
								...
								<div class="search-box mt-2 w-100 mb-5">
									<div class="search-box-header px-2 mt-0 mediaTableHeader">
										<ul class="list-group list-group-horizontal text-white">
											<li class="col-12 px-1 list-group-item mb-0 h4 font-weight-lessbold">Related Media Records (<cfloop></cfloop>) </li>
										</ul>
									</div>
									<div class="row mx-0">
										<div class="col-12 p-1">
											<cfquery name="relm" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
												...
												where media_relations.media_relationship = <cfqueryparam value=#media_rel.media_relationship# CFSQLType="CF_SQL_VARCHAR" >
