   ...
   <cfquery name="hasPrefSuff" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
	...
	<table class="ssrch">
		...
		<tr>
			...
			<td class="srch pt-2" valign="top" style="width: 260px;">
			...
			<td class="lbl pt-2" valign="top" style="width:120px;">
			...
			<td class="srch pt-2" valign="top">
				...
				<cfelse>
					<input type="text" name="listcatnum" id="listcatnum" style="min-width: 200px;" value="" class="w-100">
				</cfif>
			</td>
		</tr>
		<tr>
