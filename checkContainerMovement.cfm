...
<cfquery name="isParentLabel" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfif #action# is "loadEverything">
	<cftry>
		<cftransaction>
			...
			<cfloop query="data">
				<cfquery name="insThis" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfif #action# is "deleteEverything">
	<cfquery name="diediedie" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfif #action# is "deleteLoaded">
	<cfquery name="delAlreadyLoaded" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		delete from cf_temp_container_location where (
			container_id,
			parent_container_id,
...
<cfquery name="isChildLabel" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	select 
		container_type,
...
<cftry>
	<cfquery name="byenow" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		drop table cf_temp_container_location_two
	</cfquery>
	<cfcatch>bahhh</cfcatch>
</cftry>
	<cftransaction>
		<cfquery name="bethere" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
			create table cf_temp_container_location_two as select * from cf_temp_container_location
		</cfquery>
		<cfquery name="beGone" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
			delete from cf_temp_container_location
		</cfquery>
		<cfquery name="noDups" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfquery name="dups" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	select 
		CONTAINER_ID,
		count(CONTAINER_ID)
...
<cfif #dups.recordcount# gt 0>
	...
	<cfquery name="dupDetail" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		select 
		CONTAINER_ID,
...
<table border>
	...
	<cfset globalError = "">
<cfquery name="scans" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
...
<cfoutput query="scans">
	...
	<cfquery name="child" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		select * from container where container_id = #container_id#
	</cfquery>
	<cfquery name="parent" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
