		...
		<div class="col-12 mt-2">
			...
			<div class="form-group col-12 col-md-4 pb-2">
				...
				<h3 class="fs-subtitle text-center">This is step 2</h3>
					...
					<a aria-label="Add another set of search criteria" class="btn btn-primary addAgent btn-sm loginButtons rounded pb-1 px-2 mr-1 mr-md-auto" target="_self" href="javascript:void(0);">Add</a>
					</div>
				</div>
			</div>
