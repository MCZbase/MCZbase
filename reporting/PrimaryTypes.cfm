		...
		<script>
			...
			var linkPubCellRenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
				...
				if (value.startsWith('http')) {
						result = '<span class="#cellRenderClasses#" style="margin-top: 8px; float: ' + columnproperties.cellsalign + '; ">' + value + '&nbsp;<a target="_blank" href="' + value + '">'+value+'</a></span>';
					} else { 
			...
			var linkPageCellRenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
				...
				var citation_page_uri = rowData['ciation_page_uri'];
				if (citation_page_uri && citation_page_uri.startsWith('http') && value && value.length > 0) {
						result = '<span class="#cellRenderClasses#" style="margin-top: 8px; float: ' + columnproperties.cellsalign + '; ">' + citation_page_uri + '&nbsp;<a target="_blank" href="' + value + '">'+value+'</a></span>';
					} else { 
						result = '<span class="#cellRenderClasses#" style="margin-top: 8px; float: ' + columnproperties.cellsalign + '; ">'+value+'</span>';
					}
				return result; 
