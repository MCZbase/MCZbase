...
<form name="newMedia" method="post" action="">
 ...
 <br>
    ...
    <div> <p style="font-size: 14px;padding-bottom: 1em;">You can use the also use the <a href="##kwFrm">keyword search form</a> above.</p> </div>
      ...
      <select name="mime_type" id="mime_type" class="border rounded" >
        <option value=""></option>
        <cfloop query="ctmime_type">
          <option value="#mime_type#">#mime_type#</option>
        </cfloop>
      ...
      <div id="relationships" class="relationship_dd">
        ...
        </select>:&nbsp;<input type="text" name="related_value__1" id="related_value__1" class="w-50 border rounded" >
      ...
      <div id="labels" class="relationship_dd">
        <div id="labelsDiv__1">
          ...
          </select>:&nbsp;<input type="text" name="label_value__1" id="label_value__1" class="w-50 border rounded">
        </div>
