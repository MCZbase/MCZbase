		...
		<!---			<div class="col-12 col-sm-6 px-0 float-left text-right my-2">
				...
				<script>
					...
					<div class="form-row col-12 px-0 justify-content-center mt-1">
						<input type="button" value="Save" title="Save" aria-label="Save" class="btn btn-xs btn-primary"	onClick=" taxon_form.Action.saveChanges(); " ><div id="saveResultDiv" class="text-danger ml-2">&nbsp;</div>
						<input type="button" value="Clone" class="btn-xs btn-secondary mx-1" onclick="taxon_form.Action.value='newTaxon';submit();">
						<input type="button" value="Delete" class="btn-xs btn-warning mx-1"	onclick="taxon_form.Action.value='deleTaxa';confirmDelete('taxa');">
					</div>
