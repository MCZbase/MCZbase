					...
					<div class="border bg-light p-2 rounded mt-3">
						...
						<cfloop query="common">
							<form name="common#i#" method="post" action="/taxonomy/Taxonomy.cfm">
								...
								<input type="button" value="Delete" class="btn-xs btn-warning ml-1" onClick="common#i#.Action.value='deleteCommon';confirmDialog('Delete <b>#comon_name#</b> common name entry');">
							</form>
							<cfset i=i+1>
						</cfloop>
				...
				<cfset usedHabitats = valueList(habitat.taxon_habitat)>
					...
					<cfloop query="habitat">
						<form name="habitat#i#" method="post" action="Taxonomy.cfm">
							...
							<input type="button" value="Delete" class="btn-xs btn-secondary mb-1 float-left" onClick="habitat#i#.Action.value='deletehabitat';confirmDialog('Delete <b>#taxon_habitat#</b> habitat entry');">
						</form>
						<cfset i=i+1>
					</cfloop>
