			...
			<div class="col-12 float-left px-0 mt-3 mb-5">
				...
				<form name="taxon_form" method="post" action="Taxonomy.cfm" id="taxon_form" class="w-100 float-left border rounded">
					...
					<div class="form-row col-12 px-0 my-2 mx-0">
						<div class="col-12 col-md-3 col-md px-1 bg-light border ml-md-1">
						...
						<div class="col-12 col-md-3 col-md px-1 bg-light border ml-0 ml-md-1">
						...
						<div class="col-12 col-md-3 px-1 bg-light border ml-0 ml-md-1">
						...
						<div class="col-12 col-md-3 px-1 bg-light border mx-0 ml-md-1 mr-md-1">
