				...
				<cfset usedHabitats = valueList(habitat.taxon_habitat)>
					...
					<cfloop query="habitat">
						<form name="habitat#i#" method="post" action="Taxonomy.cfm">
							...
							<input type="button" value="Delete" class="btn-xs btn-secondary mb-1 float-left" onClick="habitat#i#.Action.value='deletehabitat';confirmDialog('Delete #taxon_habitat# habitat entry');">
						</form>
						<cfset i=i+1>
					</cfloop>
