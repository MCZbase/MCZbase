				...
				<cfset usedHabitats = valueList(habitat.taxon_habitat)>
					...
					<cfloop query="habitat">
						<form name="habitat#i#" method="post" action="/taxonomy/Taxonomy.cfm">
							...
							<input type="button" value="Delete" class="btn-xs btn-secondary mb-1 float-left" onClick="habitat#i#.Action.value='deletehabitat';confirmDialog(title'Delete <b>#taxon_habitat#</b> habitat entry','Delete?');">
						</form>
						<cfset i=i+1>
					</cfloop>
