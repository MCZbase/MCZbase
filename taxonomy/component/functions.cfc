	...
	<cftry>
		...
		<cfif tax_pub.recordcount gt 0>
			<cfloop query="tax_pub">
				...
				<cfset publication = "<a href='SpecimenUsage.cfm?publication_id=#publication_id#' target='_blank'><img src='/images/noThumbGray.jpg' height='40' width='28' alt='thumbnail icon for document' class='mr-2'>" & rereplace(formatted_publication,'([0-9]\.)','\1</a>') >
