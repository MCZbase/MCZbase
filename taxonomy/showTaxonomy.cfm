				...
				<div class="accordion w-100" id="accordionForTaxa">
					<div class="card mb-2">
						<div class="card-header w-100" id="headingPart">
							<h2 class="h4 my-0 float-left">  <a class="btn-link text-black" role="button" data-toggle="collapse" data-target="##collapseRelatedTaxa">Related higher and lower rank Taxon Records: </a><span class="text-success small ml-4">(count: #.ct# parts)</span></h2>
						</div>
						<div class="card-body px-3 py-0">
							<div id="collapseRelatedTaxa" class="collapse" aria-labelledby="headingPart" data-parent="##accordionForTaxa">
								<div class="row py-3" id="taxRelatedNames">
