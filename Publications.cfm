	...
	<cfoutput>
		<main id="content">
								...
								<form name="searchForm" id="searchForm">
									...
									<fieldset class="bg-light border-default field-set rounded px-2 pb-2 mt-2 mx-2">
										...
										<div class="form-row">
											...
											<div class="col-12 col-md-6 col-xl-2">
												<label for="cited_taxon">Cited Scientific Name</label>
											...
											<div class="col-12 col-md-6 col-xl-2">
												<label for="accepted_for_cited_taxon">Current Scientific Name</label>
			...
			<section class="container-fluid">
				<div class="row mx-0">
					<div class="col-12">
						<div class="mb-5">
							<div class="row mt-1 jqx-widget-header border px-2">
								...
								<div id="selectModeContainer" class="ml-3" style="display: none;" >
									...
									<select class="data-entry-select d-inline w-auto mt-2" id="selectMode" onChange="changeSelectMode();">
		...
		<script>
			...
			var editCellRenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
				var rowData = jQuery("##searchResultsGrid").jqxGrid('getrowdata',row);
				return '<span style="margin-top: 8px; float: ' + columnproperties.cellsalign + '; "><a target="_blank" class="ml-1 px-2 btn btn-xs btn-outline-primary" href="/publications/Publication.cfm?action=edit&publication_id=' + rowData['publication_id'] + '">Edit</a></span>';
			};
