            ...
            jQuery.getFeed({
               ...
               success: function(feed) {
				...
				header = header.replace("[en]", "");
                 ...
                 jQuery('##divRss').empty();
                 var html ='<div class="shell"><h2 class="h4 py-3 text-center"><a href="https://code.mcz.harvard.edu/wiki/index.php?title=Special:RecentChanges&hideminor=1&days=30">' + header + ' </a><span><small>- Link to Wiki - </small></span></h2>';
