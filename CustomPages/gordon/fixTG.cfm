		...
		<tr>
			...
			<td>
				<cfif len(#phylorder#) is 0>
					<cfquery name="po" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
			...
			<td>
				<cfif len(#family#) is 0>
					<cfquery name="f" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
