...
<!--- JRW edits  Commented out for MCZbase, using standard mappings.
...
<cfloop query="colls">
	...
	'>
	<cfset data='#data#<defaultFormats>
'>
<cfset data='#data#<format type="search" location="http://bnhm.berkeley.edu/manis/DwC/darwin2jrw030315.xsd"/>
'>
<cfset data='#data#<format type="scan" location="http://digir.sourceforge.net/prov/darwin/darwin2scan.xsd"/>
'>
<cfset data='#data#</defaultFormats>
'>
	...
	<cfset data = '#data#<metadata>
		'>
		<cfset data='#data#<code>! set by application (value in resources.xml) !</code>
'>
<cfset data='#data#<numberOfRecords>! set by application !</numberOfRecords>
'>
<cfset data='#data#<dateLastUpdated>! set by application !</dateLastUpdated>
'>
...
'>
	...
	'>
	<cfset data = '#data#<name>#institution# - #collection#</name>
	'>
...
<cfset pm='<metadata>
			...
			'>
<cffile action="write" file="#application.webDirectory##filePath#/providerMeta.xml" addnewline="yes" output="#pm#" mode="666">
</cfoutput>