...
function validateBugs() {
	var mEv=document.bug.user_email.value;
	var mCv=document.bug.complaint.value;
	if (mCv=='' || mEv=='') 
		{
		alert('Your email and a description of the problem are a required fields. Please try again.');
		return (false);
		}	
}
