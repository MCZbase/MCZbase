		...
		<fieldset class="border rounded p-2 mb-2">
			...
			<div class="form-row">
				<div class="col-12 mb-1">
					...
					<button type="button" id="#encodeForHtml(local.searchOpenControlId)#" class="btn btn-xs btn-outline-secondary ml-1" disabled="disabled" title="Open filtered autocomplete suggestions" aria-label="Open filtered autocomplete suggestions"><span aria-hidden="true">▼</span></button>
