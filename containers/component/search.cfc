			...
			<div class="form-row">
				<div class="col-12 mb-1">
					<label for="#encodeForHtml(local.searchControlId)#" class="data-entry-label mb-0">Container autocomplete
						<a href="##" tabindex="-1" aria-hidden="true" id="#encodeForHtml(local.searchOpenControlId)#" class="btn-link disabled ml-1" title="Open filtered autocomplete suggestions" aria-label="Open filtered autocomplete suggestions" aria-disabled="true">(&##8595;)<span class="sr-only">open pick list</span></a>
					</label>
