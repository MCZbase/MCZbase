...
<cfif action is "editLoan">
	...
	<script>
       ...
       <h2 class="wikilink" style="margin-left: 0;">Edit #scope# <img src="/images/info_i_2.gif" onClick="getMCZDocs('Loan/Gift_Transactions##Edit_a_Loan_or_Gift')" class="likeLink" alt="[ help ]">
        <span style="font-size: 16px;padding-right: 1em;">#loanDetails.collection# #loanDetails.loan_number# </span>	<span style="font-size:14px;color: ##666;font-style: italic;">Entered by #loanDetails.enteredby#</span></h2>
	<table>
    <tr>
