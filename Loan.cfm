...
<cfset title="New Loan">
	Initiate a loan:
	<img src="/images/info_i.gif" border="0" onClick="getMCZDocs('Loan/Gift_Transactions##Create_a_New_Loan_or_Gift')" class="likeLink" alt="[ help ]">
	<cfoutput>
...
<cfif action is "editLoan">
	...
	<form name="editloan" action="Loan.cfm" method="post">
		...
		<input type="hidden" name="transaction_id" value="#loanDetails.transaction_id#">
                <div>
	 	  <img src="/images/info_i.gif" border="0" onClick="getMCZDocs('Loan/Gift_Transactions##Edit_a_Loan_or_Gift')" class="likeLink" alt="[ help ]">
