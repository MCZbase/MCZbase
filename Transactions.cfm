										...
										<div class="col-md-6">
											<div class="border bg-light rounded pt-1 mb-2 pb-3 px-4">
												...
												<div class="input-group">
													...
													<div class="input-group-append" aria-label="pick a permit"> <span class="data-entry-addon py-0" tabindex="0" onkeydown=" openfindpermitdialog('permit_num','permit_id','permitpickerdialog'); "aria-labelledby="permit_picklist">Pick</span> </div>
