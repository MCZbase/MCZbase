	...
	$('##accnSearchForm').bind('submit', function(evt){
		...
		$("##searchResultsGrid").jqxGrid({
			...
			columns: [
				...
				{text: 'Foreign Shipments', datafield: 'foreign_shipments', hideable: true, hidden: getColHidProp('foreign_shipment', true) },
	...
	$('##deaccnSearchForm').bind('submit', function(evt){
		...
		$("##searchResultsGrid").jqxGrid({
			...
			columns: [
				...
				{text: 'Collection', datafield: 'collection', hideable: true, hidden: getColHidProp('collection', true) },
				{text: 'Shipments', datafield: 'shipment_count', hideable: true, hidden: getColHidProp('shipment_count', true) },
				{text: 'Foreign Shipments', datafield: 'foreign_shipments', hideable: true, hidden: getColHidProp('foreign_shipments', true) },
