				...
				<div class="col-md-11 col-sm-12 col-lg-11">
					...
					<form id="loanSearchForm">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-sm"> 
									<div class='date form-row bg-light px-2 py-1'>
										<label class="data-entry-label mb-0 " for="trans_date">Loan Date:</label>
										<input name="trans_date" id="trans_date" type="text" class="datetimeinput data-entry-input col-10 mb-1"  placeholder="start of range" value="#trans_date#">
								...
								<div class="col-sm"> 
									<div class='date form-row bg-light px-2 py-1'>
										...
										<input name="return_due_date" id="return_due_date" type="text" placeholder="start of range" class="datetimeinput data-entry-input col-10 mb-1">
										<label class="data-entry-label sr-only" for="to"></label>
								...
								<div class="col-sm"> 
									<div class="date form-row bg-light px-2 py-1">
										...
										<input name="closed_date" id="closed_date" type="text" class="datetimeinput data-entry-input col-10 mb-1"  placeholder="start of range" value="#closed_date#" > 
