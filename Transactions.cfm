				...
				<div class="col-12 pt-1 pb-3">
					...
					<div class="tab-card-main mt-1 tab-card"> 
						...
						<div class="tab-content pb-0 px-2" id="tabContentDiv"> 
							...
							<div tabindex="0" class="tab-pane fade #loanTabShow# #loanTabActive# py-3 mx-0" id="loanTab" role="tabpanel" aria-labelledby="loans-tab">
							...
							<div tabindex="0" class="tab-pane fade #accnTabShow# #accnTabActive# py-3 mx-0" id="accnTab" role="tabpanel" aria-labelledby="accns-tab" aria-hidden="true">
							...
							<div tabindex="0" class="tab-pane fade #borrowTabShow# #borrowTabActive# py-3 mx-0" id="borrowsTab" role="tabpanel" aria-labelledby="borrows-tab">
