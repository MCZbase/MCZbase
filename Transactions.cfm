						...
						<div class="card-header tab-card-header pb-0">
							<ul class="nav nav-tabs card-header-tabs" id="tabHeaders" role="tablist">
								<li class="nav-item col-12 col-md-1 col-xl-1 px-1"> 
									<a class="w-100 nav-link px-3 #allTabActive#" id="all-tab"  href="##transactionsTab" role="tab" aria-controls="transactionsTab" aria-selected="true" >All</a> 
								</li>
								<li class="nav-item col-12 col-md-2 col-xl-1 px-1"> 
									<a class="w-100 nav-link px-3 #loanTabActive#" id="loans-tab"  href="##loanTab" role="tab" aria-controls="loanTab" aria-selected="false" >Loans</a> 	
								</li>
								<li class="nav-item col-12 col-md-2 col-xl-2 px-1"> 
									<a class="w-100 nav-link px-3 #accnTabActive#" id="accns-tab"  href="##accnTab" role="tab" aria-controls="accnTab" aria-selected="false" >Accessions</a> 	
								</li>
								<li class="nav-item col-12 col-md-2 col-xl-2 px-1"> 
									<a class="w-100 nav-link px-3 #deaccnTabActive#" id="deaccns-tab"  href="##deaccnTab" role="tab" aria-controls="deaccnTab" aria-selected="false" >Deaccessions</a> 	
								</li>
								<li class="nav-item col-12 col-md-2 col-xl-2 px-1"> 
									<a class="w-100 nav-link px-3 #borrowTabActive#" id="borrows-tab"  href="##borrowsTab" role="tab" aria-controls="borrowsTab" aria-selected="false" >Borrows</a> 	
								</li>
							</ul>
						</div>
						<!--- End tab header div ---> 
