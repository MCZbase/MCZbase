				...
				<div class="col-12 pt-1 pb-3">
					...
					<div class="tabs card-header tab-card-header pb-0">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="search panel tabs">
								<button class="px-5 tabit #allTabActive#" id="tab-1" role="tab" aria-controls="panel-1" #allTabAria#>All</button> 
								<button class="px-5 tabit #loanTabActive#" id="tab-2" role="tab" aria-controls="panel-2"  #loanTabAria# >Loans</button> 	
								<button class="px-5 tabit #accnTabActive#" id="tab-3" role="tab"  aria-controls="panel-3" #accnTabAria#>Accessions</button> 	
								<button class="px-5 tabit #deaccnTabActive#" id="tab-4" role="tab" aria-controls="panel-4" #deaccnTabAria#>Deaccessions</button> 	
								<button class="px-5 tabit #borrowTabActive#" id="tab-5" role="tab" aria-controls="panel-5" #borrowTabAria# >Borrows</button> 	
							</div>
						<!--- End tab header div ---> 
						<!--- Tab content div --->
