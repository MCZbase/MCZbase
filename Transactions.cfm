						...
						<div class="tab-content pb-0 px-2" id="tabContentDiv"> 
							...
							<div class="tab-pane fade #accnTabShow# #accnTabActive# py-3 mx-2 mx-sm-3" id="accnTab" role="tabpanel" aria-labelledby="accns-tab">
								...
								<form id="accnSearchForm" class="mt-2">
									...
									<div class="col-md-6">
											<div class="date form-row bg-light border pb-2 pt-1 px-0 px-xl-2 mx-0 rounded justify-content-center">
									...
									<div class="col-md-6">
											<div class="date form-row mx-0 bg-light border pt-1 pb-2 px-3 rounded justify-content-center">
												<label class="data-entry-label mb-0 px-4 col-xl-3 mx-1" for="accn_rec_date">Date Received:</label>
