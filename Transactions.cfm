						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-sm px-0"> 
									<div class='date form-row bg-light border px-2 py-1'>
										<label class="data-entry-label mb-0 " for="trans_date">Loan Date:</label>
										<input name="trans_date" id="trans_date" type="text" class="datetimeinput data-entry-input col-10 mb-2"  placeholder="start of range" value="#trans_date#">
								...
								<div class="col-sm"> 
									<div class='date form-row bg-light border px-2 py-1'>
										...
										<input name="return_due_date" id="return_due_date" type="text" placeholder="start of range" class="datetimeinput data-entry-input col-10 mb-2">
										<label class="data-entry-label sr-only" for="to"></label>
								...
								<div class="col-sm"> 
									<div class="date form-row border bg-light px-2 py-1">
										<label class="data-entry-label mb-0" for="closed_date">Close Date:</label>
										<input name="closed_date" id="closed_date" type="text" class="datetimeinput data-entry-input col-10 mb-2"  placeholder="start of range" value="#closed_date#" > 
