	...
	<main>
		...
		<section class="container-fluid" role="search" id="content">
					...
					<div class="tab-card-main mt-1 tab-card"> 
						...
						<div class="card-header tab-card-header pb-0" id="content">
							<ul class="nav nav-tabs card-header-tabs" id="tabHeaders" role="tablist">
								...
								<li class="nav-item col-2 px-1"> 
									<a class="nav-link px-2 px-sm-3 #loanTabActive#" id="loans-tab" data-toggle="tab" tabindex="0" href="##loanTab" role="tab" aria-controls="Search Loans tab" aria-selected="false" >Loans</a> 	
								</li>
								<li class="nav-item col-3 px-1"> 
									<a class="nav-link px-2 px-sm-3 #accnTabActive#" id="accns-tab" data-toggle="tab" tabindex="0" href="##accnTab" role="tab" aria-controls="Search Accessions tab" aria-selected="false" >Accessions</a> 	
								</li>
							</ul>
						</div>
						<!--- End tab header div ---> 
								...
								<form id="accnSearchForm" class="mt-2">
									...
									<div class="col-md-6">
											<div class="date row bg-light border pb-2 pt-1 px-xl-2 mx-0 rounded justify-content-center">
												...
												<input type="text" name="to_rec_date" id="accn_to_rec_date" value="" placeholder="end yyyy-mm-dd" class="datetimeinput data-entry-input col-4 col-xl-5 hasDatepicker">
												<img class="ui-datepicker-trigger" src="/shared/images/calendar_icon.png" alt="..." title="..."> </div>
										</div>
											</div>
			...
			<!---								<div class="date form-row bg-light border pb-2 pt-1 mx-0 rounded justify-content-center">
										...
										<div class="col-md-6">
											<div class="border bg-light rounded px-0 px-sm-2 pt-1 mb-0 pb-3">
												<h3 class="h5 px-3">Permissions &amp; Rights</h3>
												<div class="col-md-12">
