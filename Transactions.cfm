									...
									<div class="form-row mx-0 mt-1 my-xl-2">
										<div class="col-12 col-md-4">
											<div class="date form-row bg-light border pb-2 px-xl-3 mb-2 mb-md-0 pt-1 mx-0 rounded justify-content-center">
												<label class="data-entry-label px-4 px-md-2 px-xl-2 mx-1 mb-0" for="trans_date">Loan Date</label>
										...
										<div class="col-12 col-md-4">
											<div class="date form-row mx-0 bg-light border pt-1 px-xl-2 pb-2 mb-md-0 mb-2 rounded justify-content-center">
												<label class="data-entry-label mb-0 px-4 px-md-2 px-xl-2 mx-1" for="return_due_date">Due Date</label>
										...
										<div class="col-12 col-md-4">
											<div class="date form-row border bg-light pb-2 px-xl-2 pt-1 mb-2 rounded mx-0 justify-content-center">
												<label class="data-entry-label mb-0 px-4 px-md-2 px-xl-2 mx-1" for="closed_date">Close Date</label>
