  ...
  /**
    ...
    function parse2px(dimText, $elem, isHeight) {
      ...
      switch (unit) {
         ...
         case 'cm':
         case 'mm':
            pixels = {'pt': 4.0 / 3.0, 'in': 96.0, 'cm': 96.0 / 2.54, 'mm': 96.0 / 16.4}[unit] * value;
            break;
         case 'em':
   ...
   // default options
   options: {
      buttonWidth: null,                   // (integer | string | 'auto' | null) Sets the min/max/exact width of the button.
      ...
      noneSelectedText: 'Select Collection', // (string | null) The text to show in the button where nothing is selected.  Set to null to use the native select's placeholder text.
   ...
   _makeOption: function(option) {
    ...
    _updateCache: function() {
      ...
      this._savedButtonWidth = 'auto';
      this._savedMenuWidth = 'auto';
      this._savedMenuHeight = 200;
