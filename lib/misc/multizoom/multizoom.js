...
var executeMultizoom = true;

var featuredimagezoomer = { // the two options for Featured Image Zoomer:
	loadinggif: '/lib/misc/multizoom/spinningred.gif', // full path or URL to "loading" gif
...
(function($){
	...
	$.extend(featuredimagezoomer, {
		...
		showimage: function($tracker, $mag, showstatus){
			...
			specs.$statusdiv.html('Current Zoom: '+specs.curpower+'<div class="smaller">Use Mouse Wheel or touchpad to Zoom In/Out. <span class="d-inline d-md-none">Image appears to right.</span></div>');
