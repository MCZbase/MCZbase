...
<cfoutput>
  <h2 class="wikilink">Search Taxonomy <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")><img src="/images/info_i_2.gif" border="0" onClick="getMCZDocs('Search Taxonomy')" class="likeLink" alt="[ help ]"/></cfif></h2>
					...
					<table>
						...
						<tr>
							<td align="right" nowrap>
								<spanid="common_name"><strong>Common&nbsp;Name:</strong></span>
							</td>
							<td nowrap="nowrap"><input size="25" name="common_name" id="common_name" maxlength="50"></td>
						</tr>
						<tr>
							<td align="right">
								<spanid="taxonomy_scientific_name"><strong>Scientific&nbsp;Name:</strong></span>
							</td>
							<td nowrap="nowrap">
                        ...
                        <tr>
							<td align="right"><b><nobr>Subphylum:</nobr></b></td>
							<td nowrap="nowrap"><input size="25" name="subphylum" maxlength="40"></td>
						</tr>
                        <tr>
						     <td align="right"><b><nobr>Superclass:</nobr></b></td>
						     <td nowrap="nowrap"><input size="25" name="superclass" maxlength="40"></td>
						</tr>
						...
						<tr>
							 <td align="right"><b><nobr>Superorder:</nobr></b></td>
							 <td><input size="25" name="superorder" maxlength="40"></td>
						</tr>
                        ...
                        <tr>
							<td align="right"><b><nobr>Infraorder:</nobr></b></td>
							<td><input size="25" name="infraorder" maxlength="40"></td>
						</tr>						
