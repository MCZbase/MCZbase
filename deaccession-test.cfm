...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <a class="navbar-brand" href="#"><img src="images/krono.gif" class="mcz_logo" alt="MCZ logo">Museum of Comparative Zoology</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Specimen Search</a>
          </li>
          <li class="nav-item">
        ...
        <form class="form-inline mt-2 mt-md-0">
          ...
          <button class="btn btn-outline-harvard my-2 my-sm-0" type="submit">Site Search</button>
        </form>
      </div>
    </nav>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Type of Deaccession</a>
            </li>
            <li class="nav-item">
...
<!---
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
              ...
              <h4>Find Deaccessions</h4>
              <div class="text-muted"></div>
            </div>
            <div class="col-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIABAADcgwAAACwAAAAAAQABAAACAkQBADs=" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Create Deaccessions</h4>
              <span class="text-muted">Something else</span>
            </div>
            <div class="col-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIABAAJ12AAAACwAAAAAAQABAAACAkQBADs=" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Edit Deaccessions</h4>
              <span class="text-muted">Something else</span>
            </div>
            <div class="col-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIABAADcgwAAACwAAAAAAQABAAACAkQBADs=" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
