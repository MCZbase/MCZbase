...
<title>Deaccession Search Results</title>
...
<link href="includes/bootstrap-4.0.0-alpha.6-dist/css/widescreen.css" media="screen" rel="stylesheet">
</head>
<body>
    ...
    <div id="wrapper">
      <div id="sidebar-wrapper">
        ...
        <ul  class="sidebar-nav2" style="margin-left:0;">
          ...
          <li> <a href="#"><i class="fa fa-male" style="font-size:20px;margin-top:1em;" aria-hidden="true"> </i> <span style="margin-left:10px;">By Agent </span> </a> </li>
          <li> <a href="#"> <i class="fa fa-location-arrow" style="font-size:20px;margin-top:1em;" aria-hidden="true"> </i> <span style="margin-left:10px;"> By Location</span> </a> </li>
        </ul>
      </div>
