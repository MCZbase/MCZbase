...
<cfoutput> 
	...
	<cfset showEvent=1>
	<h2>Find Localities <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")><img src="/images/info_i_2.gif" border="0" onClick="getMCZDocs('Find Locality)" class="likeLink" alt="[ help ]"></cfif></h2>
