...
<cfquery name="whoAreYou" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	select 
		collection,
		contact_agent_id
	from 
...
<cfoutput>
	...
	<cfquery name="userdata" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	...
	You are managing loan requests for user #req_name#. This user has submitted the following information about themselves:
	 ...
	 <cfquery name="prevAuth" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	...
	<cfelse>
		 <cfquery name="alreadyGotOne" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		...
		<cfquery  name="gotSpecs" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
			select 
				institution_acronym,
...
<cfoutput>
	<cfquery name="getLoanId" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		select  
			USER_LOAN_ID,
			 PROJECT_TITLE,
			 PROJECT_DESCRIPTION   
...
<cfif #action# is "sendEmailFinally">
	<cfoutput>
	<cfquery name="curr" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
