									...
									<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
										<div class="col-12 col-md-4 px-0 mt-2">
											<div class="date row bg-light border pb-2 mb-2 mb-md-0 pt-1 px-0 px-md-1 px-xl-1 mx-0 rounded justify-content-center">
												...
												<input name="birth_date" id="birth_date" type="text" class="datetimeinput data-entry-input col-5 col-md-5 col-lg-5 px-lg-0 col-xl-5" placeholder="#dateplaceholder#" value="#encodeForHtml(birth_date)#" aria-label="start of range for #dateWord# of birth">
												...
												<input type="text" name="to_birth_date" id="to_birth_date" value="#encodeForHtml(to_birth_date)#" class="datetimeinput col-4 col-lg-5 px-lg-0 col-xl-4 data-entry-input" placeholder="#dateplaceholder#" title="end of date range">
											</div>
										</div>
									</cfif>
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date row bg-light border pb-2 mb-2 mb-md-0 pt-1 px-0 px-md-1 px-xl-1 mx-0 rounded justify-content-center">
											...
											<input name="death_date" id="death_date" type="text" class="datetimeinput data-entry-input col-5 col-md-5 col-lg-5 px-lg-0 col-xl-5" placeholder="#dateplaceholder#" value="#encodeForHtml(death_date)#" aria-label="start of range for #dateWord# of death">
											<div class="col-1 col-xl-1 text-center px-0"><small> to</small></div>
											<label class="data-entry-label sr-only" for="to_death_date">end of search range for #dateWord# of death</label>		
											<input type="text" name="to_death_date" id="to_death_date" value="#encodeForHtml(to_death_date)#" class="datetimeinput col-4 col-lg-5 col-xl-4 px-lg-0 data-entry-input" placeholder="#dateplaceholder#" title="end of date range">
										</div>
									</div>
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date row bg-light border pb-2 mb-2 mb-md-0 pt-1 px-0 px-md-1 px-xl-1 mx-0 rounded justify-content-center">
