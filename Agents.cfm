					...
					<div class="search-box mt-4">
						...
						<div class="col-12 px-3 pt-2 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
								...
								<fieldset class="mt-2 mb-0 px-2 pb-0 pb-xl-0 border-top rounded-top-right rounded-top-left border-right border-left field-set">
								...
								<fieldset class="mb-0 px-2 pb-0 mt-0 border-right border-bottom border-left rounded-bottom-right rounded-bottom-left field-set">
							...
							<!--- ========== SECTION 3: Dates ========== --->
								...
								<fieldset class="mt-2 px-2 border-right border-top border-bottom border-left pb-1 field-set">
									<legend class="h6 my-1 px-3 border-top border-right border-bottom border-left field-set-legend w-auto bg-teal font-weight-bold">Dates</legend>
								...
								<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
									<fieldset class="mb-1 mt-2 px-2 pb-1 field-set border-top border-bottom border-right border-left">
			...
			<section class="container-fluid">
				...
				<!---		<div class="mb-5">--->
							<div class="row mb-0 jqx-widget-header border mx-0 p-2">
								...
								<div id="selectModeContainer" class="mb-1 ml-3" style="display: none;" >
									<script>
