									...
									<div class="form-row mb-0 pt-0">
										...
										<div class="col-12 col-md-4 col-lg-3 col-xl-3 mb-0 mb-md-1 form-group pb-0">
								            ...
								            <span class="small text-secondary">
											    ...
											    <button type="button" class="rules" onclick="var e=document.getElementById('middle_name');e.value='$'+e.value;">$<span class="sr-only">prefix with dollarsign for sounds like search</span></button>,<button type="button" class="rules" onclick="var e=document.getElementById('media_relationship_value');e.value='NULL';"> NULL</button>, <button type="button" class="rules" onclick="var e=document.getElementById('media_relationship_value');e.value='NULL';">NOT NULL</button>)
                                            </span>
