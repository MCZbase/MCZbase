						...
						<div class="col-12 px-3 pt-3 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
								...
								<div class="d-flex flex-wrap mb-2">
									...
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mb-md-0 pt-1 mx-md-1 px-0 px-md-0 px-xl-1 mx-0 rounded justify-content-center">
									...
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mb-md-0 ml-md-1 pt-1 px-0 px-md-0 px-xl-1 mx-0 rounded justify-content-center">
