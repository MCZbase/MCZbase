						...
						<div class="col-12 px-3 pt-2 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
                                ...
                                <fieldset class="my-2 mt-0 px-3 pb-1 border field-set">
                                    <legend class="h6 mb-1 px-3 border2 field-set-legend w-auto">Agent / Identifier</legend>
								    <div class="form-row">
                                ...
                                <!-- ========== SECTION 2: Name components ========== -->
                                 <fieldset class="my-2 px-3 pb-0 border field-set">
                                    <legend class="h6 mt-0 mb-1 px-3 border2 field-set-legend w-auto">Name Components</legend>
                                    <div class="form-row mb-0">
                                ...
                                <fieldset class="my-2 px-3 border pb-1 field-set">
                                    <legend class="h6 mt-0 mb-1 px-3 border2 field-set-legend w-auto">Dates</legend>
                                    <div class="form-row">
                                ...
                                <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
                                   <fieldset class="my-2 px-3 pb-1 field-set border">
                                    <legend class="h6 mt-1 mb-1 px-3 field-set-legend border2 w-auto">Internal Collections &amp; Permissions</legend>
                                        <div class="form-row">
