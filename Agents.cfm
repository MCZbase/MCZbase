...
<div id="overlaycontainer" style="position: relative;"> 
	...
	<cfoutput>
		<main id="content">
            ...
            <cftry>
                  <cfoutput>#renderWikiButtons(buttonClass="btn btn-xs btn-info help-btnSearchWiki border-0")#</cfoutput>
						...
						<div class="col-12 px-3 pt-3 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
								...
								<div class="d-flex flex-wrap mb-0">
									<div class="col-12 col-md-12 col-lg-12 col-xl-5 my-2 px-0">
									...
									<div class="col-12 col-md-5 col-lg-5 col-xl-3 pl-xl-2 pr-xl-0 px-0 pr-md-2 my-2">
									...
									<div class="col-12 col-md-2 col-lg-2 col-xl-1 px-0 px-md-0 my-2">
									...
									<div class="col-12 col-md-5 col-lg-5 col-xl-2 px-0 pl-md-2 my-2">
								...
								<div class="d-flex flex-wrap mb-0">
									...
									<div class="col-12 col-md-4 col-lg-4 col-xl-1 px-0 pl-md-0 mt-md-2 mt-xl-2">
								...
								<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
									<div class="d-flex flex-wrap mb-2">
										<div class="col-12 col-md-6 col-lg-6 px-0 pl-lg-0 pr-lg-0 col-xl-4 mt-2">
										...
										<div class="col-12 col-md-6 col-lg-6 col-xl-4 px-0 pl-md-2 pl-lg-2 pr-lg-0 mt-2">
									...
									<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
										<div class="col-12 col-md-4 px-0 mt-2">
											<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mt-2 mb-md-0 mr-md-1 pt-1 px-2 pr-md-1 pr-lg-1 px-xl-1 mx-0 rounded justify-content-center">
												...
												<input name="birth_date" id="birth_date" type="text" class="datetimeinput data-entry-input w-100 px-xl-2" placeholder="start #dateplaceholder#" value="#encodeForHtml(birth_date)#" aria-label="start of range for #dateWord# of birth">
												...
												<input type="text" name="to_birth_date" id="to_birth_date" value="#encodeForHtml(to_birth_date)#" class="datetimeinput w-100 px-xl-2 data-entry-input" placeholder="end #dateplaceholder#" title="end of date range">
											</div>
										</div>
									</cfif>
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mt-2 mb-md-0 pt-1 mr-md-1 mr-lg-1 px-2 px-md-1 px-xl-1 mx-0 rounded justify-content-center">
											<label class="data-entry-label px-2 px-md-0 px-lg-2 px-xl-4 mx-1 mb-0" for="death_date">#dateWord# Of Death</label>
											<input name="death_date" id="death_date" type="text" class="datetimeinput data-entry-input w-100 px-xl-2" placeholder="start #dateplaceholder#" value="#encodeForHtml(death_date)#" aria-label="start of range for #dateWord# of death">
											<div class="col-1 col-xl-1 text-center px-0"><small> to</small></div>
											<label class="data-entry-label sr-only" for="to_death_date">end of search range for #dateWord# of death</label>		
											<input type="text" name="to_death_date" id="to_death_date" value="#encodeForHtml(to_death_date)#" class="datetimeinput w-100 px-xl-2 data-entry-input" placeholder="end #dateplaceholder#" title="end of date range">
										</div>
									</div>
									<div class="col-12 col-md-4 px-0 mt-2">
										<div class="date d-flex flex-wrap bg-light border pb-2 mb-2 mb-md-0 mt-2 ml-md-1 pt-1 px-2 px-md-1 px-xl-1 mx-0 rounded justify-content-center">
											...
											<input name="collected_date" id="collected_date" type="text" class="datetimeinput data-entry-input w-100 px-xl-2" placeholder="start yyyy-mm-dd or yyyy" value="#encodeForHtml(collected_date)#" aria-label="start of range for dates collected">
											<div class="col-1 col-xl-1 text-center px-0"><small> to</small></div>
											<label class="data-entry-label sr-only" for="to_collected_date">end of search range for dates collected</label>
											<input type="text" name="to_collected_date" id="to_collected_date" value="#encodeForHtml(to_collected_date)#" class="datetimeinput w-100 px-xl-2 data-entry-input" placeholder="end yyyy-mm-dd or yyyy" title="end of date range">
										</div>
									</div>
								</div>
								<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
