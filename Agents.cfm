						...
						<div class="col-12 px-3 pt-2 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
                                ...
                                <fieldset class="my-2 mt-0 px-3 pb-1 border field-set">
								    ...
								    <div class="form-row">
                                        <div class="col-12 col-md-4 mb-0 mt-0 px-0 pr-md-0 form-group">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-8 col-xl-5 pb-0 mb-0 px-0 mt-0">
                                            <div class="form-row mb-0">
                                                ...
                                                <div class="col-12 col-md-7 pr-md-0 form-group mb-0 pb-0">
                                                ...
                                                <!-- Agent Type -->
                                                <div class="col-6 col-md-3 col-xl-3 pl-md-0 form-group mb-0 pb-1 pb-md-1">
                                ...
                                <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
                                   <fieldset class="my-2 px-3 pb-1 field-set border">
                                    <legend class="h6 mt-1 mb-1 px-3 field-set-legend border w-auto">Internal Collections &amp; Permissions</legend>
                                        <div class="form-row">
                                            <div class="col-12 col-md-3 col-xl-3 pr-md-2 px-0 mt-0 mb-md-1 mb-xl-0">
                                            ...
                                            <cfif isdefined("session.roles") and listfindnocase(session.roles,"manage_transactions")>
                                                <div class="col-12 col-md-3 col-xl-3 px-0 mt-0 pr-md-2 px-xl-0">
                                                    <div class="form-group mb-1 pb-0">
