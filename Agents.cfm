						...
						<div class="col-12 px-3 pt-3 pb-2" id="searchFormDiv">
							<form name="searchForm" id="searchForm">
                                ...
                                <fieldset class="my-3 border px-3 bg-med-teal">
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 col-md-4 col-lg-2 col-xl-6 px-0 mt-0">
								        <!-- Birth range, internal users only -->
                                            <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
                                                <div class="form-group">
                                                    <div class="date d-flex flex-wrap bg-light border col-xl-5 pb-2 mb-2 mt-0 mb-md-0 mr-md-2 pt-1 px-2 px-md-2 px-xl-2 mx-0 rounded justify-content-center">
