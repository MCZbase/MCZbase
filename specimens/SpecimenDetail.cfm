...
<cfoutput query="detail" group="cat_num">  
	...
	<cfif toptypestatuskind eq 'Primary' > 
		...
		<cfset typeName = '<span class="font-weight-bold bg-white pb-1 py-1 text-center mt-0 mt-md-3 w-100 d-block float-right">#twotypes# </span>'>
	<cfelseif toptypestatuskind eq 'Secondary' >
		<cfset  twotypes= '#replace(typestatusplain,"|","<br>","all")#'>
		<cfset typeName = '<span class="font-weight-bold bg-white pb-1 px-1 border mt-0 mt-md-3 w-100 d-block ml-auto">#twotypes#  </span>'>
	<cfelse>
		<cfset  twotypes= '#replace(typestatusplain,"|","<br>","all")#'>
		<cfset typeName = '<span class="font-weight-bold text-dark d-block border mt-0 mt-md-3 pb-1 px-1"> </span>'>
	</cfif>
