...
<div role="region" class="container-fluid mb-2">
	...
	<div class="card-body mt-1 d-flex flex-column align-items-start">
		<h1 class="mt-0 mb-0 form-row">
			...
			<cfif isDefined("cited_as") and len(cited_as) gt 0>
				<cfif toptypestatuskind eq 'Primary' >
						<span class="h5 d-block mt-1 mb-3 pb-md-3 pb-xl-0 mb-md-0 mb-md-0 card-text mb-0">#typeName#</span>
				</cfif>
				<cfif toptypestatuskind eq 'Secondary' >
						<span class="h5 d-block mt-1 mb-3 pb-md-3 pb-xl-0 mt-md-1 mb-md-0 card-text mb-0">#typeName#</span>
				</cfif>
			<cfelse>
