						...
						<ul class="d-flex flex-wrap px-1">
							<cfloop query="primaryTypes">
								...
								<cfelseif #toptypestatus# eq "Holotype">
									<cfset typeStatusColor = "darkest_red">
								<cfelseif #toptypestatus# eq "Syntype">
									<cfset typeStatusColor = "dark_orange">
				...
				<section class="col-12 pt-2 mt-0" id="section3">
					...
					<ul class="d-flex px-1 flex-wrap">
						<cfloop query="countries">
							<li class="list-group-item col-2 px-1 text-wrap float-left w-100 h-auto"><a href="#specimenSearch#&country=#country#">#country#</a> (#ct#)</li>
						</cfloop>
						<cfloop query="notcountries">
							<li class="list-group-item col-2 px-1 float-left w-100 h-auto text-wrap"><a href="#specimenSearch#&country=NULL&continent_ocean=#continent_ocean#">#continent_ocean#</a> (#ct#)</li>
						</cfloop>
					</ul>
				</section>
