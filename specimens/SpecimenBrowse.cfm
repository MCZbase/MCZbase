...
<div class="container-fluid">
	...
	<h1 class="px-2 mt-4 mb-0 w-100 text-center">Browse MCZ Specimens by Category</h1>	
		<cfoutput>
			<main class="col-12 col-md-12 py-2 mb-3 float-left mt-1">
				<div class="container-fluid mt-0">
					...
					<div class="tabs card-header tab-card-header px-2 pt-3">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="browse specimens">
							...
							<button class="col-12 px-1 col-sm-2 px-sm-2 col-xl-auto px-xl-5 my-1 my-md-0 #highergeoTabActive#" id="3" role="tab" aria-controls="highergeoPanel" #highergeoTabAria# aria-label="Browse Higher Geography">Higher<br> Geography</button>
							...
							<button class="col-12 px-1 col-sm-2 px-sm-2 col-xl-auto px-xl-5 my-1 my-md-0 #taxonomyTabActive#" id="4" role="tab" aria-controls="taxonomyPanel" #taxonomyTabAria# aria-label="Browse Taxonomy">Taxonomy<br>&nbsp;&nbsp;</button>
						</div>
						<!-- Tab panes -->
							...
							<div id="highergeoPanel" role="tabpanel" aria-labelledby="3" tabindex="-1" class="col-12 px-0 mx-0 #highergeoTabActive# unfocus"  #highergeoTabShow#>
								...
								<cfloop query="continents">
									...
									<cfloop query="countries">
										...
										<li class="list-group-item col-6 col-xl-2 col-md-3"><a href="#specimenSearch#&continent_ocean=#continentLookup#&country=#countryLookup#">#countryVal#</a> (#countries.ct#) </li>
									</cfloop>
									<cfif FindNoCase("ocean",continents.continent_ocean) GT 0>
										...
										<li class="list-group-item col-6 col-xl-2 col-md-3"><a href="#specimenSearch#&continent_ocean=#continentLookup#&ocean_region=#regionLookup#">#regionVal#</a> (#ocean_regions.ct#) </li>
									</cfloop>
									</cfif>
								</cfloop>
								</ul>
