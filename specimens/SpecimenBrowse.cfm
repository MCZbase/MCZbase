				...
				<div class="container-fluid mt-0">
					...
					<div class="tabs card-header tab-card-header px-2 pt-3">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="browse specimens">
							<button class="col-12 px-0 col-sm-3 px-0 col-xl-auto px-xl-5 my-1 text-truncate my-md-0 #featuredTabActive#" id="1" role="tab" aria-controls="featuredPanel" #featuredTabAria# aria-label="Browse Featured Collections">Featured Collections of<br> Cataloged Items</button>
