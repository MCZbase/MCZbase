									...
									<cfloop query="island_groups">
										...
										<div class="w-100 my-2">
											<h4 class="collapsebar mb-0">
												...
												#group# <cfif len(group) EQ 0>#group# (#island_groups.ct#)<cfelse><a class="w-100 d-inline px-3 py-1" href="#specimenSearch#&higher_geog=#island_groups.island_group#">(#island_groups.ct#)</a></cfif>
												</button>
											</h4>
