		...
		<cfthread name="getIdentificationsThread">
			<cfoutput>
				...
				<cfloop query="identification">
					...
					<div class="h6 pl-3 font-italic mt-2 mb-0 text-success formerID">Former Identification<cfif #getTaxa.recordcount# eq 1 and accepted_id_fg is 0 and #i# gte 2>s</cfif></div>
