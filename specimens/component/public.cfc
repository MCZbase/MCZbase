											...
											<div class="col-12 px-1">
												...
												<div class="form-row mx-0">
													<div class="small">#desc.label_value# 
														<button type="button" id="btn_pane1" class="btn btn-xs small mb-1 float-right" onClick="openEditMediaDetailsDialog(#media_id#,'mediaDialog',reloadMedia)">Edit</button>
													</div>
												</div>
											</div>
										<cfelse>
											...
											<div class='col-4 float-left border-white p-1 mb-1'>
												...
												<p class="small">
													...
													<button type="button" id="btn_pane2" class="btn btn-xs small mt-1 float-right" onClick="openEditMediaDetailsDialog(#media_id#,'mediaDialog',reloadMedia)">Edit</button>
										...
										<cfloop query="media">
											...
											<cfif i eq 1><!---This is for one large image at that top if it is not a ledger page or someother --->
												<div class="col-4 px-1">
													...
													<div class="form-row mx-0">
														<div class="small">#desc.label_value# 
															<button type="button" id="btn_pane3" class="btn btn-xs small py-0 mb-1 float-right" onClick="openEditMediaDetailsDialog(#media_id#,'mediaDialog','#guid#',reloadMedia)">Edit</button>
														</div>
													</div>
												</div>
				...
				<cfquery name="citations" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
					...
					<cfif publicationMedia.recordcount gt 0>
						<cfloop query="publicationMedia">
							...
							<div class="col-2 px-3 mt-1 mx-2 float-left d-inline">
								<cfset mt = #mime_type#>
