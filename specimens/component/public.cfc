				...
				<div class="col-12 float-left px-0">
					<ul class="sd list-unstyled bg-light row mx-0 px-2 py-1 mb-0 border-top">
						...
						<cfif colls.recordcount EQ 0>
							<li class="list-group-item col-5 px-0 fw-bolder">Collectors:</li>
							<li class="list-group-item col-7 px-0 fw-bolder">
								None
								<cfif listcontainsnocase(session.roles,"manage_specimens")>
						...
						<cfelse>
							<li class="list-group-item col-5 px-0">
								...
								<span class="my-0 font-weight-bolder">Collector#plural#: </span>
								<cfif listcontainsnocase(session.roles,"manage_specimens")>
							...
							<cfif oneOfUs EQ 0 AND Findnocase("mask collector", check.encumbranceDetail)>
								<li class="list-group-item col-7 px-0 fw-bolder">[Masked]</li>
							<cfelse>
								<cfset collectors = "">
								<cfset sep="">
								<cfloop query="colls">
								...
								<li class="list-group-item col-7 px-0 fw-bolder">#collectors#</li>
							</cfif>
						</cfif>
