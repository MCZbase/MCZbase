			...
			<cfoutput>
				...
				<cfloop query="identification">
					...
					<!---	Start of former Identifications--->
						<cfif #getTaxa.recordcount# eq 1 and accepted_id_fg is 0 and #i# gte 2> Hellos</cfif>
						<cfif #getTaxa.recordcount# eq 1 and accepted_id_fg is 0 and #i# lt 2> Hello</cfif>
