		...
		<div class="col-12 px-0">
			...
			<cfloop query="getAttributes">
				...
				<form name="editAttribute#i#" id="editAttribute#i#" class="my-0 pt-2">
					...
					<div class="border bg-light rounded mx-0 px-0 mt-2 form-row">
						<div class="col-12 border-bottom py-2 mx-0 form-row bg-box-header-gray">#getAttributes.attribute_type#: #getAttributes.attribute_value# <cfif len(#getAttributes.attribute_units#) gt 0>#getAttributes.attribute_units#</cfif>
						</div>
