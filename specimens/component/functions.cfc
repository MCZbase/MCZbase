											...
											<div class="col-12 px-0">
												<div class="row mx-0 my-2 py-2 border">
													...
													<cfquery name="transcript" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
														select media.media_uri from media, media_relations where media_relations.media_id = media.media_id and media_relationship = 'transcript of media' and <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#media.media_id#">
													</cfquery>
