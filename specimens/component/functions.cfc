													...
													<div class="row mt-2">
														<div class="col-6 px-0">
															...
															<cfloop query="determiners">
																...
																<div id="newID"></div>
																<a aria-label="Add another Identifier"  style="max-width: 22px;" class="btn btn-xs btn-primary addIDName col rounded px-1 mx-1 mt-4" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
													<script>	
