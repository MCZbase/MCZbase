												...
												<div class="col-12 border bg-light px-3 rounded mt-0 mb-2 pt-2 pb-3">
													...
													<div class="row mt-2">
														<div class="col-6 px-0">
															...
															<cfloop query="determiners">
																...
																<div id="newID"></div>
																<a aria-label="Add another Identifier"  style="max-width: 22px;" class="btn btn-xs btn-primary addIDName col loginButtons rounded px-1 mr-auto m-1" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
													...
													<script>	
														$(document).ready(function(){
															$(".addIDName").click(function(){$("##newID").append('<div class="col-12"><label for="IdBy_#i#_#idnum#">Identified By<h5 id="IdBy_#i#_#idnum#_view" class="d-inline infoLink">&nbsp;&nbsp;&nbsp;&nbsp;</h5></label><div class="col-12 px-0"><div class="input-group"><div class="input-group-prepend"> <span class="input-group-text smaller bg-lightgreen" id="IdBy_#i#_#idnum#_icon"><i class="fa fa-user" aria-hidden="true"></i></span></div><input type="text" name="IdBy_#i#_#idnum#" id="IdBy_#i#_#idnum#" value="#encodeForHTML(determiners.agent_name)#" class="reqdClr data-entry-input form-control"></div><input type="hidden" name="IdBy_#i#_#idnum#_id" id="IdBy_#i#_#idnum#_id" value="#determiners.agent_id#"><input type="hidden" name="identification_agent_id_#i#_#idnum#" id="identification_agent_id_#i#_#idnum#" value="#determiners.identification_agent_id#"></div></div><script>makeRichAgentPicker("IdBy_#i#_#idnum#", "IdBy_#i#_#idnum#_id", "IdBy_#i#_#idnum#_icon", "IdBy_#i#_#idnum#_view", #determiners.agent_id#);</script></div><button href="javascript:void(0);" arial-label="remove" class="btn data-entry-button addIDName float-right remIDName"><i class="fas fa-times"></i></button></div>');
															});
															$("##customIDName").on('click','.remIDName',function(){$(this).parent().remove()});
														});
													</script>
													</div>
													<div class="row mt-2">
