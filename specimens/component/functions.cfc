											...
											<table>
												<tr>
													<form name="deleCitation#i#" method="post" action="Citation.cfm">
														...
														<td class="border-0 pr-0 pl-2"><button type="button" aria-label="Remove Citation" class="btn btn-xs btn-danger" onclick="removeCitation(#collection_object_id#, #cited_taxon_name_id#)">Remove</button></td>
