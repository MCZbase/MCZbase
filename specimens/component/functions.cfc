   ...
   <cftry>
      ...
      <cfloop query="theResult">
         <cfset resulthtml = resulthtml & "<div class='identifcationExistingForm'>">
			...
			<cfset resulthtml = resulthtml & "<div class='form-group float-right'><button type='button' value='Create New Identification' class='btn btn-primary ml-2' onClick=""$('.dialog-ID').dialog('open'); saveIdentification(saveTo_#collection_object_id#,'identification_id');"">Save Identification</button></div> ">
