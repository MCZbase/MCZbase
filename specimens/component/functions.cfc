...
<div class="col-12 mt-4 px-1">
	<div id="accordion2">
		<div class="card">
			<div class="card-header pt-1" id="headingTwo">
				<h1 class="my-0 px-1 pb-1">
					<button class="btn btn-link text-left" data-toggle="collapse" data-target="##collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> <span class="h4">Add New Attribute</span> </button>
				</h1>
			</div>
