			...
			<div class="col-12 float-left px-0">
				<ul class="list-unstyled bg-light row mx-0 px-3 pt-1 pb-2 mb-0 border-top">
					...
					<cfif len(getLoc.began_date) gt 0 AND getLoc.began_date neq #getLoc.ended_date#>
						...
						<li class="list-group-item col-7 px-0"><input class="data-entry-input w-50" value="#getLoc.began_date#"> - <input class="data-entry-input w-50" value="#getLoc.ended_date#"></li>
					</cfif>
					<cfif len(getLoc.verbatim_date) gt 0>
						<li class="list-group-item col-5 px-0"><h5 class="my-0">Verbatim Date:</h5></li>
						<li class="list-group-item col-7 px-0"><input class="data-entry-input" value="#getLoc.verbatim_date#"></li>
					</cfif>
