								...
								<div class="card">
									<div class="card-header pt-1" id="headingMedia1">
										<h1 class="my-0 px-1 pb-1">
											<button class="btn btn-link w-100 text-left collapsed" data-toggle="collapse" data-target="##collapseMedia199" aria-expanded="true" aria-controls="collapseMedia1"><span class="h4">&nbsp; Add New Media Record &amp; Link it to this Specimen</span> </button>
										</h1>
									</div>
