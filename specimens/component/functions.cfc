				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<button type="button" class="btn btn-xs btn-secondary small mt-1 p-1" onClick="openEditIdentificationsDialog(#collection_object_id#,'identificationsDialog')">Identifications</button>
							<button type="button" class="btn btn-xs btn-secondary small mt-1 p-1" onClick="openEditCitationsDialog(#collection_object_id#,'citationsDialog')">Citations</button>
							<button type="button" class="btn btn-xs  btn-secondary small mt-1 p-1" onClick="openEditOtherIDsDialog(#collection_object_id#,'otherIDsDialog')">Other IDs</button>
