						...
						$('##searchForm').bind('submit', function(evt){
							...
							$("##searchResultsGrid").jqxGrid({
								...
								columns: [
									...
									{text: 'Order', datafield: 'DISP_ORDER', width: 100, hideable: true, hidden: getColHidProp('DISP_ORDER', false) },
									{text: 'Access Role', datafield: 'ACCESS_ROLE', width: 120, hideable: true, hidden: getColHidProp('ACCESS_ROLE', false) },
									{text: 'Hideable', datafield: 'HIDEABLE', width: 80, hideable: true, hidden: getColHidProp('HIDEABLE', false) },
									{text: 'Hidden', datafield: 'HIDDEN', width: 80, hideable: true, hidden: getColHidProp('HIDDEN', false) },
