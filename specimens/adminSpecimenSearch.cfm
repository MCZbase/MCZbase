					...
					$(document).ready(function() {
						...
						$('##searchForm').bind('submit', function(evt){
							...
							var search =
							{
								...
								id: 'id',
								url: '/specimen/component/admin.cfc?' + $('##searchForm').serialize(),
							...
							$("##searchResultsGrid").jqxGrid({
								...
								showtoolbar: false,
								columns: [
									{text: 'Table Name', datafield: 'TABLE_NAME', width: 100, hidable: true, hidden: getColHidProp('TABLE_NAME', false) },
									{text: 'Table Alias', datafield: 'TABLE_ALIAS', width: 100, hidable: true, hidden: getColHidProp('TABLE_ALIAS', false) },
									{text: 'Column Name', datafield: 'COLUMN_NAME', width: 100, hidable: true, hidden: getColHidProp('COLUMN_NAME', false) },
									{text: 'Column Alias', datafield: 'COLUMN_ALIAS', width: 100, hidable: true, hidden: getColHidProp('COLUMN_ALIAS', false) },
									{text: 'Category', datafield: 'SEARCH_CATEGORY', width: 100, hidable: true, hidden: getColHidProp('SEARCH_CATEGORY', false) },
									{text: 'Data Type', datafield: 'DATA_TYPE', width: 80, hidable: true, hidden: getColHidProp('DATA_TYPE', false) },
									{text: 'Data Length', datafield: 'DATA_LENGTH', width: 80, hidable: true, hidden: getColHidProp('DATA_LENGTH', false) },
									{text: 'Label', datafield: 'LABEL', width: 200, hidable: true, hidden: getColHidProp('LABEL', false) },
