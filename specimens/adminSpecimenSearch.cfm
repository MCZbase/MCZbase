					...
					$(document).ready(function() {
						...
						$('##searchForm').bind('submit', function(evt){
							...
							$("##searchResultsGrid").jqxGrid({
								...
								showtoolbar: false,
								columns: [
									{text: 'Table Name', datafield: 'TABLE_NAME', width: 150, hidable: true, hidden: getColHidProp('TABLE_NAME', false) },
									{text: 'Table Alias', datafield: 'TABLE_ALIAS', width: 150, hidable: true, hidden: getColHidProp('TABLE_ALIAS', false) },
									{text: 'Column Name', datafield: 'COLUMN_NAME', width: 150, hidable: true, hidden: getColHidProp('COLUMN_NAME', false) },
									{text: 'Column Alias', datafield: 'COLUMN_ALIAS', width: 150, hidable: true, hidden: getColHidProp('COLUMN_ALIAS', false) },
									{text: 'Category', datafield: 'SEARCH_CATEGORY', width: 120, hidable: true, hidden: getColHidProp('SEARCH_CATEGORY', false) },
