					...
					$(document).ready(function() {
						...
						$('##searchForm').bind('submit', function(evt){
							...
							var categoryCellRenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
								...
								if (category=='Accessions' || category=='Attributes' || category=='Cataloged Item' || category=='Collecting Events' || category=='Named Groups' || category=='Citations' || category=='Collectors' ) {
