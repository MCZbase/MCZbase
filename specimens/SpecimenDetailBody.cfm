				...
				<div class="card mb-2 bg-light">
					...
					<div class="card-header" id="heading1">
						<cfif len(#blockident#) gt 10> 
							<h3 class="h4 my-0">
								<button type="button" class="headerLnk text-left w-75 h-100" href="##" data-toggle="collapse" data-target="##identificationsPane" aria-expanded="true" aria-controls="identificationPane">Identifications</button>
							</h3>
							<cfif listcontainsnocase(session.roles,"manage_specimens")>
								<a type="button" id="btn_pane" class="btn btn-xs small py-0 float-right" onClick="openEditIdentificationsDialog(#collection_object_id#,'identificationsDialog','#guid#',reloadIdentifications)">Edit</a>
							</cfif>
						<cfelse>
							<h3 class="h4 my-0">
