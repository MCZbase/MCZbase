			...
			<div class="col-12 col-md-6 px-1 float-left"> 
				...
				<div class="accordion" id="accordionB">
					<div class="card mb-2 bg-light">
						...
						<button type="button" class="btn btn-xs small float-right" onClick="$('.dialog-ident').dialog('open');loadIdentification(#identification_id#)">Edit</button>
						</div>
						<form id="identificationForm">
							...
							<div id="identificationHTML" class="dialog-ident" title="Edit Identification (id: #identification_id#)"></div>
