...
<cfif oneOfUs is 1>
    ...
    <div class="accordion" id="accordionExample">
            ...
            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="##accordionExample">
                <div class="card-body">
                    <p><img src="https://mczbase.mcz.harvard.edu/specimen_images/herpetology/large/A15810_O_floresiana_P_v.jpg" width="100%"> <a href="https://mczbase.mcz.harvard.edu/MediaSet.cfm?media_id=1335" target="_blank" class="h5 box-shadow-0 d-block text-right my-1">Learn more</a></p>
                </div>
            </div>
        </div>
        <div class="card">
