...
<!------------------------------------ parts new ---------------------------------->
				...
				<div class="accordion" id="accordionParts">
					<div class="card mb-2 bg-light">
                        ...
                        <div id="PartsPane" <cfif #ctPart.ct# gt 5>style="height:300px;" class="collapsed show"<cfelse> class="collapse show"</cfelse> aria-labelledby="headingParts" data-parent="##accordionParts">
