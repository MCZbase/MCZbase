						...
						<div class="card mb-2 bg-light">
							...
							<div class="card-header" id="headingMedia">
								<h3 class="h4 my-0 text-dark">
									...
									<cfif listcontainsnocase(session.roles,"manage_media")>
										<a role="button" href="##" class="btn btn-xs small py-0 anchorFocus" onClick="openEditMediaDetailsDialog(#collection_object_id#,'mediaDialog','#guid#',reloadMedia)">Add/Remove</a>
									</cfif>
								</h3>
							</div>
