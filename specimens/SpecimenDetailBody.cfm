		...
		<cfset guid = "MCZ:#one.collection_cde#:#one.cat_num#">
			...
			<cfquery name="ctmedia" dbtype="query">
				...
				from 
					...
					cataloged_item 
				where 
					media_relations.related_primary_key = cataloged_item.collection_object_id AND cataloged_item.collection_object_ID = <cfqueryparam value=#collection_object_id# CFSQLType="CF_SQL_DECIMAL" >
			</cfquery>
