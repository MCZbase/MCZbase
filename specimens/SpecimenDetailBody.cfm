...
`										for which we aren't (yet) exposing the new name.  Append sp. nov or ssp. nov.
					...
					<!---		<img src="http://www.archive.org/download/proceedingsofnew04newe/page/n22_w392" width="70" height="100" class="float-left mr-2 mb-2"> --->
							<div style="width: 90px;margin:0 auto;float:left;">	<a href="#media_uri#" target="_blank"><img src="#getMediaPreview(preview_uri,media_type)#" alt="#alt#" class="d-block mr-2 mb-2" width="70" height="100"></a> 
						<span class="d-block mx-2 small">#media_type# (#mime_type#) <a href="/media/#media_id#" target="_blank">Media Details</a> #alt# </span></div>
					</cfloop>
				</cfif>
			</div>
		</div>
