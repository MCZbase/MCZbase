			...
			<div class="col-12 col-md-6 px-1 float-left"> 
				...
				<div class="accordion" id="accordionB">
					<div class="card mb-2 bg-light">
						...
						<button type="button" class="btn btn-xs small float-right" onClick="$('##dialog-identification').dialog('open'); loadIdentification(#identification_id#);">Edit</button>
						...
						<div id="collapseID" class="collapse show" aria-labelledby="heading1" data-parent="##accordionB">
							...
							<div class="dialog" id="" title="Edit Identification (id: #identification_id#)">
								<div id="loadIdentificationForm"></div>
							</div>
							</cfloop>
						</div>
						</div>
