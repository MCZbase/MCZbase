											...
											<tbody>
												...
												<cfloop query="mPart">
													...
													<cfif len(part_remarks) gt 0>
														<tr class="small">
															<td colspan="5"><span class="pl-3"><span class="font-italic">Remarks:</span> #part_remarks#</span></td>
														</tr>
													</cfif>
				...
				<cfif len(attribute.attribute_type) gt 0>
					...
					select * from attribute where attribute_type = 'sex'
							...
							len(weight.attribute_units) gt 0>
										...
										<table class="table table-striped mb-1 px-1" aria-label="Standard Measurements">
											<tr>
					...
					<div class="card-body float-left">
						<ul class="list-unstyled form-row p-1 mb-0">
							<cfif colls.recordcount gt 0>
								<li class="list-group-item"><em>Collector(s):&nbsp;</em>
									<cfloop query="colls">
								...
								<li class="list-group-item"><h5 class="mb-1 d-inline-block">Accession:</h5>
									...
									<cfif accnMedia.recordcount gt 0>
										<cfloop query="accnMedia">
											<p>#media_type# (#mime_type#)<a href="/media/#media_id#" target="_blank"><img src="#getMediaPreview('preview_uri','media_type')#" class="sr-only" width="100" alt="media image not available">Media Details</a>#descr# </p>
										</cfloop>
									</cfif>
								</li>
