...
<cfif oneOfUs is 1>
    ...
    <div class="accordion" id="accordionExample">
            ...
            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="##accordionExample">
                <div class="card-body">
                    <p><img src="https://mczbase.mcz.harvard.edu/specimen_images/herpetology/large/A15810_O_floresiana_P_v.jpg" width="100%"> <a href="https://mczbase.mcz.harvard.edu/MediaSet.cfm?media_id=1335" target="_blank" class="h5 box-shadow-0 text-right my-1">Learn more</a></p>
                </div>
            </div>
        </div>
        <div class="card">
			...
			<ul class="list-unstyled row px-3 py-1 mb-0">
				...
				<cfif len(one.spec_locality) gt 0>
					...
					<li class="list-group-item col-6 last">#one.spec_locality#</li>
						...
						<a href="https://www.google.com/maps/@-8.550948,121,6z?hl=en-US" target="_blank" class="h5 box-shadow-0 text-right my-1">Learn more</a></p>
                </div>
            </div>
        </div>
