						...
						<cfif len(#blockident#) gt 10> 
							<h3 class="h4 my-0">
								...
								<cfif listcontainsnocase(session.roles,"manage_specimens")>
									<a id="btn_pane" class="anchorFocus btn btn-xs my-2 mx-3 small py-0 float-right" onClick="openEditIdentificationsDialog(#collection_object_id#,'identificationsDialog','#guid#',reloadIdentifications)">
										Edit
									</a>
								</cfif>
							</h3>
