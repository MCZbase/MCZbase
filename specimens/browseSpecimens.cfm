...
<cfquery name="phyla" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
...
<cfquery name="notphyla" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
...
<cfquery name="notkingdoms" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
...
<cfif target NEQ "noscript">
	<cfquery name="namedGroups" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
		SELECT
...
<cfquery name="primaryTypes" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
...
<cfquery name="continents" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
...
<cfquery name="continent_islands" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
					...
					<cfif target EQ "noscript">
						...
						<div class="col-12 px-0 px-md-2">
							...
							<cfloop query="continents">
								...
								<cfquery name="countries" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#"  cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
								...
								<div class="my-2 w-100">
									<div class="pt-2 w-100" id="cont_ocean_#i#">
										...
										<cfif FindNoCase("ocean",continents.continent_ocean) GT 0>
											<cfquery name="ocean_regions" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#"  cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
						...
						<div class="col-12 px-0 px-md-2">
							...
							<cfloop query="continent_islands">
								...
								<div class="w-100 pb-2 px-4" id="continent_islands_#j#">
									<cfquery name="island_groups" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
									...
									<cfloop query="island_groups">
										...
										<cfquery name="islands" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#"  cachedwithin="#CreateTimeSpan(0,24,0,0)#" timeout="#Application.query_timeout#" >
