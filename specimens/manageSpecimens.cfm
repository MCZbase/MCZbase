						...
						<nav class="navbar navbar-expand-sm bg-white navbar-dark p-0">
							<ul class="navbar-nav d-flex flex-wrap">
								...
								<li class="nav-item mb-1">
									...
									<cfset query="SELECT flat.scientific_name, flat.collection, flat.cat_num, flat.collectors, flat.spec_locality, flat.country,flat.author_text, flat.toptypestatus #crlf#FROM user_search_table#crlf#JOIN flat ON user_search_table.collection_object_id = flat.collection_object_id#crlf#WHERE user_search_table.result_id='#result_id#'#crlf#ORDER BY count(flat.collection_object_id) desc">
