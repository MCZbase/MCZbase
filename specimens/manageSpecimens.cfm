						...
						<nav class="navbar navbar-expand-sm bg-white navbar-dark p-0">
							<ul class="navbar-nav d-flex flex-wrap">
								...
								<li class="nav-item mb-1">
									...
									<a href="/tools/userSQL.cfm?input_sql=#encodeForURL(query)#&action=run" class="nav-link btn btn-secondary btn-xs" target="_blank">Run SQL Queries on this Result</a>
								</li>
	<!---
