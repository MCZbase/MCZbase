										...
										<cfloop query="collections">
											<li class="list-group-item">
												...
												<cfif collections.recordcount GT 0>
													<input type="button" onClick=" confirmDialog('Remove all records from #collections.collection_cde# from these search results','Confirm Remove By Collection Code', function() { }  ); " class="p-1 btn btn-xs btn-warning" value="&##8998;" aria-label="Remove"/>
												</cfif>
												</cfif>
