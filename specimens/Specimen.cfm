					...
					<div class="row mb-0">
						<div class="float-left pr-md-0 my-1 
							<cfif len(header.imageurl) gt 0 and len(summary.cited_as) gt 0> 
								col-12 col-xl-4 
							<cfelseif len(header.imageurl) gt 0 and len(summary.cited_as) is null> 
								col-12 col-xl-6
							<cfelseif len(header.imageurl) is null and len(summary.cited_as) gt 0> 
								col-12 col-xl-3 
							<cfelseif len(header.imageurl) lt 1 and len(summary.cited_as) eq 0>
								col-12 col-xl-5
							<cfelse>
								col-11 </cfif>
						">
