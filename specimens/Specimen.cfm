						...
						<div class="card mb-2 bg-light">
							...
							<div class="card-header" id="headingParts">
								<h3 class="h5 my-0">
									...
									<cfif listcontainsnocase(session.roles,"manage_specimens")>
										<a href="/findContainer.cfm?collection_object_id=#collection_object_id#" target="_blank" role="button" class="btn btn-xs small py-0 anchorFocus mr-5" title="Show parts in container heirarchy">Part Locations</a>
