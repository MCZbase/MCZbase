							...
							<div class="form-row mx-0 my-2">
								...
								<form method="post" action="/users/UserProfile.cfm" name="dlForm" class="userdataForm">
									...
									<div class="form-row">
										...
										<cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>
											<div class="col-12 col-xl-5 float-left px-0 mx-2 mb-2 pt-0 pt-xl-3">
								...
								<cfif isdefined("session.roles") and listcontainsnocase(session.roles,"coldfusion_user")>
									...
									<div class="form-row">
										<div class="col-12 col-xl-7 float-left mb-2 bg-light rounded border p-2">
											...
											<span id="recentDownloadRequestsDiv"> #downloadRequestsBlockContent#</span>
												<p>The number of rows and columns determine how long it takes to process. <br>Once the download link appears, it remains for 24 hours and then is deleted.</p>
