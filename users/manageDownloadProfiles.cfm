									...
									$(document).ready(function () {
										...
										$("##available_fields").jqxListBox({ 
											...
											renderer:function (index, label, value) 
												{
												    var datarecord = $("##available_fields").jqxListBox('source').records.filter(obj => { return obj.id === value });
								...
								<script>
									$(document).ready(function () {
										...
										$("##included_fields").jqxListBox({ 
											...
											renderer:function (index, label, value) 
												{
												    var datarecord = $("##included_fields").jqxListBox('source').records.filter(obj => { return obj.id===value });
