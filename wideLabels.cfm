...
<cfdocument
        ...
        filename="#Application.webDirectory#/temp/widelabels_#cookie.cfid#_#cookie.cftoken#.pdf" orientation="portrait" >
...
<a href="/temp/widelabels_#cookie.cfid#_#cookie.cftoken#.pdf">Get the PDF</a><br />
...
<!---<cfset sql="
	...
	WHERE
		accepted_id_fg=1 AND cataloged_item.collection_object_id IN (#collection_object_id#)
">
<cfquery name="geogQuery" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	#preservesinglequotes(sql)#
</cfquery>--->
...
<cfset sql="
	...
	ORDER BY
		cat_num
">
<cfquery name="partsQuery" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
	#preservesinglequotes(sql)#
</cfquery>
