			...
			<div class="search-box col-12 px-0">
				...
				<cfoutput>
					<div class="col-12 my-2">
						...
						<fieldset class="my-0 px-2 pb-1 px-xl-0 border-top border-right border-bottom border-left field-set">
						...
						<fieldset class="my-2 px-2 pb-1 px-xl-0 border-top border-right border-bottom border-left field-set">
							<legend class="h6 mb-0 px-3 border-top border-right border-bottom border-left field-set-legend bg-teal font-weight-bold w-auto" aria-level="2">
