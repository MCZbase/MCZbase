						...
						<fieldset class="my-2 px-2 pb-1 border-top border-right border-bottom border-left field-set">
							...
							<div class="form-row">
								<div class="col-12 col-xl-4">
									<div class="form-row">
										<h3 class="h6 mb-0 px-2 mt-2 w-100 mx-0 font-weight-bold"><span class="bg-light w-auto border px-3">Specimen</span></h3>
								...
								<div class="col-12 col-xl-4">
									...
									<div class="form-row">
										<h3 class="h6 mb-0 px-2 mt-2 w-100 font-weight-bold"><span class="bg-light border w-auto">Taxon</span></h3>
								...
								<div class="col-12 col-xl-4">
									...
									<div class="form-row">
										<h3 class="h6 mb-0 px-2 mt-2 w-auto font-weight-bold"><span class="bg-light border w-auto">Agent</span></h3>
								...
								<div class="col-12">
									<div class="form-row">
										<h3 class="h6 px-2 mt-2 mb-0 font-weight-bold w-auto"><span class="bg-light border">Publication and Project</span></h3>
