	...
	<cfsavecontent variable="sectionHtml">
		...
		<div class="card-body bg-white border-bottom py-2 pl-4" data-reply-parent-id="#arguments.rootAnnotationId#">
			<div class="d-flex justify-content-between align-items-center mb-2">
				...
				<button type="button" class="btn btn-xs btn-primary" onclick="openReplyAnnotationDialog(#encodeForJavaScript(arguments.rootAnnotationId)#);">Reply in Dialog</button>
			</div>
