								...
								<div class="form-row mb-0">
									<div class="col-12 col-md-6">
										...
										<div class="input-group">
											<div class="input-group-prepend"> <span class="input-group-text" id="underscore_agent_name_icon"><i class="fa fa-user" aria-hidden="true"></i></span> </div>
							...
							<cfif undCollUse_result.recordcount EQ 0>
								...
								<ul>
									<cfloop query="undCollUse">
										<li><a href="/guid/#undCollUse.guid#" target="_blank">#undCollUse.guid#</a></li>
									</cfloop>
								</ul>
							</cfif>
						</div>
