							...
							<div class="col-12 px-0">
								...
								<div class="col-12 #colClass# mx-md-auto mt-3 mb-3">
									<div class="carousel_background border float-left w-100 p-3">
										...
										<div class="vslider float-left w-100 px-2 py-1"  style="height: 450px" id="vslider-base1">
											<cfset i=1>
								...
								<div class="carousel_background border float-left w-100 p-3">
									...
									<div class="vslider float-left w-100 px-2 py-1" style="height: 450px" id="vslider-base2">
										<cfset i=1>
								...
								<cfif localityImagesForCarousel.recordcount gt 0>
									<div class="col-12 #colClass# mx-md-auto mt-3">
										...
										<div class="vslider w-100 float-left px-2 py-1" style="height: 450px" id="vslider-base3">
											<cfset i=1>
