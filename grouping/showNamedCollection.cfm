								  ...
								  <div class="vslider w-100 float-left" style="height:820px;" id="vslider-base">
									...
									<cfelse>
										...
										<div class="vslider-styling float-left px-3 pt-2">
											...
											<a href="#media_uri#" target="_blank" class="d-block my-1 bg-light float-left col-10" title="click to open full image">
											...
											<span class="d-block float-left col-2">
							...
							<div class="col-12 px-0 mt-2 mb-3">
								...
								<div class="col-12 #colClass# mx-md-auto my-3">
									<div class="carousel_background border float-left w-100 p-2 h-auto">
										...
										<div class="vslider w-100 float-left" style="height:490px;" id="vslider-base1">
											<cfset i=1>
								...
								<div class="carousel_background border float-left w-100 p-2">
									...
									<div class="vslider w-100 float-left" style="height: 490px;" id="vslider-base2">
										<cfset i=1>
								...
								<cfif localityImagesForCarousel.recordcount gt 0>
									<div class="col-12 #colClass# mx-md-auto mt-3">
										...
										<div class="vslider w-100 float-left" style="height: 490px;" id="vslider-base3">
											<cfset i=1>
