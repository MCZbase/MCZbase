					...
					<cfif specimenImagesForCarousel.recordcount GT 0 OR localityImagesForCarousel.recordcount GT 0 OR collectingImagesForCarousel.recordcount GT 0 OR agentImagesForCarousel.recordcount GT 0>
						...
						<div class="row">
							<div class="col-12 px-2">
								...
								<div class="vslider" id="vslider-base1" style="height:370px;">
									<cfset i=1>
								...
								<div class="vslider" id="vslider-base2" style="float:left;height:auto;">
									<cfset i=1>
								...
								<cfif localityImagesForCarousel.recordcount gt 0>
									...
									<div class="col-12 #colClass# mx-md-auto px-md-0 mt-3">
										...
										<div class="vslider" id="vslider-base3" style="float:left;height:auto;">
											<cfset i=1>
								...
								<cfelse>
										...
										<div class="vslider" id="vslider-base3" style="height:370px;">
											<cfset i=1>
											<cfloop query="localityImagesForCarousel">
												<div class="carousel_background border px-3 pt-3 small pb-1">#agentImagesForCarousel['alt'][i]# <br><a href="/MediaSet.cfm?media_id=#localityImagesForCarousel['media_id'][i]#">Media Details</a><br><a href="#media_uri#" target="_blank" title="click to open full image"><img src="#localityImagesForCarousel['media_uri'][i]#" class="w-auto mx-auto" style="max-width:100%;float:left; height:auto;"></a></div>
												<cfset i=i+1>
											</cfloop>
										</div>
									</div>
