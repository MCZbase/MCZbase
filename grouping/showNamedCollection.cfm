...
.vslider-next:after {
  ...
  <div class="vslider" id="vslider-base" style="height:600px;">
	  <cfset i=1>
	<cfloop query="specimenImagesForCarousel">
		<div>#specimenImagesForCarousel['alt'][i]# <br><a href="/MediaSet.cfm?media_id=#specimenImagesForCarousel['media_id'][i]#">Media Details</a><br><a href="#media_uri#" target="_blank" title="full image"><img src="#specimenImagesForCarousel['media_uri'][i]#" class="w-100 mr-5 mb-2"></a></div>
		<cfset i=i+1>
	</cfloop>
