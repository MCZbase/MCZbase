								...
								<cfif points.recordcount gt 0>
									...
									<section class="heatmap mt-2 float-left w-100">
										...
										function initMap() {
											...
											var sw = new google.maps.LatLng(<cfif #points2.minlat# gt -50>#points2.minlat#<cfelse>-50</cfif>,<cfif #points2.minlong# lt -152>#points2.minlong#<cfelse>70</cfif>);
											var bounds = new google.maps.LatLngBounds(sw, ne);
											var centerpoint = new google.maps.LatLng(<cfif #points2.maxlong# lt 155>#points2.mylat#,#points2.mylng#<cfelse>19,127</cfif>);
											var mapOptions = {
												zoom: 1,
												minZoom: 1,
												maxZoom: 14,
