							...
							<div class="row">
								<div class="col-12 col-md-4">
									...
									<div id="carouselExampleControls4"  class="carousel slide carousel-fade" data-interval="false" data-ride="carousel" data-pause="hover" >
										...
										<a class="carousel-control-prev box-shadow-0" href="##carouselExampleControls4" role="button" data-slide="prev" style="top: -47%;"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a> <a class="carousel-control-next box-shadow-0" href="##carouselExampleControls4" role="button" data-slide="next" style="top:-47%;"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="sr-only">Next</span> </a> </div>
								</div>
								<div class="col-12 col-md-4">
