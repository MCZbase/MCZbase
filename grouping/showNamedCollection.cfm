										...
										<div class="col-12 px-1">
											<div class="carousel_background border rounded float-left w-100 p-2 mb-4">
												...
												<div class="vslider w-100 float-left bg-light" id="vslider-base">
													...
													<cfif i eq 1>
													<script>
													//	var srcWrap = "<a href='#media_uri#' target='_blank' class='d-block my-1 w-100' title='click to open full image'><img src='/media/rescaleImage.cfm?media_id=#specimenImagesForCarousel['media_id'][1]##sizeType#' class='mx-auto' alt='#trimmedAltText#' height='100%' width='100%'></a>";
