				...
				<article class="w-100">
					<div class="col-12">
						...
						<div class="row mx-0 clearfix">
							...
							<cfif specimenImageQuery.recordcount GT 1 >
								<cfset hasmediaclass = "mt-md-5">
							<cfelse>
								<cfset hasmediaclass = "" >
							</cfif>
							<div class="col mt-0 #hasmediaclass# float-left">
