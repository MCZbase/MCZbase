						...
						<cfif specimenImgs.media_uri gt 0>
							...
							<h2 class="mt-3">Images</h2>
								<div class="row">
									...
									<h3 class="h4">Specimen Images (#specimenImgs.recordcount#). Refresh page to show a different 25 images (if there are more than 25).</h3>
										<div class="carousel-wrapper">
											<div class="carousel" style="background-color: ##e8e8e8;">
											<cfset i=1>
								...
								<div class="row">
									<cfif agentImagesForCarousel.recordcount gt 0>
										<div class="col-12 col-md-6 mx-md-auto px-md-0 mt-3">
											<h3 class="h4">Agent Images (#agentImagesForCarousel.recordcount#). (25 images displayed).</h3>
									...
									<cfif collectingImagesForCarousel.recordcount gt 0>
										<div class="col-12 col-md-auto mx-md-auto px-md-0 mt-3">
											<h3 class="h4">Collecting Images (#collectingImagesForCarousel.recordcount#). (25 images displayed).</h3>
