												...
												<div class="vslider w-100 float-left bg-light" id="vslider-base">
													...
													<cfloop query="specimenImagesForCarousel">
														...
														<div class="w-100 bg-light float-left px-3 h-auto">
															...
															<cfset src=specimenImagesForCarousel['media_id'][i]>
															<cfset size='?width=1000&height=1000'>
															<cfif fileExists(#src#)>
																<a href="#media_uri#" target="_blank" class="d-block my-1 w-100" title="click to open full image">
																	<img src="https://mczbase-dev.rc.fas.harvard.edu/media/rescaleImage.cfm?media_id
> =1474028&height=300&width=300" class="mx-auto" alt="#trimmedAltText#" height="100%" width="100%">
																</a>
