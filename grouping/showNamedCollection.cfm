							...
							<div class="col-12 col-md-6 float-left px-0 mt-4 mb-3">	
								...
								<cfif points.recordcount gt 0>
									...
									<section class="heatmap mt-2 float-left w-100">
										...
										let map, heatmap;
										function initMap() {
											var ne = new google.maps.LatLng(<cfif #points2.maxlat# lt 58>#points2.maxlat#<cfelse> 58</cfif>, <cfif #points2.maxlat# lt 179>#points2.maxlong#<cfelse>178</cfif>);
											var sw = new google.maps.LatLng(<cfif #points2.minlat# gt -58>#points2.minlat#<cfelse>-58</cfif>,<cfif #points2.minlat# gt -179>#points2.minlong#<cfelse>-179</cfif>);
