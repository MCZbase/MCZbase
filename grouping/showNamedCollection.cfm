...
.vslider-next:after {
  ...
  <div class="vslider" id="vslider-base" style="height:800px;">
	  <cfset i=1>
	<cfloop query="specimenImagesForCarousel">
		<div><img src="#specimenImagesForCarousel['media_uri'][i]#" class="w-75"><br>#specimenImagesForCarousel['alt'][i]# <br><a href="/MediaSet.cfm?media_id=#specimenImagesForCarousel['media_id'][i]#">Media Details</a></div>
		<cfset i=i+1>
	</cfloop>
