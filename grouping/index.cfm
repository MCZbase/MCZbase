			...
			<main class="col-12 col-md-12 bg-light border rounded px-2 py-2 mb-3 float-left mt-1">
				<nav class="col-12 col-md-12 float-left">
					<ul class="nav nav-tabs">
						<cfloop query="types">
							<li class="nav-item">
								<h2 class="h3 mb-0"><a href="/grouping/index.cfm?underscore_collection_type=#types.underscore_collection_type#" class="nav-link active">#types.underscore_collection_type#</a></h2>
