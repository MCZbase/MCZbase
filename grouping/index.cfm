		...
		<div class="row mx-0">
			...
			<cfloop query="groups">
				...
				<cfif len(#groups.description#)gt 0>
					<div class="col-12 px-2 float-left my-2">
						<div class="border rounded py-3 col-12 float-left">
							<div class="row mx-0">
								<cfif len(images.media_id) gt 0>
									<cfset mediablock= getMediaBlockHtml(media_id="#images.media_id#",size="180")>
									<div class="col-4 float-left py-2 bg-light border rounded" id="mediaBlock#images.media_id#">
									#mediablock#
									</div>
								<cfelse>
									<div class="col-4 py-2 float-left bg-light border rounded">
