          ...
          <h3>We use css to change the background color of the content to be equal to the tab</h3>
					...
					<div class="tabs card-header tab-card-header px-2 pt-3">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="search panel tabs">
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #fixedTabActive#" id="1" role="tab" aria-controls="fixedSearchPanel" #fixedTabAria#><a href="##1">Basic Search</a></button>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #keywordTabActive#" id="2" role="tab" aria-controls="keywordSearchPanel" #keywordTabAria# ><a href="##2">Keyword Search</a></button>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #builderTabActive#" id="3" role="tab" aria-controls="builderSearchPanel" #builderTabAria# aria-label="search builder tab"><a href="##3">Search Builder</a></button>
						</div>
