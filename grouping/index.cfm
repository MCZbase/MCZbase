				...
				<div class="container px-0 mt-0">
					...
					<div class="tabs card-header tab-card-header px-2 pt-3">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="browse collections types">
							...
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #collectionTabActive#" id="2" role="tab" aria-controls="collectionPanel" #collectionTabAria# aria-label="Browse Collections"><img src="/shared/images/filter-3-line.svg" style="width:15px;">  Collections</button>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #expeditionTabActive#" id="3" role="tab" aria-controls="expeditionPanel" #expeditionTabAria# aria-label="Browse Expeditions"><img src="/shared/images/filter-3-line.svg" style="width:15px;"> Expeditions</button>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #grantTabActive#" id="4" role="tab" aria-controls="grantPanel" #grantTabAria# aria-label="Browse Grants"><img src="/shared/images/filter-3-line.svg" style="width:15px;"></i> Grants</button>
							<cfif isdefined("session.roles") and listfindnocase(session.roles,"manage_specimens")>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #workflowTabActive#" id="5" role="tab" aria-controls="workflowPanel" #workflowTabAria# aria-label="Browse Workflow"><img src="/shared/images/filter-3-line.svg" style="width:15px;"><!---<i class="fas fa-filter text-secondary"></i>---> Workflows</button>
							</cfif>
						</div>
