				...
				<div class="container px-0 mt-0">
					...
					<div class="tabs card-header tab-card-header px-2 pt-3">
						...
						<div class="tab-headers tabList" role="tablist" aria-label="browse collections types">
							...
							<cfif isdefined("session.roles") and listfindnocase(session.roles,"manage_specimens")>
							<button class="col-12 col-md-auto px-md-5 my-1 my-md-0 #workflowTabActive#" id="5" role="tab" aria-controls="workflowPanel" #workflowTabAria# aria-label="Browse Workflow"><img src="/shared/images/filter-3-line.svg" width="14"><!---<i class="fas fa-filter text-secondary"></i>---> Workflows</button>
							</cfif>
						</div>
