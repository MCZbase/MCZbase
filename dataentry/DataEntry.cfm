						...
						<div class="border-fill px-3 pt-1 pb-2 m-1" id="mydivheader4">
							...
							<div id="customAgent">
								<div class="form-row">
									...
									<a aria-label="Add another set of search criteria" class="btn btn-xs btn-primary addAgent col px-1 rounded text-center" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6 pb-1 px-1" id="mydiv9">
						...
						<!---	<h3 class="data-entry-subtitle">This is step 10</h3>--->
							<div id="customCoord">
								...
								<a aria-label="Add Coordinates" style="max-width: 26px;" class="btn btn-xs btn-primary col addCoord loginButtons rounded px-1 mr-auto m-1" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
								</div>
							</div>
...
$(document).ready(function(){
	...
	//this is from https://stackoverflow.com/questions/16183231/jquery-append-and-remove-dynamic-table-row  
$(document).ready(function(){
	$(".addCoord").click(function(){$("##customCoord").append('<div class="form-row mt-1"><label for="higher_geog" class="data-entry-label col-sm-3 text-center text-md-right pr-0">Coordinates Units</label><div class="col-sm-8 px-1"><select class="data-entry-select pr-0" required><option value="">Decimal Degrees</option><option value="1">Dec. Min. Secs.</option><option value="2">Degrees Dec. Minutes</option><option value="3">Unknown</option></select></div></div><div class="row"><label for="higher_geog" class="data-entry-label col-sm-3 text-center text-md-right px-0">Maximumm Error</label><div class="col-12 col-sm-4"><input type="text" name="maximum_error" class="data-entry-input" placeholder="Maximum Error" /></div><div class="col-12 col-sm-4 pr-0"><input type="text" class="data-entry-input pr-xl-0" placeholder="Error Units"></div></div><div class="row"><label for="extent" class="data-entry-label col-sm-3 text-center text-md-right pr-0">Extent</label><div class="col-sm-8"><input type="text" name="extent" class="data-entry-input" placeholder="Extent" /></div></div><div class="row"><label for="GPS_accuracy" class="data-entry-label col-sm-3 text-center text-md-right px-0">GPS Accuracy</label><div class="col-sm-8"><input type="text" name="gps_accuracy" class="data-entry-input" placeholder="GPS Accuracy" /></div></div><div class="row"><label for="higher_geog" class="data-entry-label col-sm-3 text-center text-md-right px-0">Datum</label><div class="col-sm-8"><select class="data-entry-select pr-0" required><option value="">NAD27</option><option value="1">POS</option><option value="2">GRA</option><option value="3">WGS84</option></select></div></div><div class="row"><label for="determiner" class="data-entry-label col-sm-3 text-center text-md-right px-0">Determiner</label><div class="col-sm-8"><input type="text" name="determiner" class="data-entry-input" placeholder="Determiner"/></div></div><div class="row"><label for="date" class="data-entry-label col-sm-3 text-center text-md-right pr-0">Date</label><div class="col-sm-8"><input type="text" name="date" class="data-entry-input" placeholder="Date" /></div></div><div class="row"><label for="higher_geog" class="data-entry-label col-sm-3 text-center text-md-right pr-0">Georeference Meth.</label><div class="col-sm-8"><select class="data-entry-select pr-0" required><option value="">GeoLocate</option><option value="1">GPS</option><option value="2">Google Earth</option><option value="3">Gazetteer</option></select></div></div><div class="row"><label for="reference" class="data-entry-label col-sm-3 text-center text-md-right px-0">Reference</label><div class="col-sm-8"><input type="text" name="reference" class="data-entry-input" placeholder="Reference" /></div></div><div class="row"><label for="locality_remark" class="data-entry-label col-sm-3 text-center text-md-right pr-0">Locality Remark</label><div class="col-12 col-xl-8 pl-xl-0"><textarea type="text" name="locality_remark" class="data-entry-textarea" placeholder="Locality Remark"/></textarea></div><button href="javascript:void(0);" arial-label="remove" class="btn addCoord float-right data-entry-button remCoord"><i class="fas fa-times"></i></button></div>');
	});
