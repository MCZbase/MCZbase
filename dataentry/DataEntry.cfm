			...
			<div class="col-12 col-xl-8 justify-content-center mt-2 mx-auto">
				<form id="regForm" action="/DataEntry.cfm">
					...
					<div class="my-4 text-center"> 
						<span class="step">Identifiers</span> <span class="step">Identifications</span> <span class="step">Agents</span> <span class="step">Coll. Event</span> <span class="step">Locality</span> <span class="step">Coordinates</span> <span class="step">Parts</span> <span class="step">Attributes</span> <span class="step">Bio.&nbsp;Relationships</span> <span class="step">Curatorial</span> <span class="step">Encumbrance</span>
					</div>
				</form>
			</div>
		</div>
