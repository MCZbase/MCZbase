							...
							<div class="portlet-content px-3">
								<div id="customPart">
									...
									<div class="form-row mx-0 my-2">
											...
											<input type="text" class="data-entry-input col-12 col-xl-3 mt-1 height1p2 float-left" name="part_name">
										...
										<input type="text" class="data-entry-input col-12 col-xl-4 float-left height1p2" name="condition">
										</div>
