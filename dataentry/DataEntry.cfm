								...
								<div class="form-row mx-0">
									...
									<div class="form-row mx-0 my-2">
										...
										<div class="col-12 col-md-5 px-0 mt-1">
											<label for="made_by_date" class="small font-weight-light col-12 col-xl-2 px-1 float-left text-right d-block mt-1 mb-0">Date</label>
											<input type="text" name="made_by_date" class="col-12 col-xl-10 px-0 float-left data-entry-input height1p2"/>
										</div>
