								...
								<div id="customSciName">
									<div class="form-row mx-0 my-2">
										...
										<div class="col-12 px-0">
											...
											<input type="text" name="max_error_distance" id="max_error_distance" class="data-entry-input col-8 col-md-7 col-xl-8 float-left" />
											<select class="data-entry-select col-4 col-md-5 col-xl-4 float-left" required>
