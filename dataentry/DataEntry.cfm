									...
									<div id="customSciName">
										<div class="bg-light border rounded px-2 pb-2"> 
											...
											<div class="col-12 px-0">
												...
												<select class="data-entry-select col-4 col-md-3 float-left mt-1 height1p2" required>
													<option value="">Units</option>
													<cfloop query="error_units">
											...
											<div class="col-12 mt-2 border bg-light rounded p-1">
												...
												<select class="data-entry-select col-12 float-left col-xl-9 mt-1 height1p2" required>
												...
												<select class="data-entry-select col-12 col-xl-9 mt-1 float-left height1p2" required>
