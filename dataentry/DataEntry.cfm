					...
					<div class="col-12 col-md-6 pb-1 px-1" id="mydiv9">
						...
						<!---	<h3 class="data-entry-subtitle">This is step 10</h3>--->
							<div id="customCoord">
								...
								<a aria-label="Add Coordinates" style="max-width: 22px;" class="btn btn-xs btn-primary col addCoord loginButtons rounded px-1 mr-auto m-1" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
								</div>
							</div>
						...
						<!---	<h3 class="data-entry-subtitle">This is step 12</h3>--->
							<div id="customAtt">
								...
								<div class="row">
									...
									<a aria-label="Add another set of search criteria" style="max-width: 22px;" class="btn btn-xs btn-primary col addAtt loginButtons rounded px-1 mr-auto mt-0 mx-1 mb-1" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
								</div>
...
$(document).ready(function(){
	...
	//this is from https://stackoverflow.com/questions/16183231/jquery-append-and-remove-dynamic-table-row  
$(document).ready(function(){
	$(".addPart").click(function(){$("##customPart").append('<div class="form-row mx-0 my-2"><label for="part_name" class="data-entry-label text-center">Part Name</label><input type="text" class="data-entry-input" name="part_name" placeholder="Part Name"><label for="other_id" class="data-entry-label text-center">Preserve Method</label><select class="data-entry-select" required><option value="">Ethanol</option><option value="1">RNALater</option><option value="2">DNA/RNA Shield</option><option value="3">Alcohol</option></select><label for="condition" class="data-entry-label text-center">Condition</label><input type="text" class="data-entry-input" name="condition" placeholder="Condition"><label for="disposition" class="data-entry-label text-center">Disposition</label><select class="data-entry-select" required><option value="">Being Processed</option><option value="1">deaccessioned</option><option value="2">in collection</option><option value="3">missing</option></select><label for="part_number" class="data-entry-label text-center">## of Parts</label><select class="data-entry-select" required=""><option value="">Modifier</option><option value="1">ca.</option><option value="2">&gt;</option><option value="3">&lt;</option></select><input type="text" name="part_number" class="data-entry-input" placeholder="Number of Parts"><label for="container_unique_id" class="data-entry-label text-center">Container</label><input type="text" class="data-entry-input" name="container_unique_id" placeholder="Container Unique ID"><label for="part_remark" class="data-entry-label text-center">Remark</label><textarea type="text" name="part_remark" class="data-entry-textarea" placeholder="Part Remark"/></textarea><button href="javascript:void(0);" arial-label="remove" class="btn data-entry-button addPart float-right remPart"><i class="fas fa-times"></i></button></div>');
	});
