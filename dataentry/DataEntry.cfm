									...
									<div id="customSciName">
										<div class="form-row mx-0 mb-2">
											...
											<input type="text" name="verbatim_locality mt-0" class="data-entry-input height1p2 col-12 col-md-9 px-0 float-left"/>
												...
												<label for="inputPassword3" class="small font-weight-light col-12 col-md-6 float-left d-block mt-1 mb-0">Verbatim Date</label>
												<input type="text" class="data-entry-input col-12 col-md-6 px-0 mt-0 height1p2" id="verbatim_date">
											</div>
