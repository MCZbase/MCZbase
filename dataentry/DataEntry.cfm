								...
								<div class="form-row mx-0">
									...
									<div id="customAtt">
										<div class="form-row mx-0 my-2">
											...
											<label for="part_number" class="small font-weight-light col-12 col-xl-3 px-2 float-left d-block mt-2 mb-0">Attribute Value</label>
											<input type="text" name="attribute value" class="data-entry-input float-left col-12 col-xl-4 height1p2">
