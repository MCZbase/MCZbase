							...
							<div class="portlet-content px-3">
								<div class="form-row mx-0">
									...
									<div class="form-row mx-0 my-2">
										<label for="scientific_name" class="small col-12 col-xl-3 font-weight-light float-left d-block mt-1 mb-0">Identification</label>
										<input type="text" name="scientific_name" class="col-12 col-xl-9 mt-1 pl-0 float-left data-entry-input height1p2"/>
										<label for="made_by" class="small font-weight-light col-12 col-xl-3 float-left d-block mt-1 mb-0">ID Made By</label>
										<input type="text" name="made_by" class="col-12 col-xl-9 mt-1 pl-0 float-left data-entry-input height1p2"/>
										<div class="col-12 col-md-6 px-0 mt-1">
											<label for="nature_of_id" class="small font-weight-light col-12 col-xl-4 px-1 float-left d-block mt-1 mb-0">Nature of ID</label>
											<select class="data-entry-select smallselect col-12 col-xl-7 pl-0 float-left height1p2">
										...
										<div class="col-12 col-md-6 px-0 mt-1">
											<label for="made_by_date" class="small font-weight-light col-12 col-xl-3 px-1 float-left d-block mt-1 mb-0">Date</label>
											<input type="text" name="made_by_date" class="col-12 col-xl-9 float-left data-entry-input height1p2"/>
										</div>
										<label for="id_remark" class="small font-weight-light col-12 col-xl-3 float-left d-block mt-1 mb-0">ID Remark</label>
										<textarea type="text" name="id_remark" rows="1" class="col-12 col-xl-9 mt-1 float-left data-entry-textarea"/></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="portlet shadow-none rounded-0 m-0 bg-blue-gray">
							...
							<div class="portlet-content bg-blue-gray px-0 px-xl-3">
								<div class="form-row mx-0">
									<div class="col-12">
										<div id="customAgent1">
											<a aria-label="Add another set of search criteria" class="btn btn-xs btn-primary py-0 addAgent1 mx-2 my-2" target="_self" href="javascript:void(0);"> <i class="fa fa-plus"></i> Add Agent</a> 
											<div class="form-row mx-0">
								...
								<div class="form-row mx-0">
									...
									<div id="customSciName">
										<div class="form-row mx-0 mb-2">
											...
											<label for="microhabitat" class="small font-weight-light mt-1 col-12 col-md-2 float-left d-block mt-1 mb-0">Microhabitat</label>
											<input type="text" name="habitat" class="data-entry-input mt-1 col-12 col-md-2 mt-1 height1p2"/>
