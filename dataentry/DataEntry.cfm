...
<cfoutput>
	...
	<p class="btn" style="position:absolute; top: 95px; left:15px;"> <a href="javascript:SwapDivsWithClick('swapper-first','swapper-other')">(Switch Between Full Screen and Step Form)</a> </p>
