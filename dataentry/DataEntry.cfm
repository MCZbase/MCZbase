							...
							<div class="portlet-content px-3">
								<div class="form-row mx-0">
									...
									<div class="form-row mx-0 my-2">
										...
										<input type="text" name="scientific_name" class="col-12 col-md-10 float-left data-entry-input height1p2"/>
										...
										<div class="col-12 col-md-6 px-0">
											<label for="nature_of_id" class="small font-weight-light col-12 col-md-3 px-0 float-left d-block mt-1 mb-0">Nature of ID</label>
