							...
							<div class="portlet-content bg-blue-gray px-0 px-xl-3">
								<div class="form-row mx-0">
									<div class="col-12 px-0">
										<div id="customAgent1">
											<a aria-label="Add another set of search criteria" class="btn btn-xs btn-primary py-0 addAgent1 mx-3 my-2" target="_self" href="javascript:void(0);"> <i class="fa fa-plus"></i> Add Agent</a> 
											<div class="form-row mx-0">
