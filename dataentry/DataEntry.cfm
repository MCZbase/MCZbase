									...
									<div id="customSciName">
										<div class="form-row mx-0 mb-2">
											...
											<div class="col-12 col-xl-5 px-0 float-left">
												<label for="inputPassword3" class="small font-weight-light col-12 col-xl-5 px-1 pl-xl-2 mt-2 float-left d-block mb-0">Verbatim Date</label>
											...
											<div class="col-12 col-xl-4 pl-0 float-left">
												<label for="inputPassword3" class="small font-weight-light col-12 col-xl-3 px-1 float-left d-block mt-2 mb-0">Time</label>
											...
											<div class="col-12 col-xl-8 float-left px-0 pr-xl-0">
												<label for="start_end_dayOfyear" class="small font-weight-light col-12 col-xl-2 px-1 float-left d-block mt-2 mb-0">Day of Year</label>
											...
											<div class="col-12 col-md-6 px-0 float-left">
												<label for="collecting_source_method" class="small col-12 col-xl-3 px-1 font-weight-light float-left d-block mt-2 mb-0">Source</label>
