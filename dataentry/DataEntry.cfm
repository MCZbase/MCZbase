					...
					<div class="col-12 col-md-6 pb-1 px-1" id="mydiv6">
						<div class="border-fill px-3 pt-1 pb-2 m-1" id="mydivheader6">
							...
							<div id="customSciName">
								...
								<a aria-label="Add another set of search criteria"  style="max-width: 28px;" class="btn btn-xs btn-primary addSciName col px-0 rounded text-center" target="_self" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
								</div>
							</div>
						</div>
					</div>
