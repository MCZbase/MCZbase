								...
								<div class="form-row mx-0">
									...
									<div id="customAtt">
										<div class="form-row mx-0 my-2">
											...
											<label for="date" class="small font-weight-light float-left d-block col-12 text-right col-xl-2 px-0 mt-2 mb-0">Date</label>
											...
											<div class="col-12 px-0">
											<label for="attribute_remark" class="small font-weight-light float-left col-12 col-xl-2 d-block pr-2 mt-2 mb-0">Attribute Remark</label>
