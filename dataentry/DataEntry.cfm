						...
						<div class="portlet shadow-none rounded-0 m-0 bg-blue-gray">
							...
							<div class="portlet-content px-3">
								<div id="customAgent1">
									<div class="row">
										<div class="col-12 mb-2">
											<a aria-label="Add another set of search criteria" class="btn btn-xs btn-primary py-0 addAgent1 mx-0 mt-0 mt-xl-0 mb-1 float-left d-block" target="_self" href="javascript:void(0);"> <i class="fa fa-plus"></i> Add Agent</a> 
											<div class="form-row">
												<div class="col-12 col-xl-6 float-left">
