					...
					<div class="portlet">
						...
						<div class="portlet-content">
							<div class="form-row mx-0">
								...
								<label for="scientific_name" class="data-entry-label text-center text-md-right px-0">Scientific Name</label>
								<input type="text" name="scientific_name" class="data-entry-input" placeholder="Scientific Name" />
								<label for="made_by" class="data-entry-label text-center text-md-right px-0">ID Made By</label>
								<input type="text" name="made_by" class="data-entry-input" placeholder="Identifier's Name" />
								<label for="nature_of_id" class="data-entry-label text-center text-md-right px-0">Nature of ID</label>
								<select class="data-entry-select" required>
									<option value="">Expert ID</option>
									<option value="1">Field ID</option>
									<option value="2">Non-Expert ID</option>
