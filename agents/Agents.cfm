								...
								<div class="form-row mb-2">
									...
									<div class="col-12 col-md-3">
										<label for="first_name" class="data-entry-label" id="first_name_label">First Name
											<span class="small">
												(accepts <a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('first_name');e.value='='+e.value;">=</a><span class="sr-only">prefix with equals sign for case sensitive exact match search</span>, 
												<a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('first_name');e.value='!'+e.value;">!</a><span class="sr-only">prefix with exclamation point for case sensitive not search</span>,, 
												NULL, NOT NULL)
											</span>
										</label>
									...
									<div class="col-12 col-md-2">
										<label for="middle_name" class="data-entry-label" id="middle_name_label">Middle Name 
											<span class="small">
												(accepts <a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('middle_name');e.value='='+e.value;">=</a><span class="sr-only">prefix with equals sign for case sensitive exact match search</span>, 
												<a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('middle_name');e.value='!'+e.value;">!</a><span class="sr-only">prefix with exclamation point for case sensitive not search</span>,, 
												NULL, NOT NULL)
											</span>
										</label>
									...
									<div class="col-12 col-md-3">
										<label for="last_name" class="data-entry-label" id="last_name_label">Last Name 
											<span class="small">
												(accepts <a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('last_name');e.value='='+e.value;">=</a><span class="sr-only">prefix with equals sign for case sensitive exact match search</span>, 
												<a href="##" tabindex="-1" aria-hidden="true" class="btn-link" onclick="var e=document.getElementById('last_name');e.value='!'+e.value;">!</a><span class="sr-only">prefix with exclamation point for case sensitive not search</span>,, 
												NULL, NOT NULL)
											</span>
										</label>
