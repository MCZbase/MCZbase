...
<!---					<div class="row mx-0">
				...
				<div class="col-12 ml-auto" id="agentBlocks">
					<div class="d-block mb-5 float-left px-0 px-md-1 col-12 col-md-4 col-xl-3 rounded mx-1 border h-auto pt-2 pb-1 <cfif getAgentRelforColor.agent_relationship eq 'employed by' AND getAgentRelforColor.related_name contains 'MCZ'><cfelse></cfif>">
						<!--- agent names --->
