...
<cfoutput>
	<div class="<cfif isdefined("session.roles") AND listfindnocase(session.roles,"coldfusion_user")><cfelse>container</cfif>">
		<div class="row mx-0">
			<cfloop query="getAgent">
				...
				<div class="col-12">
					<div class="d-block mb-5 float-left px-1 col-12 col-md-4 col-xl-auto h-auto">
						<!--- agent names --->
					...
					<div class="d-block mb-5 pr-md-2 float-left h-auto col-12 col-md-4 col-xl-auto">
							<!--- Collector --->
												...
												<cfloop query="getMedia">
													...
													<cfif getMedia.media_type IS "image">
														<li class="col-12 col-md-4 col-xl-2 px-0">
															<a class="d-block" href="/MediaSet.cfm?media_id=#getMedia.media_id#"><img src="#getMedia.media_uri#" alt="#getMedia.descriptor#" width="100"></a>
														</li>
					...
					<div class="d-block mb-5 float-left h-auto col-12 col-md-4 col-xl-auto px-1">
