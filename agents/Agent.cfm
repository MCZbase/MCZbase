		...
		<div class="row mx-0">
			<cfloop query="getAgent">
				...
				<div class="col-12 ml-auto" id="agentBlocks">
					<div class="d-block mb-5 float-left px-0 px-md-1 col-12 col-md-4 col-xl-3 rounded mx-1 rounded h-auto py-2 <cfif getAgentRelforColor.agent_relationship eq 'employed by' AND MCZBASE.get_agentnameoftype(getAgentRelforColor.related_agent_id) contains 'MCZ'>primaryType<cfelse>secondaryType</cfif>">
						<!--- agent names --->
