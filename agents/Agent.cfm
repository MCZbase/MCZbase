		...
		<div class="row mx-0">
			<cfloop query="getAgent">
				...
				<div class="col-12 ml-auto" id="agentBlocks">
					<div class="d-block mb-5 float-left px-0 px-md-1 col-12 col-md-4 col-xl-3 rounded mx-1 rounded h-auto py-2 <cfif getAgentRelforColor.agent_relationship eq 'employed by' AND getAgentRelforColor.related_name contains 'MCZ'>primaryType<cfelse>secondaryType</cfif>">
						<!--- agent names --->
					...
					<div class="d-block mb-5 float-left h-auto px-0 px-md-1 col-12 col-md-4 col-xl-auto">
							...
							<section class="accordion" id="collectorSection1">
								<div class="card mb-2 bg-light">
									...
									<cfif getAgentCollScope..recordcount GT 14>
										<!--- cardState = collapsed --->
										<cfset bodyClass = "collapse">
										<cfset ariaExpanded ="false">
									<cfelse>
							...
							<section class="accordion" id="collectorSection2">
								<div class="card mb-2 bg-light">
									...
									<cfif getAgentFamilyScope2.recordcount GT 15>
										<!--- cardState = collapsed --->
										<cfset bodyClass = "collapse">
										<cfset ariaExpanded ="false">
									<cfelse>
