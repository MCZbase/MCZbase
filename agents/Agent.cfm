	...
	<div class="<cfif isdefined("session.roles") AND listfindnocase(session.roles,"coldfusion_user")><cfelse>container</cfif>">
		<div class="row mx-0">
			<cfloop query="getAgent">
				...
				<div class="col-12">
					<div class="d-block mb-5 float-left px-1 col-12 col-md-4 col-xl-auto h-100">
						<!--- agent names --->
					...
					<div class="d-block mb-5 pr-md-2 float-left h-100 col-12 col-md-4 col-xl-auto">
							<!--- Collector --->
					...
					<div class="d-block mb-5 float-left h-100 col-12 col-md-4 col-xl-auto px-1">
