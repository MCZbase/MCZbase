										...
										<div class="card-header" id="enteredHeader">
											<h2 class="h4 my-0">
												...
												MCZbase Records Entered (
													<cfif #entered.recordcount# gt 0>
														in #entered.recordcount# collection<cfif #entered.recordcount# gt 1>s<cfelse></cfif>
													<cfelse>
														0
													</cfif>
													)
										...
										<div class="card-header" id="lastEditHeader">
											<h2 class="h4 my-0">
												<button type="button" class="headerLnk text-left w-100 h-100" data-toggle="collapse" data-target="##lastEditCardBodyWrap" aria-expanded="#ariaExpanded#" aria-controls="lastEditCardBodyWrap">
													...
													<cfif #lastEdit.cnt# gt 0>
														in #i# collection<cfif #lastEdit.recordcount# gt 1>s<cfelse></cfif>
													<cfelse>
0
													</cfif>)
												</button>
