								...
								<section class="accordion" id="collectorSection1">
									<div class="card mb-2 bg-light">
										...
										<div class="card-header" id="collectorHeader1">
											<h2 class="h4">
												<button class="btn-link mx-2 my-0" type="button" data-toggle="collapse" data-target="##collectorCardBodyWrap1" aria-expanded="#ariaExpanded#" aria-controls="collectorCardBodyWrap1">Collector (in #getAgentCollScope.recordcount# collection#plural#)</button>
											</h2>
										</div>
