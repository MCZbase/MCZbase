...
<a class="btn-xs btn-secondary px-2 float-right d-inline-block" role="button" href="/vocabularies/GeologicalHierarchies.cfm?action=list">Geological Hierarchy List</a>
