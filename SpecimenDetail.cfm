...
<cfoutput query="detail" group="cat_num">
 ...
 <cfset twotypes = '#replace(typestatusplain,"|","<br>")#'>
  ...
  <cfelseif isDefined("cited_as") and len(cited_as) gt 0 and (typestatuswords eq 'Paratype' or typestatuswords eq 'Alloparatype' or typestatuswords eq 'Alloparalectotype')>
  <cfset  twotypes= '#replace(typestatusplain,"|","<br>")#'>
