...
<cfset fieldlist = "INSTITUTION_ACRONYM,COLLECTION_CDE,OTHER_ID_TYPE,OTHER_ID_NUMBER,PART_NAME,
					PART_REMARKS,CONTAINER_BARCODE,PRESERVE_METHOD,SUBSAMPLE,CONDITION,
					COLL_OBJ_DISPOSITION,PART_COLLECTION_OBJECT_ID,ITEM_INSTRUCTIONS,ITEM_REMARKS,LOAN_NUMBER,TRANSACTION_ID">
<cfset fieldTypes = "CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,
					 CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,
					 CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_DECIMAL">
			...
			<div class="accordion" id="accordionIdentifiers">
				<div class="card mb-2 bg-light">
					...
					<div id="identifiersPane" class="collapse" aria-labelledby="headingIdentifiers" data-parent="##accordionIdentifiers">
						...
						<p class="px-3 pt-2"> Columns in <span class="text-primary">blue</span> come from download; transaction_id is autogenerated and others need to be entered into CSV. <strong>All of these columns can be retrieved from the Part Download/Report function of Manage Specimen Search Results.</strong></p>
				...
				<cfelse>
					<cfquery name="collObj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
						update
							cf_temp_loan_item
						set
							status=concat(nvl2(status, status || '; ', ''),'No matching part found; item description not autogenerated')
