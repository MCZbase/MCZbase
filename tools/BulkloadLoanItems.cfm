	...
	<cfif #action# is "validate">
		...
		<cfoutput>
			...
			<cfquery name="getTempData" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
				SELECT INSTITUTION_ACRONYM,COLLECTION_CDE,OTHER_ID_TYPE,OTHER_ID_NUMBER,PART_NAME,ITEM_INSTRUCTIONS,ITEM_REMARKS,BARCODE,SUBSAMPLE,LOAN_NUMBER,TRANSACTION_ID,PARTID,ITEM_DESCRIPTION,BARCODE,STATUS
				FROM 
					CF_TEMP_LOAN_ITEM
				WHERE 
