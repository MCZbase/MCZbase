			...
			<div class="accordion" id="accordionIdentifiers">
				<div class="card mb-2 bg-light">
					...
					<div id="identifiersPane" class="collapse" aria-labelledby="headingIdentifiers" data-parent="##accordionIdentifiers">
						...
						<p class="px-3 pt-2"> <strong>Columns in <span class="text-primary">blue</span> are retrieved from the Part Download/Report function of Manage Specimen Search Results.</strong> Additional columns are included to help identify the parts. Other column values need to be entered into CSV before uploading [TRANSACTION_ID value is autogenerated from the loan_number entry]. </p>
