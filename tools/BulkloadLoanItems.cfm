			...
			<div class="accordion" id="accordionIdentifiers">
				<div class="card mb-2 bg-light">
					...
					<div id="identifiersPane" class="collapse" aria-labelledby="headingIdentifiers" data-parent="##accordionIdentifiers">
						...
						<p class="px-3 pt-2"> Columns in <span class="text-primary">blue</span> <strong>are retrieved from the Part Download/Report function of Manage Specimen Search Results.</strong> TRANSACTION_ID is autogenerated and others need to be entered into CSV. </p>
