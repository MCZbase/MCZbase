		...
		<cfoutput>
			...
			<cfloop query="getTempData">
				...
				<cfquery name="l" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
					select count(*) c, locality_id,geog_auth_rec.HIGHER_GEOG,SPEC_LOCALITY
					...
					and geog_auth_rec.SPEC_LOCALITY='#trim(PreserveSingleQuotes(getTempData.SPECLOCALITY))#'
					and geog_auth_rec.locality_id = #getTempData.locality_id#
				</cfquery>
				<cfif l.c neq 0>
