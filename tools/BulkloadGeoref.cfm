	...
	<cfif variables.action is "validate">
		...
		<cfoutput>
			...
			<cfloop query="getTempData">
				...
				<cfif REFind("^[0-9.-]+$",getTempData.dec_lat) GT 0 AND REFind("^[0-9.-]+$",getTempData.dec_long) GT 0 AND ( REFind("^[0-9.]*$",getTempData.max_error_distance) GT 0 OR getTempData.max_error_distance EQ '') AND REFind("^[0-9]*$",getTempDatalocality_id) GT 0>
					<cfquery name="warningLocalityID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
						UPDATE cf_temp_georef
