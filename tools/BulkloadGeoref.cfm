		...
		<cfoutput>
			...
			<cftransaction>
				<cftry>
					...
					<cfquery name="getLatLongFg" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="updategeoref1_result">
					...
					<cfloop query="getTempData">
						#getLatLongFg.accepted_lat_long_fg#
