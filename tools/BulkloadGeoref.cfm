...
<cfset fieldTypes ="CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DECIMAL,dec_lat{CF_SQL_DECIMAL,scale=4},dec_long{CF_SQL_DECIMAL,scale=4},CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DATE,CF_SQL_VARCHAR,CF_SQL_DECIMAL,CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_DECIMAL">
		...
		<cfoutput>
			...
			<cftransaction>
					...
					<cfloop query="getTempData">
						...
						<cfquery name="updateGeoref" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="updateGeoref_result">
							...
							<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#DETERMINED_BY_AGENT_ID#">,
							 TO_DATE(<cfqueryparam value="#dynamicDate#" cfsqltype="cf_sql_varchar">, '#dateFormat#'),
				...
				<cfcatch>
					...
					<p class="mt-3">There was a problem updating georeferences. </p>
