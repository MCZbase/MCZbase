		...
		<cfoutput>
			...
			<ul class="list-group list-group-horizontal mb-3">
				<li class="list-group-item font-weight-lessbold">
					<a href="/vocabularies/ControlledVocabulary.cfm?table=CTAGENT_TYPE">VALID AGENT TYPES</a>
				</li> <span class="mt-1"> | </span>
				<li class="list-group-item font-weight-lessbold">
					<a href="/vocabularies/ControlledVocabulary.cfm?table=CTAGENT_NAME_TYPE">VALID AGENT NAME TYPES</a> 
				</li> <span class="mt-1"> | </span>
				<li class="list-group-item font-weight-lessbold">
