...
<!---			<cfquery name="otherNameType" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		...
		<!---	<cfloop query="getTempTableQC">
				...
				<cfquery name="AgentNameID1" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
					select sq_agent_name_id.nextval nextAgentNameId1 from dual
				</cfquery>
				...
				<cfquery name="AgentNameID2" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
				...
				<cfquery name="AgentNameID3" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
					select sq_agent_name_id.nextval nextAgentNameId3 from dual
				</cfquery>
		...
		<!---	<cftransaction>
			...
			<cftransaction>
				...
				<cfquery name="saveAID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="pkResult">
					...
					<cfquery name="saveANID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="pkResult">
					select agent_name_id from agent
					where ROWIDTOCHAR(rowid) = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#insResult.GENERATEDKEY#">
				</cfquery>
				<cfquery name="newAgentName" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#" result="insertResult">
					...
					values (#saveANID.agent_name_id#,#saveAID.agent_id#,'preferred','#preferred_name#')
				</cfquery>
