			...
			<cfif #action# is "validate">
				...
				<cfloop query="getTempTableQC">
					...
					<cfloop index="i" from="1" to="6">
						...
						<cfquery name="chkPAtt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
						update cf_temp_parts set
						PART_ATT_DETBY_#i# = NVL2(PART_ATT_DETBY_#i#, mczbase.get_agentnameoftype(PART_ATT_DETBY_#i#), 'preferred_agent_name') 
						...
						AND NVL2(PART_ATT_DETBY_#i#, mczbase.get_agentnameoftype(PART_ATT_DETBY_#i#), 'preferred_agent_name') is null
						AND username = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#session.username#">
						AND key = <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#getTempTableQC.key#">
						</cfquery>
						<cfquery name="chk" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
