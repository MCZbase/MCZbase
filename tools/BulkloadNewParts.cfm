			...
			<cfif #action# is "validate">
				...
				<cfloop query="getTempTableQC">
					...
					<cfloop index="i" from="1" to="6">
						...
						(select attribute_type from ctspecpart_attribute_type where code_tables is not null)
						AND username = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#session.username#">
						AND key = <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#getTempTableQC.key#">
						</cfquery>
						...
						<cfquery name="flatWrongUnits" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
							...
							WHERE 
								'||PART_ATT_UNITS_#i#||' not in (
									<cfif sp_units2.units_code_table EQ "CTLENGTH_UNITS">
									...
									<cfelseif sp_units2.units_code_table EQ "CTTHICKNESS_UNITS">
										select THICKNESS_UNITS from CTTHICKNESS_UNITS
									<cfelseif sp_units2.units_code_table EQ "CTANGLE_UNITS">
