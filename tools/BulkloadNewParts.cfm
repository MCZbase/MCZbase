		...
		<div class="col-12 pb-3">
			...
			<cfif #action# is "validate">
				...
				<!---					AND '||PART_ATT_NAME_#i#||''|''||PART_ATT_VAL_#i#||' not in 
						...
						select cf_temp_parts.part_att_name_#i# as 'partno',cf_temp_parts.part_att_val_#i# as 'partvalno',cf_temp_parts.collection_cde,ctspecpart_attribute_type.attribute_type, decode(value_code_tables, null, unit_code_tables,value_code_tables) as 'code_table' from ctspecpart_attribute_type, cf_temp_parts where attribute_type = '||PART_ATT_NAME_#i#||'
