...
<cfif isDefined("action") AND action is "dumpProblems">
	<cfquery name="getProblemData" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		SELECT MEDIA_URI,MIME_TYPE,MEDIA_TYPE,PREVIEW_URI,MEDIA_RELATIONSHIP,LABEL_SUBJECT,LABEL_MADE_DATE,LABEL_HEIGHT,LABEL_WIDTH,LABEL_DESCRIPTION,MEDIA_LICENSE_ID,MASK_MEDIA
		FROM cf_temp_media 
...
<cfset fieldlist = "MEDIA_URI,MIME_TYPE,MEDIA_TYPE,PREVIEW_URI,MEDIA_RELATIONSHIP,LABEL_SUBJECT,LABEL_MADE_DATE,LABEL_HEIGHT,LABEL_WIDTH,LABEL_DESCRIPTION,MEDIA_LICENSE_ID,MASK_MEDIA">
<cfset fieldTypes ="CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DATE,CF_SQL_DECIMAL,CF_SQL_DECIMAL,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_VARCHAR,CF_SQL_DECIMAL,CF_SQL_DECIMAL">
<cfset requiredfieldlist = "MEDIA_URI,MIME_TYPE,MEDIA_TYPE,MEDIA_RELATIONSHIP,LABEL_SUBJECT,LABEL_MADE_DATE,LABEL_HEIGHT,LABEL_WIDTH,LABEL_DESCRIPTION">
		...
		<cfoutput>
			...
			<cftransaction>
				...
				<cfcatch>
					...
					<cfquery name="getProblemData" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
						SELECT 
							STATUS, MEDIA_URI, MIME_TYPE, MEDIA_TYPE, PREVIEW_URI,MEDIA_RELATIONSHIP,LABEL_SUBJECT,LABEL_MADE_DATE,LABEL_HEIGHT, LABEL_WIDTH,LABEL_DESCRIPTION,MEDIA_LICENSE_ID,MASK_MEDIA,LABEL_TYPE_1,LABEL_VALUE_1,LABEL_TYPE_2,LABEL_VALUE_2,LABEL_TYPE_3,LABEL_VALUE_3,LABEL_TYPE_4,LABEL_VALUE_4,LABEL_TYPE_5,LABEL_VALUE_5,LABEL_TYPE_6,LABEL_VALUE_6,LABEL_TYPE_7,LABEL_VALUE_7,LABEL_TYPE_8,LABEL_VALUE_8,USERNAME
						FROM 
							cf_temp_media
						WHERE
