						...
						<cfelse>
							...
							<cfelseif table_name is "project">
								...
								<cfquery name="cProject" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
									select project_id from project where (PROJECT_NAME =<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#labelValue#"> OR PROJECT_ID = <cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#labelValue#">)
								</cfquery>
