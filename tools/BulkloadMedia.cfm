...
<cfif isDefined("action") AND action is "dumpProblems">
	<cfquery name="getProblemData" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cookie.cfid)#">
		SELECT MEDIA_URI,MIME_TYPE,MEDIA_TYPE,PREVIEW_URI,RELATIONSHIP_CREATED_BY,LABEL_SUBJECT,LABEL_MADE_DATE,LABEL_HEIGHT,LABEL_WIDTH,LABEL_DESCRIPTION,RELATIONSHIP_TYPE_1,RELATIONSHIP_VALUE_1,MEDIA_LICENSE_ID,MASK_MEDIA
		FROM cf_temp_media 
