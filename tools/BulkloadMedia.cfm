...
<!------------------------------------------------------->
	...
	<cfif #action# is "nothing">
		<cfoutput>
			...
			<p>Folloow all the instructions above. Reminder: To mark media as hidden from Public Users put a 1 in the MASK_MEDIA column. Enter zero or Leave blank for Public media</p>
