...
<!------------------------------------------------------->
	...
	<cfif #action# is "validate">
		...
		<cfoutput>
			...
			<cfif numberFormat(getTempMedia.related_primary_key_1)  && #getTempMedia.media_relationship_1# eq 'shows agent'>
			...
			<cfif numberFormat(getTempMedia.related_primary_key_2) && #getTempMedia.media_relationship_2# eq 'shows agent'>
