					...
					<form name="filterResults">
						...
						<div class="form-row mx-0">
							<div class="col-12">
								...
								<input type="button" value="Bulkloading Edited Parts w/Attributes" onClick='document.getElementById("action").value="downloadBulkloaderAll";document.forms["filterResults"].submit();' title="Edited Part fields plus: PART_ATT_NAME_1, PART_ATT_VAL_1, PART_ATT_UNITS_1, PART_ATT_DETBY_1, PART_ATT_MADEDATE_1, PART_ATT_REM_1" class="btn btn-xs mb-2 btn-secondary"></input>
