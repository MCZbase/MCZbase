					...
					<form name="filterResults">
						...
						<div class="form-row mx-0">
							<div class="col-12">
								...
								<input type="button" value="Download Parts CSV with Loan Fields" onClick='document.getElementById("action").value="downloadForLoanItems";document.forms["filterResults"].submit();' class="btn btn-xs mb-2 btn-secondary"></input>
							</div>
						</div>			
					</form>
				</div>
