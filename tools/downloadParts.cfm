					...
					<form name="filterResults">
						...
						<div class="form-row mx-0">
							<div class="col-12">
								...
								<input type="button" value="Bulkloading Edited Parts w/Attributes" onClick='document.getElementById("action").value="downloadBulkloaderAll";document.forms["filterResults"].submit();' title="Edited Part fields plus: PART_ATT_NAME_1, PART_ATT_VAL_1, PART_ATT_UNITS_1, PART_ATT_DETBY_1, PART_ATT_MADEDATE_1, PART_ATT_REM_1 X 6" class="btn btn-xs mb-2 btn-secondary"></input>
								<input type="button" value="Container Placements" onClick='document.getElementById("action").value="downloadBulkPartContainer";document.forms["filterResults"].submit();' title="Parts fields plus container hierarchy: CONTAINER_BARCODE, P1_BARCODE, P2_BARCODE, P3_BARCODE, P4_BARCODE, P5_BARCODE, P6_BARCODE" class="btn btn-xs mb-2 btn-secondary"></input>
								<input type="button" value="Bulkloading Parts to New Containers" onClick='document.getElementById("action").value="downloadBulkPartContainerMove";document.forms["filterResults"].submit();' title="Parts fields and Container Hierarchy plus: blank NEW_CONTAINER_BARCODE column" class="btn btn-xs mb-2 btn-secondary"></input>
								<input type="button" value="Bulkloading Loan Items" onClick='document.getElementById("action").value="downloadPartLoanItems";document.forms["filterResults"].submit();' title="Parts fields and Container Hierarchy plus: ITEM_INSTRUCTIONS, ITEM_REMARKS, LOAN_NUMBER, TRANSACTION_ID, SUBSAMPLE" class="btn btn-xs mb-2 btn-secondary"></input>
							</div>
						</div>			
					</form>
				</div>
