...
<!------------------------------------------------------->
	...
	<cfif #action# is "getFile">
		...
		<cfset NO_COLUMN_ERR = 'One or more required fields are missing in the header line of the csv file. Check the charset you selected if uploaded csv columns match required headers and one (or more) "Required column not found" is listed.'>
		...
		<cftry>
				...
				<cfif len(errorMessage) GT 0>
					<cfif size GT 1>
						...
						<cfset errorMessage = "<br>You may have specified the wrong format. One or more column headers were not found. #errorMessage#.">
