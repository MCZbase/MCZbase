...
<main class="container py-3" id="content">
	...
	<cfif #action# is "nothing">
		<cfoutput>
			...
			<p>Pay attention to capitalization where it is required. Messages will help to navigate problems with the data in the .csv file. Reference the help page <a href="/vocabularies/ControlledVocabulary.cfm?table=CTCOLL_OTHER_ID_TYPE">CTCOLL_OTHER_ID_TYPE</a> for entries ("catalog number" can also be used&mdash;not found on OTHER ID TYPE list</p>
			...
			<p class="mt-3">The following columns (column headers) are required: </p>
			<ul class="geol_hier">
				<cfloop list="#fieldlist#" index="field" delimiters=",">
