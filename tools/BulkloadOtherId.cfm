...
<!------------------------------------------------------->
	...
	<cfif #action# is "getFile">
		...
		<cfset NO_COLUMN_ERR = 'One or more required fields are missing in the header line of the csv file. <span class="text-danger">[If you uploaded csv columns that match the required headers and see at least one "Required column not found," check the charset you selected.]</span>'>
