		...
		<div class="row mx-0">
			<div class="col-12 mt-3">
				<form method="post" action="">
					...
					<h1 class="h2">SQL</h1>
					<p class="">Modify this query to your needs. Retain the user_search_table.result_id in the query to modify your original search result. You can eliminate it to extend the query to the entire database.</p>
