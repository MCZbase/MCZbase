				...
				<cftransaction>
					<cfloop query="getTempData">
						<cfquery name="updateCitations" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#" result="updateCitations_result">
							insert into citation (PUBLICATION_ID,COLLECTION_OBJECT_ID,cited_taxon_name_id,cit_current_fg,occurs_page_number,type_status,citation_remarks,citation_page_uri)values(11281,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#cf_temp_citation.COLLECTION_OBJECT_ID#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#cf_temp_citation.CITED_TAXON_NAME_ID#">,1,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#cf_temp_citation.OCCURS_PAGE_NUMBER#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#cf_temp_citation.TYPE_STATUS#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#cf_temp_citation.CITATION_REMARKS#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#cf_temp_citation.CITATION_PAGE_URI#">)
						</cfquery>
			...
			<cftransaction>
				<cftry>
					...
					<cfloop query="getTempData">
						...
						<cfquery name="updateCitations" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#" result="updateCitations_result">
							insert into citation (publication_id,collection_object_id,cited_taxon_name_id,cit_current_fg,occurs_page_number,
							citation_page_uri,type_status,citation_remarks)values(<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#CF_TEMP_CITATION.PUBLICATION_ID#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#collection_object_id#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#cited_taxon_name_id#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#occurs_page_number#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#citation_page_URI#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#type_status#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#citation_remarks#">)
						</cfquery>
						<cfset citation_updates = citation_updates + updateCitations_result.recordcount>
					</cfloop>
