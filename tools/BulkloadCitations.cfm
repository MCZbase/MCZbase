		...
		<cfoutput>
			...
			<div id="template" class="my-1 mx-0">
				<label for="templatearea" class="data-entry-label" style="line-height: inherit;">
					Copy this header line, paste it into a blank worksheet, and save it as a .csv file or <a href="/tools/BulkloadCitations.cfm?action=getCSVHeader" class="font-weight-bold">download</a> a template.
				</label>
			...
			<div class="accordion" id="accordionCitations">
				<div class="card mb-2 bg-light">
					<div class="card-header" id="headingCitations">
						<h3 class="h5 my-0">
							<button type="button" role="button" aria-label="Citations pane" class="headerLnk text-left w-100" data-toggle="collapse" data-target="##citationsPane" aria-expanded="false" aria-controls="citationsPane">
								Data Entry Instructions per Column
							</button>
						</h3>
					</div>
					<div id="citationsPane" class="collapse" aria-labelledby="headingCitations" data-parent="##accordionCitations">
			...
			<cftransaction>
				...
				<cftry>
					...
					<cfif getCitData.recordcount eq citation_updates>
						...
						<p>
							<a href="/Specimens.cfm?execute=true&builderMaxRows=1&action=builderSearch&openParens1=0&field1=COLL_OBJECT%3ACOLL_OBJ_COLLECTION_OBJECT_ID&searchText1=#encodeForUrl(valuelist(getCitData.collection_object_id))#&closeParens1=0" class="btn-link font-weight-lessbold">
