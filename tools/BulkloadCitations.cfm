...
<!------------------------------------------------------->
	...
	<cfif #action# is "validate">
		...
		<cfoutput>
			...
			<cfquery name="getCID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
				update cf_temp_citation set cit_current_fg = 1
				WHERE username = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#session.username#">
			</cfquery>
				...
				<cftransaction>
					<cfloop query="getTempData">
						<cfquery name="updateCitations" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#" result="updateCitations_result">
							insert into citation (publication_id,collection_object_id,cited_taxon_name_id,cit_current_fg,occurs_page_number,type_status,citation_remarks,citation_page_uri)values(<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#publication_ID#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#collection_object_ID#">,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#TAXON_NAME_ID#">,1,<cfqueryparam cfsqltype="CF_SQL_DECIMAL" value="#OCCURS_PAGE_NUMBER#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#TYPE_STATUS#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#CITATION_REMARKS#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#CITATION_PAGE_URI#">)
						</cfquery>
