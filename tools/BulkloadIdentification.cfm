				...
				<cftry>
					...
					<cfloop query="getTempData">
						...
						<cfquery name="sumID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#" result="sumID_result">
							select IDENTIFICATION_ID,TAXON_NAME_ID, COLLECTION_OBJECT_ID, MADE_DATE, NATURE_OF_ID, ACCEPTED_ID_FG,IDENTIFICATION_REMARKS, TAXA_FORMULA, SCIENTIFIC_NAME, AGENT_1_ID,stored_as_fg 
							from identification 
