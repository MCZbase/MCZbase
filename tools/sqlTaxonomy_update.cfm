...
<!--- no security --->
<!--- TODO: Refactor this to a database property associated with the user, rather than hardcoding authorized users --->
<cfif session.username is not "gordon" and session.username is not "dlm" and session.username is not "ccicero"
		and session.username is not "AlanBatten" and #session.username# is not "heliumcell">
