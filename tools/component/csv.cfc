...
<cffunction name="checkAdditionalFields" returntype="string" access="remote" returnformat="plain">
	...
	<cfoutput>
		...
		<cfif containsAdditional >
			...
			<cfif additionalCount GT 1 and #fieldList# contains 'LOAN_NUMBER'><cfset extra=" above. Use them to find the loan objects"></cfif>
			<cfif additionalCount GT 1><cfset plural1a="are"><cfelse><cfset plural1a="is"></cfif>
			<h3 class="h4">Warning: Found #additionalCount# additional column header#plural1# in the CSV that #plural1a# not in the list of expected headers #extra#: </h3>
