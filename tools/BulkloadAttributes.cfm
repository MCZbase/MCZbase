		...
		<!---	<cfset fieldlist2 = "institution_acronym,collection_cde,other_id_type,other_id_number,attribute,attribute_value,attribute_units,attribute_date,attribute_meth,determiner,remarks">--->
			...
			<cfloop condition="true">
				<cfloop from="0" to="#size#" index="i">
					...
					<cfif thisheader EQ 'institution_acronym'><cfset institution_acronym_exists=true>#i# #thisheader# <cfelse><cfset myVar=false> #thisheader#</cfif>
					<cfif thisheader EQ 'collection_cde'><cfset myVar=true>#i# #thisheader#<cfelse><cfset myVar=false> #thisheader#</cfif>
					<cfif thisheader EQ 'other_id_type'><cfset myVar=true>#i# #thisheader#<cfelse><cfset myVar=false>#thisheader# </cfif>
					<cfif thisheader EQ 'other_id_number'><cfset myVar=true>#i# #thisheader# <cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'attribute'><cfset myVar=true>#i# #thisheader# <cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'attribute_value'><cfset myVar=true>#i# #thisheader# <cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'attribute_units'><cfset myVar=true>#i# #thisheader# <cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'attribute_date'><cfset myVar=true>#i# #thisheader# <cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'attribute_meth'><cfset myVar=true>#i# #thisheader#<cfelse><cfset myVar=false>#thisheader#</cfif>
					<cfif thisheader EQ 'determiner'><cfset myVar=true>#i# #thisheader#<cfelse><cfset myVar=false>#thisheader# </cfif>
					<cfif thisheader EQ 'remarks_date'><cfset renarks_exists=true>#i# <cfelse><cfset myVar=false>#thisheader# </cfif>
					<cfset i= i+1>
						#thisheader# #myVar# , 
				</cfloop>
			</cfloop>
