...
<!---				<cfset List1 = "institution_acronym,collection_cde,other_id_type,other_id_number,attribute,attribute_value,attribute_units,attribute_date,attribute_meth,determiner,remarks">
				...
				<cfif isDefined(#headers.get(0)#)>ww</cfif>,<cfif isDefined(#headers.get(1)#)>this one</cfif>,<cfif isDefined(#headers.get(2)#)>this one</cfif>,<cfif isDefined(#headers.get(3)#>none</cfif>,<cfif isDefined(#headers.get(4)#>that</cfif>,<cfif isDefined(#headers.get(4)#>fda</cfif>,<cfif isDefined(#headers.get(6)#)>this one</cfif>,<cfif isDefined(#headers.get(7)#)>feae</cfif>,<cfif isDefined(#headers.get(8)#)>This</cfif>,<cfif isDefined(#headers.get(9)#)>This one</cfif>, <cfif isDefined(#headers.get(9)#)>#headers.get(10)#</cfif>
