...
<!---				<cfset List1 = "institution_acronym,collection_cde,other_id_type,other_id_number,attribute,attribute_value,attribute_units,attribute_date,attribute_meth,determiner,remarks">
			...
			#headers.get(0)#, #headers.get(1)#, #headers.get(2)#, #headers.get(3)#, #headers.get(4)#, #headers.get(5)#, <cfif isDefined(#headers.get(6)#)>this one</cfif>, #headers.get(7)#, #headers.get(8)#, <cfif isDefined(#headers.get(6)#)>#headers.get(9)#</cfif>, #headers.get(10)#
