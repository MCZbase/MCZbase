...
<main class="container-fluid px-5 py-3" id="content">
	...
	<cfif #action# is "getFile">
		...
		<cftry>
				...
				<cfset typeArray = listToArray(ucase(fieldTypes))>
				<cfset commentArray = listToArray(ucase(commentList))><!--- the types for the full list of fields --->
				...
				<ul class="h4 mb-4 font-weight-normal">
					...
					<cfloop list="#fieldlist#" index="field" delimiters=",">
						...
						<cfif commentList = valueList(#getDataDetails.COMMENTS#)>
