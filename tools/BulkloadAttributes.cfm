		...
		<!---	<cfset fieldlist2 = "institution_acronym,collection_cde,other_id_type,other_id_number,attribute,attribute_value,attribute_units,attribute_date,attribute_meth,determiner,remarks">--->
			...
			<cfloop condition="true">
				<cfloop from="0" to="#size#" index="i">
					...
					<cfif isDefined(thisheader) and thisheader EQ 'institution_acronym'><cfset myVar=true>#i# <cfelse><cfset myVar=false> </cfif>
					<cfif thisheader EQ 'collection_cde'><cfset myVar=true>#i#<cfelse><cfset myVar=false> </cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'other_id_type'><cfset myVar=true>#i#<cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'other_id_number'><cfset myVar=true>#i#  <cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'attribute'><cfset myVar=true>#i#  <cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'attribute_value'><cfset myVar=true>#i#  <cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'attribute_units'><cfset myVar=true>#i#  <cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'attribute_date'><cfset myVar=true>#i#  <cfelse><cfset myVar=false></cfif>
					<cfif isDefined(thisheader) and thisheader EQ 'attribute_meth'><cfset myVar=true>#i# <cfelse><cfset myVar=false></cfif>
