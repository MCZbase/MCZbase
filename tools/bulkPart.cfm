...
<cftry>
	...
	<cfcase value="entryPoint">
		<cfoutput>
			...
			<cfif isDefined("result_id") and len(result_id) GT 0>
				<div>On #getCount.ct# cataloged items from specimen search result [#result_id#]</div>
			<cfelse>
				<div>On list of #getCount.ct# cataloged items.</div>
			</cfif>
													...
													<script>
														$(document).ready(function() {
															...
															<cfif i GT 1>
																...
																$("##part_name_#i#").on("autocompleteselect",function() { 
																	if ($("##part_name_#i#").val()!="") { 
																		$(".forpart#i#").show();
																	} else { 
																		$(".forpart#i#").hide();
