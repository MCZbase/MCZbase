		...
		<cfoutput>
			...
			<cfif other_id_type eq 'catalog number' OR related_other_id_type eq 'catalog number'>
				...
				(
					...
					where (ci.collection_cde = cf_temp_bl_relations.collection_cde || ci.collecton_cde = cf_temp_bl_relations.related_collection_cde)
			...
			<cfelse>
				...
				(
					...
					where (co.other_id_type = cf_temp_bl_relations.other_id_type || co.other_id_type = cf_temp_bl_relations.related_other_id_type)
					and (co.other_id_number = cf_temp_bl_relations.other_id_val || co.other_id_number = cf_temp_bl_relations.related_other_id_val)
				) 
				where username = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#session.username#">
				</cfquery>
			</cfif>
			<cfquery name="miac" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
				...
				SET status = 'record number not found'
