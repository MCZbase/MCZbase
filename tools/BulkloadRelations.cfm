				...
				<cfset relations_updates = 0>
					<cftransaction>
						<cfloop query="getTempData">
							...
							insert into 
								BIOL_INDIV_RELATIONS (collection_object_id,related_coll_object_id,biol_indiv_relationship,biol_indiv_relation_remarks) values (<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#collection_object_id#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#related_coll_object_id#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#biol_indiv_relationship#">,<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#biol_indiv_relation_remarks#">)
							</cfquery>
