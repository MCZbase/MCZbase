 ...
 *
 * When redirectUrl is provided (create mode) the page navigates to the new
 * encumbrance view on success.  When redirectUrl is omitted (edit mode) the
 ...
 *                                 omit or pass falsy to stay on page (edit mode).
 */
