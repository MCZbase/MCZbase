...
<!------------------------------------------------------------------------------------->
<cffunction name="getMediaPreview1" access="public" output="true">
	<cfargument name="puria" required="true" type="string">
	<cfargument name="mta" required="true" type="string">
	<cfset r=0>
	<cfif len(puri) gt 0>
