	...
	<div class="collapse navbar-collapse" id="navbarToggler1">
		...
		<cfif isdefined("session.username") and len(#session.username#) gt 0>
			...
			<form class="form-inline my-2 my-lg-0 pl-2" name="signOut" method="post" action="/login.cfm">
				...
				<button class="btn btn-outline-success my-1 my-sm-1 logout" aria-label="logout" title="" onclick="signOut.action.value='signOut';submit();" target="_top">Log out #session.username# 
