					...
					<li><a href="##" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<ul class="dropdown" aria-label="submenu">
							<cfif session.roles contains "coldfusion_user">
								...
								<form name="profile" method="post" action="/UserProfile.cfm">
									<input type="hidden" name="action" value="nothing">
									<input type="submit" aria-label="Search" value="User Profile" class="anchor-button form-control mr-sm-0 my-2 my-lg-0 px-5 px-lg-0 pt-1 bg-light text-left" style="height: 34px;font-size: .92em; margin-top:2px;" placeholder="User Profile" onClick="logIn.action.value='nothing';submit();">
								</form>
								</li>
							</cfif>
							<cfif session.roles contains "public">
