					...
					<li class="nav-item dropdown"> 
						...
						<ul aria-labelledby="dropdownMenug" class="dropdown-menu border-0 shadow">
							<li>
								...
								<form name="profile" method="post" action="/UserProfile.cfm">
									<input type="hidden" name="action" value="nothing">
									<input type="submit" aria-label="Search" value="User Profile" class="form-control-sm form-control-plaintext p-0 text-left"  placeholder="User Profile" onClick="logIn.action.value='nothing';submit();">
								</form>
								</cfif> 
								</a>
							</li>
