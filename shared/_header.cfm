...
<cfif CGI.script_name IS "/agents/Agent.cfm"
   OR CGI.script_name IS "/grouping/showNamedCollection.cfm"
   OR (isDefined("variables.loadMapLibraries") AND variables.loadMapLibraries) >
	<!---
	...
	--->
  <!--- Load Maps JS with all needed libs exactly once --->
  <script src="https://maps.googleapis.com/maps/api/js?key=#application.gmap_api_key#&libraries=visualization,geometry"></script>
