			...
			<div class="container-fluid">
				...
				<div id="navbarContent" class="collapse navbar-collapse">
					...
					<li class="nav-item dropdown"> 
						<a id="dropdownMenu1" href="##" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle py-1 active">Search</a>
						...
						<ul aria-labelledby="dropdownMenuk" class="dropdown-menu border-0 shadow">
							...
							<li class="dropdown-submenu"> 
								...
								<ul aria-labelledby="dropdownMenul" class="dropdown-menu border-0 shadow">
									<li class="mx-3 mx-lg-0"><a href="##" class="dropdown-item">Specimen</a></li>
									<li class="mx-3 mx-lg-0"><a href="##" class="dropdown-item">Taxon</a></li>
									<li class="mx-3 mx-lg-0"><a href="##" class="dropdown-item">Media</a></li>
									<li class="mx-3 mx-lg-0"><a href="##" class="dropdown-item">Publication</a></li>
					...
					<li class="nav-item dropdown"> 
						...
						<ul aria-labelledby="dropdownMenug" class="dropdown-menu border-0 shadow">
							<li>
								...
								<form name="profile" method="post" action="/UserProfile.cfm">
									<input type="hidden" name="action" value="nothing">
									<input type="submit" aria-label="Search" value="User Profile" class="anchor-button form-control-sm" style="font-size:.92em;"  placeholder="User Profile" onClick="logIn.action.value='nothing';submit();">
								</form>
								</cfif> 
								</a>
							</li>
