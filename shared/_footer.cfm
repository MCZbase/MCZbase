...
<footer class="footer">
    ...
    <cfif cgi.HTTP_HOST contains "harvard.edu" >
        ...
        <div class="row copyright_background">
            <div class="col-12 col-md-6 mx-auto"> <img alt="Harvard Museum of Comparative Zoology Logo" class="media-element file-default file-os-files-medium" src="/shared/images/harvard_museum.png">
