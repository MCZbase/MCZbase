...
<footer class="footer">
    ...
    <cfif cgi.HTTP_HOST contains "harvard.edu" >
        ...
        <div class="row copyright_background">
            <div class="footer-col-4-md" align="center"> <img alt="Harvard Museum of Comparative Zoology Logo" class="media-element file-default file-os-files-medium" src="/shared/images/harvard_museum.png">
