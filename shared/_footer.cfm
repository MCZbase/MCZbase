		...
		<cfif cgi.HTTP_HOST contains "harvard.edu" >
			...
			<div class="row copyright_background">
				<div class="col-12 col-md-6 col-xl-3 mx-auto">
					...
					<div class="agreements text-center small90 mt-1">
						<a href="https://mcz.harvard.edu/acknowledgment-harmful-content" class="policy_link" aria-label="acknowledgment of harmful content">Acknowledgment of Harmful Content</a> <a>|</a> <a href="/Affiliates.cfm" class="policy_link" aria-label="affiliates_link">Affiliates</a> <a>|</a> <a href="https://mcz.harvard.edu/privacy-policy" class="policy_link" aria-label="privacy_policy_link">Privacy</a> <a>|</a> <a href="https://mcz.harvard.edu/user-agreement" class="policy_link" aria-label="user_agreement_link">User Agreement</a> 
					</div>
				</div>
			</div>
			<div class="branding-container">
				<div class="copyright-bottom text-center">
					<small>
						...
						<a href="http://accessibility.harvard.edu/" class="text-white" aria-label="accessibility_link">Accessibility</a> | <a href="http://www.harvard.edu/reporting-copyright-infringements" class="text-white" aria-label="report_copyright_infringement_link">Report Copyright Infringement</a>
					</small> 
				</div>
			</div>
		</cfif>
