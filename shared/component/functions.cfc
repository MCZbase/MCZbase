...
--->
<cffunction name="pickCollectingEventHtml" access="remote">
	...
	<cftry> 
		...
		<cfset result = result & "
		<div class='container-fluid'><div class='row'><div class='col-12'><div id='mediaSearchForm' class='search-box px-3 py-2'><h1 class='h3 mt-2'>Search for Collecting Events</h1>
		...
		<!--- TODO: Use jqxgrid with a picker cellrenderer --->
			...
			$(document).ready(function() {
				...
				$('##findCollectingEventForm').bind('submit', function(evt){
					...
					$("##searchResultsGrid").on("bindingcomplete", function(event) {
						...
						$('##resultLink').html('<a href="/localities/CollectingEvents.cfm?action=search&execute=true&' + $('##findCollectingEventForm :input').filter(function(index,element){return $(element).val()!='';}).serialize() + '">Link to this search</a>');
