									...
									<tr>
										...
										<td>
											...
											<cfif NOT findNoCase("DO NOT DELETE", getEnc.remarks)>
												...
												<cfif getEnc.object_count EQ 0 OR len(trim(getEnc.expiration_event)) GT 0 OR (len(getEnc.expiration_date) GT 0 AND parseDateTime(getEnc.expiration_date) LT date())>
