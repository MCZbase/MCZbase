							...
							<div class="col-12 px-4 py-1">
								<ul class="pt-3">
									<cfif isdefined("session.roles") AND listcontainsnocase(session.roles,"coldfusion_user")>
										...
										<li class="mb-1">Use this form to make suggestions in relation to database function or data display (Select: <i>A bug or issue with MCZbase</i> and priority <i>Enhancement Request</i>).</li>
