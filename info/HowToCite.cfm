		...
		<div class="col-12">
			<h2 class="mt-4 mb-3">Guidelines for Citing MCZ Specimens</h2>
				<div class="section">
					<div class="row">
						<div class="col-12">
							<h3 class="h4">Mentioning an MCZ specimen in a publication </h3>
				...
				<div class="section">
					<div class="row">
						<div class="col-12">
							<h3 class="h4">Citing MCZ Specimen Data </h3>
				...
				<div class="section">
					<div class="row">
						<div class="col-12">
							<h3 class="h4">Citing the MCZbase Dataset as a whole </h3>
				...
				<div class="section">
					<div class="row">
						<div class="col-12">
							<h3 class="h4">Citing the MCZbase Collection Management System Code</h3>
				...
				<div class="section">
					<div class="row">
						<div class="col-12">
							<h3 class="h4">Library Record for MCZbase</h3>
