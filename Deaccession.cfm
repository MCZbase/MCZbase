				...
				<tr>
					...
					<td>
						...
						<input type="text" name="rec_agent_name" id="rec_agent_name"
						  class="reqdClr" size="40" requiured readonly autocomplete="off" onfocus="this.removeAttribute('readonly');"
...
<cfif action is "editDeacc">
  ...
  <form name="editDeacc" action="Deaccession.cfm" method="post" id="editDeacc">
   ...
   <cfif #cgi.HTTP_HOST# contains "harvard.edu">
	  ...
	  <option value="/Reports/report_printer.cfm?transaction_id=#transaction_id#&report=mcz_files_deaccession_header">Header Copy for MCZ Files</option>
           <cfif inhouse.c is 1 and authorized.c GT 0 >
