											...
											<section class="col-12 search-header-basic py-1">
												...
												<div class="col-12 col-xl-1 float-left">
													<div class="h4 d-inline-block-md text-dark my-0 py-0">
														Identifiers
														<button type="button" id="IDDetailCtl" class="btn btn-xs px-3 px-xl-0 float-right small py-0 border-0 infoLink" onclick="toggleIDDetail(#toggleTo#);">#IDButton#</button>
													</div>
												</div>	
