									...
									<div class="row">
										<div class="input-group mt-1 px-3">
											<div class="input-group-btn col-md-4 col-sm-12">
												...
												<select class="custom-select bg-white" name="col-multi-select" id="col-multi-select" multiple="multiple" style="padding: .2em .5em">
											...
											<div class="mt-1 col-md-12 col-sm-12 p-0 my-2 mb-3" id="customFields">
												<div class="row border-0 p-0 mx-1 my-1 px-2 mb-2">
													<div class="col-md-3 col-sm-12 p-0 mx-1">
														...
														<select title="Select Type..." name="selectType" id="selectType" class="custom-select bg-white form-control-sm border d-flex">
													...
													<div class="col-md-2 col-sm-12 p-0 mx-1">
														...
														<select title="Select Comparator..." name="comparator" id="comparator" class="custom-select bg-white form-control-sm border d-flex">
								...
								<form id="searchForm3">
									<div class="container">
										<div class="form-row col-12 px-0 mx-0 mb-2">
												...
												<div class="col-sm-4">
													<select name="selectCollection" class="custom-select bg-white mb-2 col-3 col-multi-select" id="collmultiselect2" multiple="multiple">
													<cfloop query="collSearch">
										...
										<div class="form-row col-12 px-0 mx-0 mb-2">
											...
											<label class="col-sm-2 data-entry-label text-right" for="when">Verbatim Date</label>
											<div class="col-sm-4">
...
$(document).ready(function(){
	$(".addCF").click(function(){$("##customFields").append('<ul class="row col-md-11 col-sm-12 mx-0 my-4"><li class="d-inline col-sm-12 col-md-1 px-0 mr-2"><select title="Join Operator" name="JoinOperator" id="joinOperator" class="custom-select bg-white data-entry-select mx-0 d-flex"><option value="">Join with...</option><option value="and">and</option><option value="or">or</option><option value="not">not</option></select></li><li class="d-inline mr-2 col-sm-12 px-0 col-md-2"><select title="Select Type" name="SelectType" class="custom-select bg-white data-entry-select d-flex"><option>Select Type...</option><optgroup label="Identifiers"><option>MCZ Catalog (Collection)</option><option>Catalog Number</option><option>Number plus other identifiers?</option><option>Other Identifier Type</option><option>Accession</option><option>Accession Agency</option></optgroup><optgroup label="Taxonomy"><option>Any Taxonomic Element</option><option>Scientific Name</option><option>Began Date</option><option>Ended Date</option></optgroup></select></li><li class="d-inline col-sm-12 px-0 mr-2 col-md-2"><select title="Comparator" name="comparator" id="comparator" class="custom-select bg-white data-entry-select d-flex"><option value="">Compare with...</option><option value="like">contains</option><option value="eq">is</option></select></li><li class="col d-inline mr-2 px-0"><input type="text" class="data-entry-input" name="customFieldValue[]" id="srchTxt" placeholder="Enter Value"/></li><li class="d-inline mr-2 col-md-1 col-sm-1 px-0 d-flex justify-content-end"><button href="javascript:void(0);" arial-label="remove" class="btn-xs px-3 btn-primary remCF mr-auto">Remove</button></li></ul>');
		});
