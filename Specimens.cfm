									...
									<form id="fixedSearchForm">
										...
										<div class="container-flex togglesearchform" style="display: block;">
											<div class="col-12 search-form-basic-odd px-0 pb-2">
												...
												<div class="col-12 col-xl-auto px-1 pt-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
											...
											<div class="col-12 px-0 pb-2">
												<div class="col-12 col-xl-auto px-1 py-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
													<div style="font-size: 0.85rem;" class="h6 font-weight-bold d-inline-block-md text-xl-right pl-2 w-100 pr-1 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
													 General&thinsp;
													</div>
												</div>
											...
											<cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_transactions")>
												<div class="col-12 search-form-basic-odd pb-2 px-0">
													<div class="col-12 col-xl-auto px-1 py-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
														<div style="font-size: 0.85rem;" class="h6 font-weight-bold d-inline-block-md text-xl-right w-100 pl-1 pr-1 text-left text-md-left text-dark  mb-1 mb-md-0 pt-1 pt-md-0">
															Transactions&thinsp;
														</div>
													</div>
