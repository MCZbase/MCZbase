									...
									<div class="row">
										<div class="col-12">
											<div class="mb-3">
												...
												<div class="sticky"> GUID  | COLLECTION | CATALOG NUMBER | DEACCESSION | TOP TYPE STATUS | SPECIFIC LOCALITY | SCIENTIFIC NAME WITH AUTHOR | COLLECTORS | BEGAN DATE | ENDED DATE | COUNTRY | STATE/PROVINCE | WATERBODY | VERBATIM DATE |  COLLECTORS | BEGAN DATE | ENDED DATE | COUNTRY | STATE/PROVINCE | WATERBODY | VERBATIM DATE | OTHER IDS </div>
