		...
		function setupGrid(gridId,gridPrefix) { 
			...
			$("##"+gridId).jqxGrid({
				...
				columns: [
					...
					{text: 'Began Date', datafield: 'BEGAN_DATE', width: 120, cellsformat: 'yyyy-mm-dd', filtertype: 'date', hidable: true, hidden: getColHidProp('BEGAN_DATE', false) },
					{text: 'Ended Date', datafield: 'ENDED_DATE',filtertype: 'date', cellsformat: 'yyyy-mm-dd',width: 120, hidable: true, hidden: getColHidProp('ENDED_DATE', false) },
