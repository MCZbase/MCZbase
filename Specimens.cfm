									...
									<div class="row mx-0">
										<div class="col-12">
											<div class="mb-3">
												...
												<div class="sticky"> GUID  | COLLECTION | CATALOG NUMBER | DEACCESSION | TOP TYPE STATUS | SPECIFIC LOCALITY | SCIENTIFIC NAME WITH AUTHOR | COLLECTORS | BEGAN DATE<br> (TO DO: Figure out how to make this work on the column header row)</div>
