						...
						<div class="tab-content mt-0 px-0 pb-0">
							...
							function toggleIDDetail(onOff) {
								if (onOff==0) {
									...
									$("##IDDetail").show();
									$("##IDDetailCtl").attr('onCLick','toggleIDDetail(0)').html('<span class="btn-link d-block">less <i class="fas fa-caret-right" style="vertical-align: middle;" title="more fields"></i></span>');
								}
