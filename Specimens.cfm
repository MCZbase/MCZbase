											...
											<div id="searchButtons">
												<div class="form-row mx-0 px-4 my-1 pb-1">
													<div class="col-12 px-2 py-2 py-sm-0">
														...
														<button type="reset" class="btn btn-xs btn-outline-secondary col-12 col-md-auto px-md-3 mx-0 my-2 mr-md-2" aria-label="Reset this search form to inital values">Reset</button>
									...
									<form name= "keywordSearchForm" id="keywordSearchForm" class="container-fluid">
										...
										<div class="row mx-0 my-3">
											<div class="col-12">
												...
												<button type="reset" class="btn btn-xs btn-outline-secondary col-12 col-md-auto px-md-3 mr-md-2 mx-0 my-2 my-sm-1" aria-label="Reset this search form to inital values">Reset</button>
									...
									<form id="builderSearchForm" class="container-fluid">
										...
										<div class="form-row mb-3">
											<div class="col-12">
												...
												<button type="reset" class="btn btn-xs btn-outline-secondary col-12 col-md-auto px-md-3 mr-md-2 mx-0 my-1" aria-label="Reset this search form to inital values" disabled>Reset</button>
