							...
							<div class="container">
								<form id="searchForm3">
									<div class="container">
										...
										<label for="catalogNum" class="col-sm-2 data-entry-label font-dot-8">Catalog Number</label>
											<div class="col-sm-4">
										...
										<div class="form-row col-12 px-0 mx-0 mb-2">
											<label for="otherID" class="col-sm-2 data-entry-label font-dot-8">Other ID Type</label>
												<div class="col-sm-4">
											...
											<label for="otherIDnumber" class="col-sm-2 data-entry-label font-dot-8">Other ID Text</label>
											<div class="col-sm-4">
												<input type="text" class="data-entry-input" id="otherIDnumber" aria-label="Other ID number" placeholder="Other ID(s)">
											</div>
										</div>
										<div class="form-row col-12 px-0 mx-0 mb-2">
											<label for="taxa" class="mb-1 col-sm-2 data-entry-label font-dot-8">Any Taxonomy</label>
											<div class="col-sm-4">
												<input id="taxa" class="data-entry-input" aria-label="any taxonomy" >
											</div>
											<label for="geography" class="col-sm-2 data-entry-label font-dot-8">Any Geography</label>
											<div class="col-sm-4">
										...
										<div class="form-row col-12 px-0 mx-0 mb-2">
											...
											<label for="part_name" class="col-sm-2 data-entry-label font-dot-8">Part Name</label>
											<div class="col-sm-4">
												<input type="text" id="part_name" name="part_name" class="data-entry-input">
											</div>
										</div>	
										<div class="form-row col-12 px-0 mx-0 mb-2">
											<label for="place" class="col-sm-2 data-entry-label font-dot-8">Loan Number</label>
											<div class="col-sm-4">
												<input type="text" name="place" class="data-entry-input" id="place">
											</div>
											<label class="col-sm-2 data-entry-label font-dot-8" for="when">Verbatim Date</label>
											<div class="col-sm-4">
...
$(document).ready(function(){
	$(".addCF").click(function(){$("##customFields").append('<ul class="row col-md-11 col-sm-12 mx-0 my-4"><li class="d-inline col-sm-12 col-md-1 px-0 mr-2"><select title="Join Operator" name="JoinOperator" id="joinOperator" class="custom-select-sm bg-white data-entry-select mx-0 d-flex"><option value="">Join with...</option><option value="and">and</option><option value="or">or</option><option value="not">not</option></select></li><li class="d-inline mr-2 col-sm-12 px-0 col-md-2"><select title="Select Type" name="SelectType" class="custom-select-sm bg-white data-entry-select d-flex"><option>Select Type...</option><optgroup label="Identifiers"><option>MCZ Catalog (Collection)</option><option>Catalog Number</option><option>Number plus other identifiers?</option><option>Other Identifier Type</option><option>Accession</option><option>Accession Agency</option></optgroup><optgroup label="Taxonomy"><option>Any Taxonomic Element</option><option>Scientific Name</option><option>Began Date</option><option>Ended Date</option></optgroup></select></li><li class="d-inline col-sm-12 px-0 mr-2 col-md-2"><select title="Comparator" name="comparator" id="comparator" class="custom-select-sm bg-white data-entry-select d-flex"><option value="">Compare with...</option><option value="like">contains</option><option value="eq">is</option></select></li><li class="col d-inline mr-2 px-0"><input type="text" class="data-entry-input" name="customFieldValue[]" id="srchTxt" placeholder="Enter Value"/></li><li class="d-inline mr-2 col-md-1 col-sm-1 px-0 d-flex justify-content-end"><button href="javascript:void(0);" arial-label="remove" class="btn-xs px-3 btn-primary remCF mr-auto">Remove</button></li></ul>');
