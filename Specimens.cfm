					...
					<div class="col-12 mt-1 pb-3 mr-0 mr-md-3 mr-xl-4">
						...
						<div class="tabs card-header tab-card-header px-2 pt-3">
							...
							<div class="tab-headers px-0 tabList" role="tablist" aria-label="search panel tabs">
								<button class="col-3 col-md-2 px-2 my-0 #fixedTabActive#" id="basicSearchTabButton" tabid="1" role="tab" aria-controls="fixedSearchPanel" #fixedTabAria# data-wiki-page="Basic Specimen Search"><span class="h3 mb-0 font-weight-bold" role="heading" aria-level="2">Basic Search</span></button>
								<button class="col-3 col-xl-2 px-1 my-0 #keywordTabActive#" id="keywordSearchTabButton" tabid="2" role="tab" aria-controls="keywordSearchPanel" #keywordTabAria# data-wiki-page="Keyword Search"><span class="h3 mb-0 font-weight-bold" role="heading" aria-level="2">Keyword Search</span></button>
								<button class="col-3 col-xl-2 px-1 my-0 #builderTabActive#" id="builderSearchTabButton" tabid="3" role="tab" aria-controls="builderSearchPanel" #builderTabAria# aria-label="search builder tab" data-wiki-page="Search Builder"><span class="h3 mb-0 font-weight-bold" role="heading" aria-level="2">Search Builder</span></button>
							</div>
