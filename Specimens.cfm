										...
										<div class="container-flex">
											<section class="col-12 px-0 mt-0 mb-0">
												<div class="form-row mx-0 px-0 mb-1">
													<div class="jqx-widget-header col-12 px-0 border-bottom py-0">
														...
														<div class="col-12 mt-1 mb-0 px-2 px-xl-3 col-md-2 col-xl-2 float-left">
															...
															<div class="col-12 px-2 mb-0 mt-1 px-xl-3 mb-2 col-md-3 float-left">
												...
												<!---	<label for="IDDetailCtl" class="data-entry-label d-sm-none d-md-inline float-left" style="color: transparent">Identifiers</label>--->
													<button type="button" id="IDDetailCtl" class="btn btn-xs btn-outline-primary" onclick="toggleIDDetail(#toggleTo#);">#IDButton#</button>
												</div>
