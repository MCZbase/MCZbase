									...
									<form id="fixedSearchForm">
										...
										<div class="container-flex togglesearchform" style="display: block;">
											...
											<div class="col-12 px-0 pb-2">
												...
												<div class="col-12 col-xl-2 px-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);" >
													<div class="pb-1 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
														<button type="button" id="TaxaDetailCtl" class="btn btn-xs px-1 pt-xl-1 px-xl-1 small py-0 border-0 text-decoration-none" onclick="toggleTaxaDetail(#toggleTo#);"><span class="h5 mx-2 border-bottom border-dotted text-decoration-none text-black font-weight-bold">Taxonomy</span><span class="btn-link">#TaxaButton#</span></button>
													</div>
												</div>
												<div class="form-row col-12 col-xl-auto pt-1 px-3 mx-0 mb-0">
											...
											<div class="col-12 search-form-basic-odd px-0 pb-2">
												...
												<div class="col-12 col-xl-2 px-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
													<div class="pb-1 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
														<button type="button" id="GeogDetailCtl" class="btn btn-xs px-1 pt-xl-1 px-xl-1 small py-0 border-0 text-decoration-none" onclick="toggleGeogDetail(#toggleTo#);"><span class="h5 mx-2 border-bottom border-dotted text-decoration-none text-black font-weight-bold">Geography</span><span class="btn-link"><i class="fas fa-caret-down" title="more fields"><span class="sr-only">more fields</span></i></span></button>
													</div>
												</div>
												<div class="form-row col-12 col-xl-auto pt-1 px-3 mx-0 mb-0">
													<div class="col-12 mb-1 col-md-4">
											...
											<div class="col-12 px-0 pb-2">
												...
												<div class="col-12 col-xl-2 px-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
													<div class="pb-1 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
														<button type="button" id="CollDetailCtl" style="font-size: 0.95rem" class="btn btn-xs py-0 py-xl-1 px-1 px-xl-1 small border-0 text-decoration-none" onclick="toggleCollDetail(#toggleTo#);"><span class="text-black h5 mx-2 border-bottom border-dotted text-decoration-none text-black font-weight-bold">Coll. Event</span><span class="btn-link">#CollButton#</span></button>
													</div>
												</div>
											...
											<div class="col-12 search-form-basic-odd px-0 pb-2">
												...
												<div class="col-12 col-xl-2 px-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
													<div class="pb-1 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
														<button type="button" id="SpecDetailCtl" class="btn btn-xs px-1 pt-xl-1 px-xl-1 small py-0 border-0 text-decoration-none" onclick="toggleSpecDetail(#toggleTo#);">
															<span class="h5 mx-2 border-bottom border-dotted text-decoration-none text-black font-weight-bold">Specimen</span>
											...
											<div class="col-12 px-0 pb-2">
												<div class="col-12 col-xl-2 px-1 py-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
													<div style="font-size: 0.85rem;" class="h6 font-weight-bold d-inline-block-md text-xl-right w-100 px-1 py-xl-1 text-left text-xl-right text-dark mb-1 mb-md-0 pt-1 pt-md-0">
													 General&thinsp;
													</div>
												</div>
												<div class="form-row col-12 col-xl-auto pt-1 px-3 mb-0 mx-0">
											...
											<cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_transactions")>
												<div class="col-12 search-form-basic-odd pb-2 px-0">
													<div class="col-12 col-xl-2 px-1 py-1 mb-1 border float-left" style="-webkit-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);-moz-box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);box-shadow: -1px 15px 12px -4px rgba(176,170,176,0.55);">
														<div style="font-size: 0.85rem;" class="h6 font-weight-bold d-inline-block-md text-xl-right w-100 px-1 py-xl-1 text-left text-md-left text-dark mb-1 mb-md-0 pt-1 pt-md-0">
															Transactions&thinsp;
														</div>
													</div>
