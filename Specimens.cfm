										...
										<div class="container-flex togglesearchform" style="display: block;">
												...
												<div class="col-12 col-xl-2 col-xxl-1 px-0 mb-1 float-left">
													<div class="pb-1 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 text-left text-md-left text-dark mb-1 mb-md-0 pt-2">
														...
														<cfif findNoCase("redesign",gitBranch) GT 0 OR (isdefined("session.roles") AND listfindnocase(session.roles,"collops") ) >
															<button type="button" id="IDDetailCtl" class="d-none d-xl-inline-block py-1 py-xl-0 btn-link text-right btn small" onclick="toggleIDDetail(#toggleTo#);">#IDButton#</button>
														</cfif>
													</div>
												</div>	
											...
											<div class="col-12 form-row mx-0 px-0 pb-2 pb-xl-0">
												...
												<div class="col-12 col-xl-2 col-xxl-1 px-0 mb-1">
													<div class="pb-1 pb-xl-0 font-weight-bold d-inline-block-md text-xl-right px-1 w-100 pt-2 text-left text-dark mb-0">
														<span style="font-size: 0.95rem" class="mx-2 px-2 px-xl-0 d-block text-black font-weight-bold">Taxonomy</span>
														<button type="button" id="TaxaDetailCtl" class="d-none d-xl-inline-block py-0 py-xl-1 btn-link text-right btn small" onclick="toggleTaxaDetail(#toggleTo#);">#TaxaButton#</button>
													</div>
												</div>
												<div class="form-row col-12 col-xl-10 col-xxl-11 pt-1 px-3 mx-0 mb-0">
											...
											<cfif isdefined("session.roles") and listcontainsnocase(session.roles,"manage_transactions")>
												<div class="col-12 form-row mx-0 search-form-basic-odd pb-1 px-0">
													<div class="col-12 col-xl-2 col-xxl-1 px-0 mb-1 float-left">
														<div style="font-size: 0.95rem;" class="mx-2 px-2 pt-2 px-xl-0 text-left text-xl-right text-black font-weight-bold">
															Transactions
														</div>
													</div>
													<div class="form-row col-12 col-xl-10 col-xxl-11 px-3 pt-1 mb-0 mx-0">
