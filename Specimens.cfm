									...
									<div class="col-9 float-right px-0"> 
										...
										<div class="collapse collapseStyle" id="collapseKeyword">
											<div class="card card-body pl-4 py-3 pr-3">
												...
												<p>These only work with the keyword search, operators for other searches are different. <cfif isdefined("session.roles") and listfindnocase(session.roles,"coldfusion_user")>See: <a href="https://code.mcz.harvard.edu/wiki/index.php/Search_Operators" target="_blank">Search Operators</a>.</cfif></p>
												<dl class="mb-0"> 
