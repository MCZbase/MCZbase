							...
							<form name="searchForm" id="searchForm"> 
								...
								<div class="form-row my-2 mx-0">
									<div class="col-12 text-left">
										...
										<button type="button" class="btn-xs btn-warning" aria-label="Start a new collection number series search with a clear form" onclick="window.location.href='#Application.serverRootUrl#/CollEventNumberSeries.cfm?action=findAll';" >New Search</button>
									</div>
								</div>
							</form>
						</div>
