				...
				<ul class="nav nav-tabs">
					<cfloop query="types">
						<li class="nav-item border rounded">
							<a class="nav-link btn-link px-2" style="text-transform:capitalize;" href="/vocabularies/GeologicalHierarchies.cfm?action=list&type=#types.type#">#types.type# Terms</a>
						</li>
					</cfloop>
