		...
		<div class="row">
			<div class="col-12">
				<div class="d-flex justify-content-between align-items-center mt-3 mb-2">
					<h1 id="pageHeading" class="h3 mb-0">Specimen Part Names</h1>
				...
				<section aria-labelledby="listHeading">
					<h2 id="listHeading" class="h5 mt-3 mb-2">Part Names</h2>
					<table class="table table-sm table-bordered table-striped d-xl-table">
